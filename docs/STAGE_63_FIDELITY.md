...
| **H63x** | `STAGE_63_EXIT_CRITERIA.md`; ADR-132 (planned); `test_stage63_exit_h63x.py` | Stage 63 exit + freeze | Exit PENDING |
...
- `docs/BUSINESS_REQUIREMENTS_DOCUMENT.md` — BR-16 fidelity (+ Stage 63 P1–G1 / D1 cite)
- `docs/API_DOCUMENTATION.md` — Stage 63 P1–G1 / D1 cite
- `PRODUCTION_READINESS.md` — Capital & scale Completes + Stage 63 D1 cite
- `docs/DEVELOPMENT_ROADMAP.md` — Stage 63 D1
- `docs/LAUNCH_CHECKLIST.md` — P1–G1 / D1 evidence
- `docs/DEPLOYMENT_GUIDE.md` — Stage 63 P1–G1 / D1
- `docs/SECURITY_GUIDE.md` — Stage 63 P1–G1 / D1 cite
- `docs/IPO_READINESS_MVP.md` · `docs/GLOBAL_SCALE_MVP.md`
- `docs/STAGE_63_PLAN.md` — Open — D1 complete; H63x next
