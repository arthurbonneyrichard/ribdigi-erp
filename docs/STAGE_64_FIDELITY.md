...
| **H64x** | `STAGE_64_EXIT_CRITERIA.md`; ADR-134; `test_stage64_exit_h64x.py` (at close) | Stage 64 exit + freeze | Next track needs open ADR |
...
- `docs/STAGE_64_PLAN.md` — Open — D1 complete; H64x next
