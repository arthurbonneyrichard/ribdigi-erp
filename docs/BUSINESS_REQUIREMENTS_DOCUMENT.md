...
- **Acceptance Criteria:**
  ...
  - [x] Cheque management (issue, deposit, bounce tracking) (`POST /accounting/cheques/{id}/bounce|cancel?reason=` **required**; blank/omit → 400; Accounting Cheques Bounce/Cancel reason field → notes + journal description)
