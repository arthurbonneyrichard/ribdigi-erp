...
- **Acceptance Criteria:**
  ...
  - [ ] All reports filterable by date range, branch, store (P&L + cash-flow support date/store/branch; BS + TB support `as_of`; **expense summary/budget-vs-actual support `branch_id`/`department_id`**; others partial)
