...
**Active delivery plan:** Stage 37 open — Commercial Data Protection Fidelity (`docs/STAGE_37_PLAN.md`, ADR-079). Stages 1–36 remain frozen for their scopes; P1 next.
