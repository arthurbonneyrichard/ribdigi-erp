...
**Active delivery plan:** Stage 36 open (`docs/STAGE_36_PLAN.md`, ADR-077) — B1 complete; D1 next. Stages 1–35 remain frozen for their scopes (`docs/STAGE_35_EXIT_CRITERIA.md`, ADR-076).
