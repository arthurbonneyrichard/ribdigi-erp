...
**Active delivery plan:** Stage 35 open (`docs/STAGE_35_PLAN.md`, ADR-075) — P1 complete; S1 next. Stages 1–34 remain frozen for their scopes (`docs/STAGE_34_EXIT_CRITERIA.md`, ADR-074).
