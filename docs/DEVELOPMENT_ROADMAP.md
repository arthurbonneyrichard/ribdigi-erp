...
**Active delivery plan:** Stage 35 exit met (`docs/STAGE_35_EXIT_CRITERIA.md`, ADR-076). Stages 1–35 remain frozen for their scopes; Stage 36+ requires explicit open ADR after CONTINUE/NEXT.
