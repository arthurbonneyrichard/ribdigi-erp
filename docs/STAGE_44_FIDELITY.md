...
| **H44x** | `STAGE_44_EXIT_CRITERIA.md`; ADR-094 (planned); `test_stage44_exit_h44x.py` | Stage 44 exit + freeze | Next track needs open ADR |
...
- `docs/STAGE_44_PLAN.md` — Open (D1 complete; H44x next)
