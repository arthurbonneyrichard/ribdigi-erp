...
- [ ] Users + RBAC assignment packaging for the E2E smoke path (not forging live user provisioning Complete).
- [ ] Automated proof: `backend/tests/test_e2e_users_rbac_u1.py`.
- [ ] SECURITY_GUIDE / LAUNCH_CHECKLIST honesty updated.
- [ ] Plan / launch / roadmap cite Stage 35 U1.

## P1 acceptance criteria

- [ ] Purchase-to-stock packaging (supplier → products → PO → receive → verify stock) for E2E smoke (not forging live purchasing success).
- [ ] Automated proof: `backend/tests/test_e2e_purchase_stock_p1.py`.
- [ ] LAUNCH_CHECKLIST / PRODUCTION_READINESS honesty updated.
- [ ] Plan / launch / roadmap cite Stage 35 P1.

## S1 acceptance criteria

- [ ] Sale-to-payment packaging (customer → POS → payment → stock reduction) for E2E smoke (not forging live POS success).
- [ ] Automated proof: `backend/tests/test_e2e_sale_payment_s1.py`.
- [ ] LAUNCH_CHECKLIST / PRODUCTION_READINESS honesty updated.
- [ ] Plan / launch / roadmap cite Stage 35 S1.
