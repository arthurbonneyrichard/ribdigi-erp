...
- [x] Unread count, categorized groups, mark read/unread, 90-day history panel proven.
- [x] Automated proof: `backend/tests/test_dashboard_notifications_n1.py`.
- [x] BR-4.4 synced with evidence.
