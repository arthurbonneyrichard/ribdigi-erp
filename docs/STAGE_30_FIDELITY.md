...
**Status:** Open with Stage 30 D1; H30x next (ADR-065)  
...
- `docs/BUSINESS_REQUIREMENTS_DOCUMENT.md` — BR-16 fidelity (+ Stage 30 L1–A1 / D1 cite)
- `docs/API_DOCUMENTATION.md` — Stage 30 L1–A1 / D1 cite
- `PRODUCTION_READINESS.md` — monitoring / K8s / launch Completes + Stage 30 D1 cite
- `docs/DEVELOPMENT_ROADMAP.md` — Stage 30 D1
- `docs/LAUNCH_CHECKLIST.md` — L1–A1 / D1 evidence
- `docs/DEPLOYMENT_GUIDE.md` — Stage 30 I1 / L1 / A1 / D1
- `docs/SECURITY_GUIDE.md` — Stage 30 L1–A1 / D1 cite
...
- `docs/STAGE_30_PLAN.md` — D1 complete; H30x next
