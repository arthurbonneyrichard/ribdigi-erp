...
@pytest.mark.parametrize("rel", [
    ...
    "docs/TRANSFER_HOUREKIYAJIYUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md",
    "docs/TRANSFER_HOUREKIYAJIYUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md",
    "docs/TRANSFER_HOUREKIYAJIYUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md",
])
