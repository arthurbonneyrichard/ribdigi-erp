"""Inventory / reports movement from_date/to_date Query OpenAPI honesty (BR-5.3)."""
...
def test_iso_date_query_schema_for_movements():
...
def test_movement_date_ui_and_docs():
    ...
    assert "Movement date Query OpenAPI" in agents
...
@pytest.mark.asyncio
async def test_movement_date_query_blank_invalid_422(client):
    ac, _seed = client
