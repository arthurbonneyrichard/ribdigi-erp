"""WAL / PITR strategy + S3 offsite backup packaging fidelity (MVP)."""
...
def test_wal_pitr_runbook():
    ...
    assert "PITR_DRILL_PACK_MVP.md" in doc or "pitr-drill-checklist.json" in doc
...
def test_wal_gate_complete_mvp_and_evidence():
    ...
    # Remaining honesty — live operator drill still post-MVP
