...
def test_users_soft_activate_deactivate_colors():
    page = _read("frontend/app/(dashboard)/users/page.tsx")
...
def test_inventory_product_and_catalog_soft_colors():
    page = _read("frontend/app/(dashboard)/inventory/page.tsx")
...
def test_stores_org_soft_colors():
    page = _read("frontend/app/(dashboard)/stores/page.tsx")
...
def test_accounting_coa_and_bank_soft_colors():
    page = _read("frontend/app/(dashboard)/accounting/page.tsx")
...
def test_party_tax_expense_soft_toggle_colors():
    sales = _read("frontend/app/(dashboard)/sales/page.tsx")
