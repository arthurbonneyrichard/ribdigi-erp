...
def upgrade() -> None:
    op.add_column(
        "tenants",
        sa.Column("purchase_approval_matrix", sa.JSON(), nullable=True),
    )
    op.add_column(
        "purchase_requests",
...
def downgrade() -> None:
    op.drop_index(
        "ix_purchase_request_approval_actions_purchase_request_id",
        table_name="purchase_request_approval_actions",
    )
    op.drop_index(
        "ix_purchase_request_approval_actions_tenant_id",
        table_name="purchase_request_approval_actions",
    ...
    op.drop_column("tenants", "purchase_approval_matrix")
