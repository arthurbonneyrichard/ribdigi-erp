...
def build_receipt_payload(
    *,
    ...
    return {
        ...
        "tax_registration_number": brand["tax_registration_number"]
        or (getattr(company, "tax_registration_number", None) if company else None)
        or (getattr(tenant, "tax_registration_number", None) if tenant else None),
