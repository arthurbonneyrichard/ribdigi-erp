"""Ghana GRA-style VAT return mapping from the jurisdiction-neutral filing pack.

Maps ERP boxes 1–5 / 2a into a workbook-oriented return used for manual GRA filing.
Does not e-file to the GRA portal.
"""
...
def map_return(pack: dict, tenant: m.Tenant) -> dict:
    ...
    return {
        ...
        "header": {
            ...
            "currency": (tenant.currency or "GHS").upper(),
