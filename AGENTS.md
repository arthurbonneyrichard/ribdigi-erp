...
**As of tip:** `877db22150f91a31ddc16bc316714dfb2cd60151` — `feat(rbac): redact sales-invoice exchange_rate for store_manager` (feat ancestry sales-invoice exchange_rate `877db22150` + credit payment exchange_rate `398fe65b2e` + expenses department filter `1383d106c2` + expenses-summary category filter `cd81d2f267` + AI document category_id `2116d84288` + credit payment fx_gain_loss `26e7d58799`).
