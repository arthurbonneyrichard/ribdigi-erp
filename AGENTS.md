...
**As of tip:** `140fe80ca527de7eed803e6834636e1900ab9b83` — `docs: align PR #303 As of tip to header/footer + TIN honesty HEAD` (feat ancestry tax filing TIN `47844e3c4d` + receipt header/footer `9100933f8c` + receipt company_address/phone `82f3f89420` + continuum PO `emailed_to` `9ff88796a1` + security H1–H5 `3cf99a5540`/`caf7d98b55`).
