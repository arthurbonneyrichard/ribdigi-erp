...
**As of tip:** `532673add67293f070e3d39b2d0b8f92e417b7c3` — `docs: align PR #303 As of tip to print/receipt TIN honesty HEAD` (feat ancestry print/receipt TIN `5eb2864692` + company_email `73752ad7e2` + invoice print `template` `5d076753b7` + receipt print template `8d06c785d9` + tax filing TIN `47844e3c4d` + continuum PO `emailed_to` `9ff88796a1` + security H1–H5 `3cf99a5540`/`caf7d98b55`).
