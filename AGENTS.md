...
**As of tip:** `096bbd7af0970fa6fdd34ea0492b6d31e0f5b4e7` — **SEC-M1 + M3 + M4 FIXED**; **SEC-M2/M5 Phase A+B** on tip (flag OFF; login skips LS when `cookie_session`; central `apiFetch`) — still **OPEN/PARTIAL**, not FIXED. Continuum CLE `invoice_total` redact honesty remains **PARTIAL**.  
