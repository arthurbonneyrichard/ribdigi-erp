...
**As of tip:** `631d061d3ef273edb8e1d47526713f879f20e3a7` — **SEC-M1 + M3 + M4 FIXED**; **SEC-M2/M5 Phase A+B** on tip (flag OFF; login skips LS when `cookie_session`; central `apiFetch`) — still **OPEN/PARTIAL**, not FIXED. Continuum CLE `invoice_total` redact honesty remains **PARTIAL**.  
