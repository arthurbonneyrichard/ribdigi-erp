...
**As of tip:** `0b26f4086f8cc7ee3568b99bfa14bcfcf1540e05` — `docs: align PR #303 As of tip to company_email redact honesty HEAD` (feat ancestry `73752ad7e2` + invoice print `template` `5d076753b7` + receipt print template `8d06c785d9` + tax filing TIN `47844e3c4d` + continuum PO `emailed_to` `9ff88796a1` + security H1–H5 `3cf99a5540`/`caf7d98b55`).).
