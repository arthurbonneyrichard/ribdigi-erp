...
**As of tip:** `119c990dbcea441b41df460cfe946ed256c93fbb` — `docs: align PR #303 As of tip to company_email redact honesty HEAD` (feat ancestry `73752ad7e2` + invoice print `template` `5d076753b7` + receipt print template `8d06c785d9` + tax filing TIN `47844e3c4d` + continuum PO `emailed_to` `9ff88796a1` + security H1–H5 `3cf99a5540`/`caf7d98b55`).).
