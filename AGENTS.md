...
**As of tip:** `20d858ea0d744d5ec88e1cf4bd697c3527dd8bd7` — `feat(rbac): redact sales-invoice balance_due_base for store_manager` (feat ancestry sales-invoice `balance_due_base` `9baec24d88` + aging document `balance_due_base` `843f16dafa` + accounting reports branch filter `baf6e4b84b` + credit-aging document `exchange_rate` `abe20b58a4` + purchase-invoice `exchange_rate` `0d97de259c` + sales-invoice `exchange_rate` `877db22150` + credit payment `exchange_rate` `398fe65b2e` + expenses department filter `1383d106c2` + expenses-summary category filter `cd81d2f267` + AI document `category_id` `2116d84288`).
