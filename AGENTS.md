...
**As of tip:** `077ab8f5c0ff6368951265d81bc41e2c67448708` — **SEC-M1 + M3 + M4 FIXED**; **SEC-M2/M5 Phase A** cookie foundation on tip (flag OFF). Phase B client helpers land on `cursor/sec-m2-m5-cookie-phase-b-dac4` (login skip LS when `cookie_session`; central `apiFetch`) — still **OPEN/PARTIAL**, not FIXED. Continuum CLE `invoice_total` redact honesty remains **PARTIAL**.  
