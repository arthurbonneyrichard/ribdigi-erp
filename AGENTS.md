...
**As of tip:** `44619da1c292c0f5be025d957f1db013ce00fcb0` — `feat(rbac): deny expenses-summary category_id filter for store_manager` (feat ancestry expenses-summary category filter `cd81d2f267` + cheque bank_name `d2ce109255` + BI expense by_category `fc44ef131e`).
