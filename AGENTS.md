...
**As of tip:** `196a189be02d3cae3d43a55899764286a75528c0` — `feat(rbac): redact credit-aging document exchange_rate for store_manager` (feat ancestry aging document `exchange_rate` `abe20b58a4` + purchase-invoice `exchange_rate` `0d97de259c` + sales-invoice `exchange_rate` `877db22150` + credit payment `exchange_rate` `398fe65b2e` + credit payment `fx_gain_loss` `26e7d58799` + AI document `category_id` `2116d84288` + expenses department filter `1383d106c2` + cheque `bank_name` `d2ce109255` + BI expense by_category `fc44ef131e` + credit payment `currency` `450f6476d7` + tax-filing jurisdiction `8d34911703` + credit-aging document currency `f191a48c68` + purchase-invoice `currency` `2ae6d54e66` + sales-invoice `currency` `4991a65408`)... (feat ancestry purchase-invoice `exchange_rate` `0d97de259c` + sales-invoice exchange_rate `877db22150` + credit payment exchange_rate `398fe65b2e` + expenses department filter `1383d106c2` + AI document category_id `2116d84288`)....
