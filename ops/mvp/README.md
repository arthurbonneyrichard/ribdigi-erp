...
- `docs/TRANSFER_KOFUKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kofukiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1651 I1
- `docs/TRANSFER_KOFUKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kofukiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1651 B1
- `docs/TRANSFER_KOFUKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kofukiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1651 P1
- `docs/TRANSFER_IRONGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ironglaze-gate-honesty-pack-remaining-gate.json` — Stage 1650 I1
- `docs/TRANSFER_IRONGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ironglaze-gate-honesty-pack-rg-blockers.json` — Stage 1650 B1
- `docs/TRANSFER_IRONGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ironglaze-gate-honesty-pack-rg-pointers.json` — Stage 1650 P1
- `docs/TRANSFER_NAMAKOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-namakoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1649 I1
- `docs/TRANSFER_NAMAKOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-namakoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1649 B1
- `docs/TRANSFER_NAMAKOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-namakoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1649 P1
- `docs/TRANSFER_YOHENGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-yohenglaze-gate-honesty-pack-remaining-gate.json` — Stage 1648 I1
- `docs/TRANSFER_YOHENGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-yohenglaze-gate-honesty-pack-rg-blockers.json` — Stage 1648 B1
- `docs/TRANSFER_YOHENGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-yohenglaze-gate-honesty-pack-rg-pointers.json` — Stage 1648 P1
- `docs/TRANSFER_SEIJIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-seijiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1647 I1
- `docs/TRANSFER_SEIJIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-seijiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1647 B1
- `docs/TRANSFER_SEIJIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-seijiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1647 P1
- `docs/TRANSFER_KAIYUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kaiyuglaze-gate-honesty-pack-remaining-gate.json` — Stage 1646 I1
- `docs/TRANSFER_KAIYUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kaiyuglaze-gate-honesty-pack-rg-blockers.json` — Stage 1646 B1
- `docs/TRANSFER_KAIYUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kaiyuglaze-gate-honesty-pack-rg-pointers.json` — Stage 1646 P1
- `docs/TRANSFER_TETSUYUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tetsuyuglaze-gate-honesty-pack-remaining-gate.json` — Stage 1645 I1
- `docs/TRANSFER_TETSUYUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tetsuyuglaze-gate-honesty-pack-rg-blockers.json` — Stage 1645 B1
- `docs/TRANSFER_TETSUYUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tetsuyuglaze-gate-honesty-pack-rg-pointers.json` — Stage 1645 P1
- `docs/TRANSFER_HAIYUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-haiyuglaze-gate-honesty-pack-remaining-gate.json` — Stage 1644 I1
- `docs/TRANSFER_HAIYUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-haiyuglaze-gate-honesty-pack-rg-blockers.json` — Stage 1644 B1
- `docs/TRANSFER_HAIYUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-haiyuglaze-gate-honesty-pack-rg-pointers.json` — Stage 1644 P1
- `docs/TRANSFER_AMENAGASHIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-amenagashiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1643 I1
- `docs/TRANSFER_AMENAGASHIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-amenagashiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1643 B1
- `docs/TRANSFER_AMENAGASHIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-amenagashiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1643 P1
- `docs/TRANSFER_CHOJIGIROGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chojigiroglaze-gate-honesty-pack-remaining-gate.json` — Stage 1642 I1
- `docs/TRANSFER_CHOJIGIROGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chojigiroglaze-gate-honesty-pack-rg-blockers.json` — Stage 1642 B1
- `docs/TRANSFER_CHOJIGIROGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chojigiroglaze-gate-honesty-pack-rg-pointers.json` — Stage 1642 P1
- `docs/TRANSFER_SHINOORIBEGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shinooribeglaze-gate-honesty-pack-remaining-gate.json` — Stage 1641 I1
- `docs/TRANSFER_SHINOORIBEGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shinooribeglaze-gate-honesty-pack-rg-blockers.json` — Stage 1641 B1
- `docs/TRANSFER_SHINOORIBEGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shinooribeglaze-gate-honesty-pack-rg-pointers.json` — Stage 1641 P1
- `docs/TRANSFER_KUROMONOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kuromonoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1640 I1
- `docs/TRANSFER_KUROMONOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kuromonoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1640 B1
- `docs/TRANSFER_KUROMONOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kuromonoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1640 P1
- `docs/TRANSFER_NARUMIORIBEGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-narumioribeglaze-gate-honesty-pack-remaining-gate.json` — Stage 1639 I1
- `docs/TRANSFER_NARUMIORIBEGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-narumioribeglaze-gate-honesty-pack-rg-blockers.json` — Stage 1639 B1
- `docs/TRANSFER_NARUMIORIBEGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-narumioribeglaze-gate-honesty-pack-rg-pointers.json` — Stage 1639 P1
- `docs/TRANSFER_AOORIBEGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-aooribeglaze-gate-honesty-pack-remaining-gate.json` — Stage 1638 I1
- `docs/TRANSFER_AOORIBEGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-aooribeglaze-gate-honesty-pack-rg-blockers.json` — Stage 1638 B1
- `docs/TRANSFER_AOORIBEGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-aooribeglaze-gate-honesty-pack-rg-pointers.json` — Stage 1638 P1
- `docs/TRANSFER_NEZUMISHINOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nezumishinoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1637 I1
- `docs/TRANSFER_NEZUMISHINOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nezumishinoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1637 B1
- `docs/TRANSFER_NEZUMISHINOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nezumishinoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1637 P1
- `docs/TRANSFER_SETOGUROGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-setoguroglaze-gate-honesty-pack-remaining-gate.json` — Stage 1636 I1
- `docs/TRANSFER_SETOGUROGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-setoguroglaze-gate-honesty-pack-rg-blockers.json` — Stage 1636 B1
- `docs/TRANSFER_SETOGUROGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-setoguroglaze-gate-honesty-pack-rg-pointers.json` — Stage 1636 P1
- `docs/TRANSFER_KISETOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kisetoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1635 I1
- `docs/TRANSFER_KISETOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kisetoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1635 B1
- `docs/TRANSFER_KISETOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kisetoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1635 P1
- `docs/TRANSFER_ORIBEYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-oribeyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1634 I1
- `docs/TRANSFER_ORIBEYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-oribeyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1634 B1
- `docs/TRANSFER_ORIBEYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-oribeyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1634 P1
- `docs/TRANSFER_SHINOYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shinoyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1633 I1
- `docs/TRANSFER_SHINOYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shinoyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1633 B1
- `docs/TRANSFER_SHINOYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shinoyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1633 P1
- `docs/TRANSFER_BIZENYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bizenyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1632 I1
- `docs/TRANSFER_BIZENYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bizenyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1632 B1
- `docs/TRANSFER_BIZENYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bizenyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1632 P1
- `docs/TRANSFER_KIBIYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kibiyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1631 I1
- `docs/TRANSFER_KIBIYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kibiyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1631 B1
- `docs/TRANSFER_KIBIYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kibiyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1631 P1
- `docs/TRANSFER_AKAZUYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-akazuyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1630 I1
- `docs/TRANSFER_AKAZUYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-akazuyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1630 B1
- `docs/TRANSFER_AKAZUYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-akazuyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1630 P1
- `docs/TRANSFER_SETOSHIDAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-setoshidaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1629 I1
- `docs/TRANSFER_SETOSHIDAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-setoshidaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1629 B1
- `docs/TRANSFER_SETOSHIDAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-setoshidaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1629 P1
- `docs/TRANSFER_OFUKEYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ofukeyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1628 I1
- `docs/TRANSFER_OFUKEYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ofukeyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1628 B1
- `docs/TRANSFER_OFUKEYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ofukeyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1628 P1
- `docs/TRANSFER_INUYAMAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-inuyamaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1627 I1
- `docs/TRANSFER_INUYAMAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-inuyamaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1627 B1
- `docs/TRANSFER_INUYAMAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-inuyamaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1627 P1
- `docs/TRANSFER_SHODOYAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shodoyaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1626 I1
- `docs/TRANSFER_SHODOYAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shodoyaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1626 B1
- `docs/TRANSFER_SHODOYAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shodoyaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1626 P1
- `docs/TRANSFER_AWAJIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-awajiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1625 I1
- `docs/TRANSFER_AWAJIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-awajiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1625 B1
- `docs/TRANSFER_AWAJIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-awajiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1625 P1
- `docs/TRANSFER_AWAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-awaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1624 I1
- `docs/TRANSFER_AWAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-awaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1624 B1
- `docs/TRANSFER_AWAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-awaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1624 P1
- `docs/TRANSFER_OBORIYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-oboriyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1623 I1
- `docs/TRANSFER_OBORIYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-oboriyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1623 B1
- `docs/TRANSFER_OBORIYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-oboriyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1623 P1
- `docs/TRANSFER_MIKAWACHIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mikawachiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1622 I1
- `docs/TRANSFER_MIKAWACHIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mikawachiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1622 B1
- `docs/TRANSFER_MIKAWACHIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mikawachiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1622 P1
- `docs/TRANSFER_IZUMOYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-izumoyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1621 I1
- `docs/TRANSFER_IZUMOYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-izumoyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1621 B1
- `docs/TRANSFER_IZUMOYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-izumoyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1621 P1
- `docs/TRANSFER_TSUBOYAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tsuboyaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1620 I1
- `docs/TRANSFER_TSUBOYAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tsuboyaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1620 B1
- `docs/TRANSFER_TSUBOYAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tsuboyaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1620 P1
- `docs/TRANSFER_HASAMIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hasamiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1619 I1
- `docs/TRANSFER_HASAMIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hasamiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1619 B1
- `docs/TRANSFER_HASAMIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hasamiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1619 P1
- `docs/TRANSFER_KOISHIWARAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-koishiwaraglaze-gate-honesty-pack-remaining-gate.json` — Stage 1618 I1
- `docs/TRANSFER_KOISHIWARAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-koishiwaraglaze-gate-honesty-pack-rg-blockers.json` — Stage 1618 B1
- `docs/TRANSFER_KOISHIWARAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-koishiwaraglaze-gate-honesty-pack-rg-pointers.json` — Stage 1618 P1
- `docs/TRANSFER_ONTAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ontaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1617 I1
- `docs/TRANSFER_ONTAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ontaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1617 B1
- `docs/TRANSFER_ONTAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ontaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1617 P1
- `docs/TRANSFER_KASAMAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kasamaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1616 I1
- `docs/TRANSFER_KASAMAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kasamaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1616 B1
- `docs/TRANSFER_KASAMAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kasamaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1616 P1
- `docs/TRANSFER_IWAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-iwaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1615 I1
- `docs/TRANSFER_IWAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-iwaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1615 B1
- `docs/TRANSFER_IWAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-iwaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1615 P1
- `docs/TRANSFER_TAMBAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tambaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1614 I1
- `docs/TRANSFER_TAMBAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tambaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1614 B1
- `docs/TRANSFER_TAMBAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tambaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1614 P1
- `docs/TRANSFER_ECHIZENGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-echizenglaze-gate-honesty-pack-remaining-gate.json` — Stage 1613 I1
- `docs/TRANSFER_ECHIZENGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-echizenglaze-gate-honesty-pack-rg-blockers.json` — Stage 1613 B1
- `docs/TRANSFER_ECHIZENGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-echizenglaze-gate-honesty-pack-rg-pointers.json` — Stage 1613 P1
- `docs/TRANSFER_BANKOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bankoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1612 I1
- `docs/TRANSFER_BANKOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bankoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1612 B1
- `docs/TRANSFER_BANKOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bankoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1612 P1
- `docs/TRANSFER_TOKONAMEGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tokonameglaze-gate-honesty-pack-remaining-gate.json` — Stage 1611 I1
- `docs/TRANSFER_TOKONAMEGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tokonameglaze-gate-honesty-pack-rg-blockers.json` — Stage 1611 B1
- `docs/TRANSFER_TOKONAMEGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tokonameglaze-gate-honesty-pack-rg-pointers.json` — Stage 1611 P1
- `docs/TRANSFER_SHIGARAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shigarakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1610 I1
- `docs/TRANSFER_SHIGARAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shigarakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1610 B1
- `docs/TRANSFER_SHIGARAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shigarakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1610 P1
- `docs/TRANSFER_MINOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-minoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1609 I1
- `docs/TRANSFER_MINOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-minoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1609 B1
- `docs/TRANSFER_MINOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-minoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1609 P1
- `docs/TRANSFER_SATSUMAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-satsumaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1608 I1
- `docs/TRANSFER_SATSUMAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-satsumaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1608 B1
- `docs/TRANSFER_SATSUMAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-satsumaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1608 P1
- `docs/TRANSFER_KYOYAKIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kyoyakiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1607 I1
- `docs/TRANSFER_KYOYAKIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kyoyakiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1607 B1
- `docs/TRANSFER_KYOYAKIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kyoyakiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1607 P1
- `docs/TRANSFER_NABESHIMAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nabeshimaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1606 I1
- `docs/TRANSFER_NABESHIMAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nabeshimaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1606 B1
- `docs/TRANSFER_NABESHIMAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nabeshimaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1606 P1
- `docs/TRANSFER_KUTANIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kutaniglaze-gate-honesty-pack-remaining-gate.json` — Stage 1605 I1
- `docs/TRANSFER_KUTANIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kutaniglaze-gate-honesty-pack-rg-blockers.json` — Stage 1605 B1
- `docs/TRANSFER_KUTANIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kutaniglaze-gate-honesty-pack-rg-pointers.json` — Stage 1605 P1
- `docs/TRANSFER_IMARIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-imariglaze-gate-honesty-pack-remaining-gate.json` — Stage 1604 I1
- `docs/TRANSFER_IMARIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-imariglaze-gate-honesty-pack-rg-blockers.json` — Stage 1604 B1
- `docs/TRANSFER_IMARIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-imariglaze-gate-honesty-pack-rg-pointers.json` — Stage 1604 P1
- `docs/TRANSFER_ARITAGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-aritaglaze-gate-honesty-pack-remaining-gate.json` — Stage 1603 I1
- `docs/TRANSFER_ARITAGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-aritaglaze-gate-honesty-pack-rg-blockers.json` — Stage 1603 B1
- `docs/TRANSFER_ARITAGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-aritaglaze-gate-honesty-pack-rg-pointers.json` — Stage 1603 P1
- `docs/TRANSFER_TOBEGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tobeglaze-gate-honesty-pack-remaining-gate.json` — Stage 1602 I1
- `docs/TRANSFER_TOBEGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tobeglaze-gate-honesty-pack-rg-blockers.json` — Stage 1602 B1
- `docs/TRANSFER_TOBEGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tobeglaze-gate-honesty-pack-rg-pointers.json` — Stage 1602 P1
- `docs/TRANSFER_MASHIKOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mashikoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1601 I1
- `docs/TRANSFER_MASHIKOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mashikoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1601 B1
- `docs/TRANSFER_MASHIKOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mashikoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1601 P1
- `docs/TRANSFER_HAGIGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hagiglaze-gate-honesty-pack-remaining-gate.json` — Stage 1600 I1
- `docs/TRANSFER_HAGIGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hagiglaze-gate-honesty-pack-rg-blockers.json` — Stage 1600 B1
- `docs/TRANSFER_HAGIGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hagiglaze-gate-honesty-pack-rg-pointers.json` — Stage 1600 P1
- `docs/TRANSFER_KARATSUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-karatsuglaze-gate-honesty-pack-remaining-gate.json` — Stage 1599 I1
- `docs/TRANSFER_KARATSUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-karatsuglaze-gate-honesty-pack-rg-blockers.json` — Stage 1599 B1
- `docs/TRANSFER_KARATSUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-karatsuglaze-gate-honesty-pack-rg-pointers.json` — Stage 1599 P1
- `docs/TRANSFER_BIZENGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bizenglaze-gate-honesty-pack-remaining-gate.json` — Stage 1598 I1
- `docs/TRANSFER_BIZENGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bizenglaze-gate-honesty-pack-rg-blockers.json` — Stage 1598 B1
- `docs/TRANSFER_BIZENGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bizenglaze-gate-honesty-pack-rg-pointers.json` — Stage 1598 P1
- `docs/TRANSFER_SETOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-setoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1597 I1
- `docs/TRANSFER_SETOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-setoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1597 B1
- `docs/TRANSFER_SETOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-setoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1597 P1
- `docs/TRANSFER_RAKUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rakuglaze-gate-honesty-pack-remaining-gate.json` — Stage 1596 I1
- `docs/TRANSFER_RAKUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rakuglaze-gate-honesty-pack-rg-blockers.json` — Stage 1596 B1
- `docs/TRANSFER_RAKUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rakuglaze-gate-honesty-pack-rg-pointers.json` — Stage 1596 P1
- `docs/TRANSFER_ORIBEGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-oribeglaze-gate-honesty-pack-remaining-gate.json` — Stage 1595 I1
- `docs/TRANSFER_ORIBEGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-oribeglaze-gate-honesty-pack-rg-blockers.json` — Stage 1595 B1
- `docs/TRANSFER_ORIBEGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-oribeglaze-gate-honesty-pack-rg-pointers.json` — Stage 1595 P1
- `docs/TRANSFER_SHINOGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shinoglaze-gate-honesty-pack-remaining-gate.json` — Stage 1594 I1
- `docs/TRANSFER_SHINOGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shinoglaze-gate-honesty-pack-rg-blockers.json` — Stage 1594 B1
- `docs/TRANSFER_SHINOGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shinoglaze-gate-honesty-pack-rg-pointers.json` — Stage 1594 P1
- `docs/TRANSFER_TENMOKUGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tenmokuglaze-gate-honesty-pack-remaining-gate.json` — Stage 1593 I1
- `docs/TRANSFER_TENMOKUGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tenmokuglaze-gate-honesty-pack-rg-blockers.json` — Stage 1593 B1
- `docs/TRANSFER_TENMOKUGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tenmokuglaze-gate-honesty-pack-rg-pointers.json` — Stage 1593 P1
- `docs/TRANSFER_CELADONGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-celadonglaze-gate-honesty-pack-remaining-gate.json` — Stage 1592 I1
- `docs/TRANSFER_CELADONGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-celadonglaze-gate-honesty-pack-rg-blockers.json` — Stage 1592 B1
- `docs/TRANSFER_CELADONGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-celadonglaze-gate-honesty-pack-rg-pointers.json` — Stage 1592 P1
- `docs/TRANSFER_ASHGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ashglaze-gate-honesty-pack-remaining-gate.json` — Stage 1591 I1
- `docs/TRANSFER_ASHGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ashglaze-gate-honesty-pack-rg-blockers.json` — Stage 1591 B1
- `docs/TRANSFER_ASHGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ashglaze-gate-honesty-pack-rg-pointers.json` — Stage 1591 P1
- `docs/TRANSFER_SALTGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-saltglaze-gate-honesty-pack-remaining-gate.json` — Stage 1590 I1
- `docs/TRANSFER_SALTGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-saltglaze-gate-honesty-pack-rg-blockers.json` — Stage 1590 B1
- `docs/TRANSFER_SALTGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-saltglaze-gate-honesty-pack-rg-pointers.json` — Stage 1590 P1
- `docs/TRANSFER_INGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-inglaze-gate-honesty-pack-remaining-gate.json` — Stage 1589 I1
- `docs/TRANSFER_INGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-inglaze-gate-honesty-pack-rg-blockers.json` — Stage 1589 B1
- `docs/TRANSFER_INGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-inglaze-gate-honesty-pack-rg-pointers.json` — Stage 1589 P1
- `docs/TRANSFER_OVERGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-overglaze-gate-honesty-pack-remaining-gate.json` — Stage 1588 I1
- `docs/TRANSFER_OVERGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-overglaze-gate-honesty-pack-rg-blockers.json` — Stage 1588 B1
- `docs/TRANSFER_OVERGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-overglaze-gate-honesty-pack-rg-pointers.json` — Stage 1588 P1
- `docs/TRANSFER_UNDERGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-underglaze-gate-honesty-pack-remaining-gate.json` — Stage 1587 I1
- `docs/TRANSFER_UNDERGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-underglaze-gate-honesty-pack-rg-blockers.json` — Stage 1587 B1
- `docs/TRANSFER_UNDERGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-underglaze-gate-honesty-pack-rg-pointers.json` — Stage 1587 P1
- `docs/TRANSFER_ENAMELGLAZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-enamelglaze-gate-honesty-pack-remaining-gate.json` — Stage 1586 I1
- `docs/TRANSFER_ENAMELGLAZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-enamelglaze-gate-honesty-pack-rg-blockers.json` — Stage 1586 B1
- `docs/TRANSFER_ENAMELGLAZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-enamelglaze-gate-honesty-pack-rg-pointers.json` — Stage 1586 P1
- `docs/TRANSFER_GLAZECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-glazecoat-gate-honesty-pack-remaining-gate.json` — Stage 1585 I1
- `docs/TRANSFER_GLAZECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-glazecoat-gate-honesty-pack-rg-blockers.json` — Stage 1585 B1
- `docs/TRANSFER_GLAZECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-glazecoat-gate-honesty-pack-rg-pointers.json` — Stage 1585 P1
- `docs/TRANSFER_PORCELAINCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-porcelaincoat-gate-honesty-pack-remaining-gate.json` — Stage 1584 I1
- `docs/TRANSFER_PORCELAINCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-porcelaincoat-gate-honesty-pack-rg-blockers.json` — Stage 1584 B1
- `docs/TRANSFER_PORCELAINCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-porcelaincoat-gate-honesty-pack-rg-pointers.json` — Stage 1584 P1
- `docs/TRANSFER_VITREOUSCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-vitreouscoat-gate-honesty-pack-remaining-gate.json` — Stage 1583 I1
- `docs/TRANSFER_VITREOUSCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-vitreouscoat-gate-honesty-pack-rg-blockers.json` — Stage 1583 B1
- `docs/TRANSFER_VITREOUSCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-vitreouscoat-gate-honesty-pack-rg-pointers.json` — Stage 1583 P1
- `docs/TRANSFER_GLASSCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-glasscoat-gate-honesty-pack-remaining-gate.json` — Stage 1582 I1
- `docs/TRANSFER_GLASSCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-glasscoat-gate-honesty-pack-rg-blockers.json` — Stage 1582 B1
- `docs/TRANSFER_GLASSCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-glasscoat-gate-honesty-pack-rg-pointers.json` — Stage 1582 P1
- `docs/TRANSFER_SILICACOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-silicacoat-gate-honesty-pack-remaining-gate.json` — Stage 1581 I1
- `docs/TRANSFER_SILICACOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-silicacoat-gate-honesty-pack-rg-blockers.json` — Stage 1581 B1
- `docs/TRANSFER_SILICACOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-silicacoat-gate-honesty-pack-rg-pointers.json` — Stage 1581 P1
- `docs/TRANSFER_QUARTZCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quartzcoat-gate-honesty-pack-remaining-gate.json` — Stage 1580 I1
- `docs/TRANSFER_QUARTZCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quartzcoat-gate-honesty-pack-rg-blockers.json` — Stage 1580 B1
- `docs/TRANSFER_QUARTZCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quartzcoat-gate-honesty-pack-rg-pointers.json` — Stage 1580 P1
- `docs/TRANSFER_DIAMONDCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-diamondcoat-gate-honesty-pack-remaining-gate.json` — Stage 1579 I1
- `docs/TRANSFER_DIAMONDCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-diamondcoat-gate-honesty-pack-rg-blockers.json` — Stage 1579 B1
- `docs/TRANSFER_DIAMONDCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-diamondcoat-gate-honesty-pack-rg-pointers.json` — Stage 1579 P1
- `docs/TRANSFER_GRAPHITECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-graphitecoat-gate-honesty-pack-remaining-gate.json` — Stage 1578 I1
- `docs/TRANSFER_GRAPHITECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-graphitecoat-gate-honesty-pack-rg-blockers.json` — Stage 1578 B1
- `docs/TRANSFER_GRAPHITECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-graphitecoat-gate-honesty-pack-rg-pointers.json` — Stage 1578 P1
- `docs/TRANSFER_CARBONCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-carboncoat-gate-honesty-pack-remaining-gate.json` — Stage 1577 I1
- `docs/TRANSFER_CARBONCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-carboncoat-gate-honesty-pack-rg-blockers.json` — Stage 1577 B1
- `docs/TRANSFER_CARBONCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-carboncoat-gate-honesty-pack-rg-pointers.json` — Stage 1577 P1
- `docs/TRANSFER_IRONCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ironcoat-gate-honesty-pack-remaining-gate.json` — Stage 1576 I1
- `docs/TRANSFER_IRONCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ironcoat-gate-honesty-pack-rg-blockers.json` — Stage 1576 B1
- `docs/TRANSFER_IRONCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ironcoat-gate-honesty-pack-rg-pointers.json` — Stage 1576 P1
- `docs/TRANSFER_STEELCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-steelcoat-gate-honesty-pack-remaining-gate.json` — Stage 1575 I1
- `docs/TRANSFER_STEELCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-steelcoat-gate-honesty-pack-rg-blockers.json` — Stage 1575 B1
- `docs/TRANSFER_STEELCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-steelcoat-gate-honesty-pack-rg-pointers.json` — Stage 1575 P1
- `docs/TRANSFER_ALUMINUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-aluminumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1574 I1
- `docs/TRANSFER_ALUMINUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-aluminumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1574 B1
- `docs/TRANSFER_ALUMINUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-aluminumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1574 P1
- `docs/TRANSFER_TITANIUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-titaniumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1573 I1
- `docs/TRANSFER_TITANIUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-titaniumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1573 B1
- `docs/TRANSFER_TITANIUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-titaniumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1573 P1
- `docs/TRANSFER_RUTHENIUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rutheniumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1572 I1
- `docs/TRANSFER_RUTHENIUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rutheniumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1572 B1
- `docs/TRANSFER_RUTHENIUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rutheniumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1572 P1
- `docs/TRANSFER_OSMIUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-osmiumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1571 I1
- `docs/TRANSFER_OSMIUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-osmiumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1571 B1
- `docs/TRANSFER_OSMIUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-osmiumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1571 P1
- `docs/TRANSFER_IRIDIUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-iridiumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1570 I1
- `docs/TRANSFER_IRIDIUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-iridiumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1570 B1
- `docs/TRANSFER_IRIDIUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-iridiumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1570 P1
- `docs/TRANSFER_RHODIUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rhodiumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1569 I1
- `docs/TRANSFER_RHODIUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rhodiumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1569 B1
- `docs/TRANSFER_RHODIUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rhodiumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1569 P1
- `docs/TRANSFER_PALLADIUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-palladiumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1568 I1
- `docs/TRANSFER_PALLADIUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-palladiumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1568 B1
- `docs/TRANSFER_PALLADIUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-palladiumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1568 P1
- `docs/TRANSFER_PLATINUMCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-platinumcoat-gate-honesty-pack-remaining-gate.json` — Stage 1567 I1
- `docs/TRANSFER_PLATINUMCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-platinumcoat-gate-honesty-pack-rg-blockers.json` — Stage 1567 B1
- `docs/TRANSFER_PLATINUMCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-platinumcoat-gate-honesty-pack-rg-pointers.json` — Stage 1567 P1
- `docs/TRANSFER_GOLDCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-goldcoat-gate-honesty-pack-remaining-gate.json` — Stage 1566 I1
- `docs/TRANSFER_GOLDCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-goldcoat-gate-honesty-pack-rg-blockers.json` — Stage 1566 B1
- `docs/TRANSFER_GOLDCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-goldcoat-gate-honesty-pack-rg-pointers.json` — Stage 1566 P1
- `docs/TRANSFER_SILVERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-silvercoat-gate-honesty-pack-remaining-gate.json` — Stage 1565 I1
- `docs/TRANSFER_SILVERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-silvercoat-gate-honesty-pack-rg-blockers.json` — Stage 1565 B1
- `docs/TRANSFER_SILVERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-silvercoat-gate-honesty-pack-rg-pointers.json` — Stage 1565 P1
- `docs/TRANSFER_BRONZECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bronzecoat-gate-honesty-pack-remaining-gate.json` — Stage 1564 I1
- `docs/TRANSFER_BRONZECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bronzecoat-gate-honesty-pack-rg-blockers.json` — Stage 1564 B1
- `docs/TRANSFER_BRONZECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bronzecoat-gate-honesty-pack-rg-pointers.json` — Stage 1564 P1
- `docs/TRANSFER_BRASSCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-brasscoat-gate-honesty-pack-remaining-gate.json` — Stage 1563 I1
- `docs/TRANSFER_BRASSCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-brasscoat-gate-honesty-pack-rg-blockers.json` — Stage 1563 B1
- `docs/TRANSFER_BRASSCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-brasscoat-gate-honesty-pack-rg-pointers.json` — Stage 1563 P1
- `docs/TRANSFER_COPPERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-coppercoat-gate-honesty-pack-remaining-gate.json` — Stage 1562 I1
- `docs/TRANSFER_COPPERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-coppercoat-gate-honesty-pack-rg-blockers.json` — Stage 1562 B1
- `docs/TRANSFER_COPPERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-coppercoat-gate-honesty-pack-rg-pointers.json` — Stage 1562 P1
- `docs/TRANSFER_ZINCCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-zinccoat-gate-honesty-pack-remaining-gate.json` — Stage 1561 I1
- `docs/TRANSFER_ZINCCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-zinccoat-gate-honesty-pack-rg-blockers.json` — Stage 1561 B1
- `docs/TRANSFER_ZINCCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-zinccoat-gate-honesty-pack-rg-pointers.json` — Stage 1561 P1
- `docs/TRANSFER_TINCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tincoat-gate-honesty-pack-remaining-gate.json` — Stage 1560 I1
- `docs/TRANSFER_TINCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tincoat-gate-honesty-pack-rg-blockers.json` — Stage 1560 B1
- `docs/TRANSFER_TINCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tincoat-gate-honesty-pack-rg-pointers.json` — Stage 1560 P1
- `docs/TRANSFER_NICKELCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nickelcoat-gate-honesty-pack-remaining-gate.json` — Stage 1559 I1
- `docs/TRANSFER_NICKELCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nickelcoat-gate-honesty-pack-rg-blockers.json` — Stage 1559 B1
- `docs/TRANSFER_NICKELCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nickelcoat-gate-honesty-pack-rg-pointers.json` — Stage 1559 P1
- `docs/TRANSFER_CHROMECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chromecoat-gate-honesty-pack-remaining-gate.json` — Stage 1558 I1
- `docs/TRANSFER_CHROMECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chromecoat-gate-honesty-pack-rg-blockers.json` — Stage 1558 B1
- `docs/TRANSFER_CHROMECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chromecoat-gate-honesty-pack-rg-pointers.json` — Stage 1558 P1
- `docs/TRANSFER_GALVANCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-galvancoat-gate-honesty-pack-remaining-gate.json` — Stage 1557 I1
- `docs/TRANSFER_GALVANCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-galvancoat-gate-honesty-pack-rg-blockers.json` — Stage 1557 B1
- `docs/TRANSFER_GALVANCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-galvancoat-gate-honesty-pack-rg-pointers.json` — Stage 1557 P1
- `docs/TRANSFER_PLATECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-platecoat-gate-honesty-pack-remaining-gate.json` — Stage 1556 I1
- `docs/TRANSFER_PLATECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-platecoat-gate-honesty-pack-rg-blockers.json` — Stage 1556 B1
- `docs/TRANSFER_PLATECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-platecoat-gate-honesty-pack-rg-pointers.json` — Stage 1556 P1
- `docs/TRANSFER_ANODIZECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-anodizecoat-gate-honesty-pack-remaining-gate.json` — Stage 1555 I1
- `docs/TRANSFER_ANODIZECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-anodizecoat-gate-honesty-pack-rg-blockers.json` — Stage 1555 B1
- `docs/TRANSFER_ANODIZECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-anodizecoat-gate-honesty-pack-rg-pointers.json` — Stage 1555 P1
- `docs/TRANSFER_CERAMICCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ceramiccoat-gate-honesty-pack-remaining-gate.json` — Stage 1554 I1
- `docs/TRANSFER_CERAMICCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ceramiccoat-gate-honesty-pack-rg-blockers.json` — Stage 1554 B1
- `docs/TRANSFER_CERAMICCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ceramiccoat-gate-honesty-pack-rg-pointers.json` — Stage 1554 P1
- `docs/TRANSFER_POWDERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-powdercoat-gate-honesty-pack-remaining-gate.json` — Stage 1553 I1
- `docs/TRANSFER_POWDERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-powdercoat-gate-honesty-pack-rg-blockers.json` — Stage 1553 B1
- `docs/TRANSFER_POWDERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-powdercoat-gate-honesty-pack-rg-pointers.json` — Stage 1553 P1
- `docs/TRANSFER_RUBBERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rubbercoat-gate-honesty-pack-remaining-gate.json` — Stage 1552 I1
- `docs/TRANSFER_RUBBERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rubbercoat-gate-honesty-pack-rg-blockers.json` — Stage 1552 B1
- `docs/TRANSFER_RUBBERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rubbercoat-gate-honesty-pack-rg-pointers.json` — Stage 1552 P1
- `docs/TRANSFER_VINYLCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-vinylcoat-gate-honesty-pack-remaining-gate.json` — Stage 1551 I1
- `docs/TRANSFER_VINYLCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-vinylcoat-gate-honesty-pack-rg-blockers.json` — Stage 1551 B1
- `docs/TRANSFER_VINYLCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-vinylcoat-gate-honesty-pack-rg-pointers.json` — Stage 1551 P1
- `docs/TRANSFER_ACRYLICCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-acryliccoat-gate-honesty-pack-remaining-gate.json` — Stage 1550 I1
- `docs/TRANSFER_ACRYLICCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-acryliccoat-gate-honesty-pack-rg-blockers.json` — Stage 1550 B1
- `docs/TRANSFER_ACRYLICCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-acryliccoat-gate-honesty-pack-rg-pointers.json` — Stage 1550 P1
- `docs/TRANSFER_POLYCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-polycoat-gate-honesty-pack-remaining-gate.json` — Stage 1549 I1
- `docs/TRANSFER_POLYCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-polycoat-gate-honesty-pack-rg-blockers.json` — Stage 1549 B1
- `docs/TRANSFER_POLYCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-polycoat-gate-honesty-pack-rg-pointers.json` — Stage 1549 P1
- `docs/TRANSFER_URETHANECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-urethanecoat-gate-honesty-pack-remaining-gate.json` — Stage 1548 I1
- `docs/TRANSFER_URETHANECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-urethanecoat-gate-honesty-pack-rg-blockers.json` — Stage 1548 B1
- `docs/TRANSFER_URETHANECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-urethanecoat-gate-honesty-pack-rg-pointers.json` — Stage 1548 P1
- `docs/TRANSFER_EPOXYCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-epoxycoat-gate-honesty-pack-remaining-gate.json` — Stage 1547 I1
- `docs/TRANSFER_EPOXYCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-epoxycoat-gate-honesty-pack-rg-blockers.json` — Stage 1547 B1
- `docs/TRANSFER_EPOXYCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-epoxycoat-gate-honesty-pack-rg-pointers.json` — Stage 1547 P1
- `docs/TRANSFER_ENAMELCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-enamelcoat-gate-honesty-pack-remaining-gate.json` — Stage 1546 I1
- `docs/TRANSFER_ENAMELCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-enamelcoat-gate-honesty-pack-rg-blockers.json` — Stage 1546 B1
- `docs/TRANSFER_ENAMELCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-enamelcoat-gate-honesty-pack-rg-pointers.json` — Stage 1546 P1
- `docs/TRANSFER_SHELLACCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shellaccoat-gate-honesty-pack-remaining-gate.json` — Stage 1545 I1
- `docs/TRANSFER_SHELLACCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shellaccoat-gate-honesty-pack-rg-blockers.json` — Stage 1545 B1
- `docs/TRANSFER_SHELLACCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shellaccoat-gate-honesty-pack-rg-pointers.json` — Stage 1545 P1
- `docs/TRANSFER_LACQUERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lacquercoat-gate-honesty-pack-remaining-gate.json` — Stage 1544 I1
- `docs/TRANSFER_LACQUERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lacquercoat-gate-honesty-pack-rg-blockers.json` — Stage 1544 B1
- `docs/TRANSFER_LACQUERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lacquercoat-gate-honesty-pack-rg-pointers.json` — Stage 1544 P1
- `docs/TRANSFER_OILCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-oilcoat-gate-honesty-pack-remaining-gate.json` — Stage 1543 I1
- `docs/TRANSFER_OILCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-oilcoat-gate-honesty-pack-rg-blockers.json` — Stage 1543 B1
- `docs/TRANSFER_OILCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-oilcoat-gate-honesty-pack-rg-pointers.json` — Stage 1543 P1
- `docs/TRANSFER_WAXCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-waxcoat-gate-honesty-pack-remaining-gate.json` — Stage 1542 I1
- `docs/TRANSFER_WAXCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-waxcoat-gate-honesty-pack-rg-blockers.json` — Stage 1542 B1
- `docs/TRANSFER_WAXCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-waxcoat-gate-honesty-pack-rg-pointers.json` — Stage 1542 P1
- `docs/TRANSFER_SEALCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sealcoat-gate-honesty-pack-remaining-gate.json` — Stage 1541 I1
- `docs/TRANSFER_SEALCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sealcoat-gate-honesty-pack-rg-blockers.json` — Stage 1541 B1
- `docs/TRANSFER_SEALCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sealcoat-gate-honesty-pack-rg-pointers.json` — Stage 1541 P1
- `docs/TRANSFER_MIDCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-midcoat-gate-honesty-pack-remaining-gate.json` — Stage 1540 I1
- `docs/TRANSFER_MIDCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-midcoat-gate-honesty-pack-rg-blockers.json` — Stage 1540 B1
- `docs/TRANSFER_MIDCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-midcoat-gate-honesty-pack-rg-pointers.json` — Stage 1540 P1
- `docs/TRANSFER_UNDERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-undercoat-gate-honesty-pack-remaining-gate.json` — Stage 1539 I1
- `docs/TRANSFER_UNDERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-undercoat-gate-honesty-pack-rg-blockers.json` — Stage 1539 B1
- `docs/TRANSFER_UNDERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-undercoat-gate-honesty-pack-rg-pointers.json` — Stage 1539 P1
- `docs/TRANSFER_PRIMERCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-primercoat-gate-honesty-pack-remaining-gate.json` — Stage 1538 I1
- `docs/TRANSFER_PRIMERCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-primercoat-gate-honesty-pack-rg-blockers.json` — Stage 1538 B1
- `docs/TRANSFER_PRIMERCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-primercoat-gate-honesty-pack-rg-pointers.json` — Stage 1538 P1
- `docs/TRANSFER_TOPCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-topcoat-gate-honesty-pack-remaining-gate.json` — Stage 1537 I1
- `docs/TRANSFER_TOPCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-topcoat-gate-honesty-pack-rg-blockers.json` — Stage 1537 B1
- `docs/TRANSFER_TOPCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-topcoat-gate-honesty-pack-rg-pointers.json` — Stage 1537 P1
- `docs/TRANSFER_BASECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-basecoat-gate-honesty-pack-remaining-gate.json` — Stage 1536 I1
- `docs/TRANSFER_BASECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-basecoat-gate-honesty-pack-rg-blockers.json` — Stage 1536 B1
- `docs/TRANSFER_BASECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-basecoat-gate-honesty-pack-rg-pointers.json` — Stage 1536 P1
- `docs/TRANSFER_CLEARCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clearcoat-gate-honesty-pack-remaining-gate.json` — Stage 1535 I1
- `docs/TRANSFER_CLEARCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clearcoat-gate-honesty-pack-rg-blockers.json` — Stage 1535 B1
- `docs/TRANSFER_CLEARCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clearcoat-gate-honesty-pack-rg-pointers.json` — Stage 1535 P1
- `docs/TRANSFER_HARDCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hardcoat-gate-honesty-pack-remaining-gate.json` — Stage 1534 I1
- `docs/TRANSFER_HARDCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hardcoat-gate-honesty-pack-rg-blockers.json` — Stage 1534 B1
- `docs/TRANSFER_HARDCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hardcoat-gate-honesty-pack-rg-pointers.json` — Stage 1534 P1
- `docs/TRANSFER_SOFTCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-softcoat-gate-honesty-pack-remaining-gate.json` — Stage 1533 I1
- `docs/TRANSFER_SOFTCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-softcoat-gate-honesty-pack-rg-blockers.json` — Stage 1533 B1
- `docs/TRANSFER_SOFTCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-softcoat-gate-honesty-pack-rg-pointers.json` — Stage 1533 P1
- `docs/TRANSFER_METALCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-metalcoat-gate-honesty-pack-remaining-gate.json` — Stage 1532 I1
- `docs/TRANSFER_METALCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-metalcoat-gate-honesty-pack-rg-blockers.json` — Stage 1532 B1
- `docs/TRANSFER_METALCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-metalcoat-gate-honesty-pack-rg-pointers.json` — Stage 1532 P1
- `docs/TRANSFER_PEARLCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pearlcoat-gate-honesty-pack-remaining-gate.json` — Stage 1531 I1
- `docs/TRANSFER_PEARLCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pearlcoat-gate-honesty-pack-rg-blockers.json` — Stage 1531 B1
- `docs/TRANSFER_PEARLCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pearlcoat-gate-honesty-pack-rg-pointers.json` — Stage 1531 P1
- `docs/TRANSFER_CASTCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-castcoat-gate-honesty-pack-remaining-gate.json` — Stage 1530 I1
- `docs/TRANSFER_CASTCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-castcoat-gate-honesty-pack-rg-blockers.json` — Stage 1530 B1
- `docs/TRANSFER_CASTCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-castcoat-gate-honesty-pack-rg-pointers.json` — Stage 1530 P1
- `docs/TRANSFER_DULLCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dullcoat-gate-honesty-pack-remaining-gate.json` — Stage 1529 I1
- `docs/TRANSFER_DULLCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dullcoat-gate-honesty-pack-rg-blockers.json` — Stage 1529 B1
- `docs/TRANSFER_DULLCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dullcoat-gate-honesty-pack-rg-pointers.json` — Stage 1529 P1
- `docs/TRANSFER_SATINCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-satincoat-gate-honesty-pack-remaining-gate.json` — Stage 1528 I1
- `docs/TRANSFER_SATINCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-satincoat-gate-honesty-pack-rg-blockers.json` — Stage 1528 B1
- `docs/TRANSFER_SATINCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-satincoat-gate-honesty-pack-rg-pointers.json` — Stage 1528 P1
- `docs/TRANSFER_SILKCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-silkcoat-gate-honesty-pack-remaining-gate.json` — Stage 1527 I1
- `docs/TRANSFER_SILKCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-silkcoat-gate-honesty-pack-rg-blockers.json` — Stage 1527 B1
- `docs/TRANSFER_SILKCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-silkcoat-gate-honesty-pack-rg-pointers.json` — Stage 1527 P1
- `docs/TRANSFER_DRIPOFF_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dripoff-gate-honesty-pack-remaining-gate.json` — Stage 1526 I1
- `docs/TRANSFER_DRIPOFF_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dripoff-gate-honesty-pack-rg-blockers.json` — Stage 1526 B1
- `docs/TRANSFER_DRIPOFF_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dripoff-gate-honesty-pack-rg-pointers.json` — Stage 1526 P1
- `docs/TRANSFER_FLOODCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-floodcoat-gate-honesty-pack-remaining-gate.json` — Stage 1525 I1
- `docs/TRANSFER_FLOODCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-floodcoat-gate-honesty-pack-rg-blockers.json` — Stage 1525 B1
- `docs/TRANSFER_FLOODCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-floodcoat-gate-honesty-pack-rg-pointers.json` — Stage 1525 P1
- `docs/TRANSFER_GLOSSCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-glosscoat-gate-honesty-pack-remaining-gate.json` — Stage 1524 I1
- `docs/TRANSFER_GLOSSCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-glosscoat-gate-honesty-pack-rg-blockers.json` — Stage 1524 B1
- `docs/TRANSFER_GLOSSCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-glosscoat-gate-honesty-pack-rg-pointers.json` — Stage 1524 P1
- `docs/TRANSFER_MATTECOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mattecoat-gate-honesty-pack-remaining-gate.json` — Stage 1523 I1
- `docs/TRANSFER_MATTECOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mattecoat-gate-honesty-pack-rg-blockers.json` — Stage 1523 B1
- `docs/TRANSFER_MATTECOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mattecoat-gate-honesty-pack-rg-pointers.json` — Stage 1523 P1
- `docs/TRANSFER_UVCOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-uvcoat-gate-honesty-pack-remaining-gate.json` — Stage 1522 I1
- `docs/TRANSFER_UVCOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-uvcoat-gate-honesty-pack-rg-blockers.json` — Stage 1522 B1
- `docs/TRANSFER_UVCOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-uvcoat-gate-honesty-pack-rg-pointers.json` — Stage 1522 P1
- `docs/TRANSFER_AQUEOUS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-aqueous-gate-honesty-pack-remaining-gate.json` — Stage 1521 I1
- `docs/TRANSFER_AQUEOUS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-aqueous-gate-honesty-pack-rg-blockers.json` — Stage 1521 B1
- `docs/TRANSFER_AQUEOUS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-aqueous-gate-honesty-pack-rg-pointers.json` — Stage 1521 P1
- `docs/TRANSFER_LAMINATE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-laminate-gate-honesty-pack-remaining-gate.json` — Stage 1520 I1
- `docs/TRANSFER_LAMINATE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-laminate-gate-honesty-pack-rg-blockers.json` — Stage 1520 B1
- `docs/TRANSFER_LAMINATE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-laminate-gate-honesty-pack-rg-pointers.json` — Stage 1520 P1
- `docs/TRANSFER_VARNISH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-varnish-gate-honesty-pack-remaining-gate.json` — Stage 1519 I1
- `docs/TRANSFER_VARNISH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-varnish-gate-honesty-pack-rg-blockers.json` — Stage 1519 B1
- `docs/TRANSFER_VARNISH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-varnish-gate-honesty-pack-rg-pointers.json` — Stage 1519 P1
- `docs/TRANSFER_SOFTTOUCH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-softtouch-gate-honesty-pack-remaining-gate.json` — Stage 1518 I1
- `docs/TRANSFER_SOFTTOUCH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-softtouch-gate-honesty-pack-rg-blockers.json` — Stage 1518 B1
- `docs/TRANSFER_SOFTTOUCH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-softtouch-gate-honesty-pack-rg-pointers.json` — Stage 1518 P1
- `docs/TRANSFER_SPOTUV_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spotuv-gate-honesty-pack-remaining-gate.json` — Stage 1517 I1
- `docs/TRANSFER_SPOTUV_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spotuv-gate-honesty-pack-rg-blockers.json` — Stage 1517 B1
- `docs/TRANSFER_SPOTUV_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spotuv-gate-honesty-pack-rg-pointers.json` — Stage 1517 P1
- `docs/TRANSFER_BLINDSTAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-blindstamp-gate-honesty-pack-remaining-gate.json` — Stage 1516 I1
- `docs/TRANSFER_BLINDSTAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-blindstamp-gate-honesty-pack-rg-blockers.json` — Stage 1516 B1
- `docs/TRANSFER_BLINDSTAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-blindstamp-gate-honesty-pack-rg-pointers.json` — Stage 1516 P1
- `docs/TRANSFER_DEBOSFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-debosform-gate-honesty-pack-remaining-gate.json` — Stage 1515 I1
- `docs/TRANSFER_DEBOSFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-debosform-gate-honesty-pack-rg-blockers.json` — Stage 1515 B1
- `docs/TRANSFER_DEBOSFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-debosform-gate-honesty-pack-rg-pointers.json` — Stage 1515 P1
- `docs/TRANSFER_HOTSTAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hotstamp-gate-honesty-pack-remaining-gate.json` — Stage 1514 I1
- `docs/TRANSFER_HOTSTAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hotstamp-gate-honesty-pack-rg-blockers.json` — Stage 1514 B1
- `docs/TRANSFER_HOTSTAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hotstamp-gate-honesty-pack-rg-pointers.json` — Stage 1514 P1
- `docs/TRANSFER_EMBOSSDIE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-embossdie-gate-honesty-pack-remaining-gate.json` — Stage 1513 I1
- `docs/TRANSFER_EMBOSSDIE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-embossdie-gate-honesty-pack-rg-blockers.json` — Stage 1513 B1
- `docs/TRANSFER_EMBOSSDIE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-embossdie-gate-honesty-pack-rg-pointers.json` — Stage 1513 P1
- `docs/TRANSFER_CREASEDIE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-creasedie-gate-honesty-pack-remaining-gate.json` — Stage 1512 I1
- `docs/TRANSFER_CREASEDIE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-creasedie-gate-honesty-pack-rg-blockers.json` — Stage 1512 B1
- `docs/TRANSFER_CREASEDIE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-creasedie-gate-honesty-pack-rg-pointers.json` — Stage 1512 P1
- `docs/TRANSFER_FOILFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-foilform-gate-honesty-pack-remaining-gate.json` — Stage 1511 I1
- `docs/TRANSFER_FOILFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-foilform-gate-honesty-pack-rg-blockers.json` — Stage 1511 B1
- `docs/TRANSFER_FOILFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-foilform-gate-honesty-pack-rg-pointers.json` — Stage 1511 P1
- `docs/TRANSFER_COUNTERFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-counterform-gate-honesty-pack-remaining-gate.json` — Stage 1510 I1
- `docs/TRANSFER_COUNTERFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-counterform-gate-honesty-pack-rg-blockers.json` — Stage 1510 B1
- `docs/TRANSFER_COUNTERFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-counterform-gate-honesty-pack-rg-pointers.json` — Stage 1510 P1
- `docs/TRANSFER_WINDOWFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-windowform-gate-honesty-pack-remaining-gate.json` — Stage 1509 I1
- `docs/TRANSFER_WINDOWFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-windowform-gate-honesty-pack-rg-blockers.json` — Stage 1509 B1
- `docs/TRANSFER_WINDOWFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-windowform-gate-honesty-pack-rg-pointers.json` — Stage 1509 P1
- `docs/TRANSFER_RULEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ruleform-gate-honesty-pack-remaining-gate.json` — Stage 1508 I1
- `docs/TRANSFER_RULEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ruleform-gate-honesty-pack-rg-blockers.json` — Stage 1508 B1
- `docs/TRANSFER_RULEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ruleform-gate-honesty-pack-rg-pointers.json` — Stage 1508 P1
- `docs/TRANSFER_KISSFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kissform-gate-honesty-pack-remaining-gate.json` — Stage 1507 I1
- `docs/TRANSFER_KISSFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kissform-gate-honesty-pack-rg-blockers.json` — Stage 1507 B1
- `docs/TRANSFER_KISSFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kissform-gate-honesty-pack-rg-pointers.json` — Stage 1507 P1
- `docs/TRANSFER_TABFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tabform-gate-honesty-pack-remaining-gate.json` — Stage 1506 I1
- `docs/TRANSFER_TABFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tabform-gate-honesty-pack-rg-blockers.json` — Stage 1506 B1
- `docs/TRANSFER_TABFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tabform-gate-honesty-pack-rg-pointers.json` — Stage 1506 P1
- `docs/TRANSFER_SLOTFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-slotform-gate-honesty-pack-remaining-gate.json` — Stage 1505 I1
- `docs/TRANSFER_SLOTFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-slotform-gate-honesty-pack-rg-blockers.json` — Stage 1505 B1
- `docs/TRANSFER_SLOTFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-slotform-gate-honesty-pack-rg-pointers.json` — Stage 1505 P1
- `docs/TRANSFER_PERFFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-perfform-gate-honesty-pack-remaining-gate.json` — Stage 1504 I1
- `docs/TRANSFER_PERFFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-perfform-gate-honesty-pack-rg-blockers.json` — Stage 1504 B1
- `docs/TRANSFER_PERFFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-perfform-gate-honesty-pack-rg-pointers.json` — Stage 1504 P1
- `docs/TRANSFER_PUNCHFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-punchform-gate-honesty-pack-remaining-gate.json` — Stage 1503 I1
- `docs/TRANSFER_PUNCHFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-punchform-gate-honesty-pack-rg-blockers.json` — Stage 1503 B1
- `docs/TRANSFER_PUNCHFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-punchform-gate-honesty-pack-rg-pointers.json` — Stage 1503 P1
- `docs/TRANSFER_DIECUTFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-diecutform-gate-honesty-pack-remaining-gate.json` — Stage 1502 I1
- `docs/TRANSFER_DIECUTFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-diecutform-gate-honesty-pack-rg-blockers.json` — Stage 1502 B1
- `docs/TRANSFER_DIECUTFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-diecutform-gate-honesty-pack-rg-pointers.json` — Stage 1502 P1
- `docs/TRANSFER_SHEARFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shearform-gate-honesty-pack-remaining-gate.json` — Stage 1501 I1
- `docs/TRANSFER_SHEARFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shearform-gate-honesty-pack-rg-blockers.json` — Stage 1501 B1
- `docs/TRANSFER_SHEARFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shearform-gate-honesty-pack-rg-pointers.json` — Stage 1501 P1
- `docs/TRANSFER_SCOREFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-scoreform-gate-honesty-pack-remaining-gate.json` — Stage 1500 I1
- `docs/TRANSFER_SCOREFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-scoreform-gate-honesty-pack-rg-blockers.json` — Stage 1500 B1
- `docs/TRANSFER_SCOREFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-scoreform-gate-honesty-pack-rg-pointers.json` — Stage 1500 P1
- `docs/TRANSFER_LANCINGFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lancingform-gate-honesty-pack-remaining-gate.json` — Stage 1499 I1
- `docs/TRANSFER_LANCINGFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lancingform-gate-honesty-pack-rg-blockers.json` — Stage 1499 B1
- `docs/TRANSFER_LANCINGFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lancingform-gate-honesty-pack-rg-pointers.json` — Stage 1499 P1
- `docs/TRANSFER_NIBBLEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nibbleform-gate-honesty-pack-remaining-gate.json` — Stage 1498 I1
- `docs/TRANSFER_NIBBLEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nibbleform-gate-honesty-pack-rg-blockers.json` — Stage 1498 B1
- `docs/TRANSFER_NIBBLEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nibbleform-gate-honesty-pack-rg-pointers.json` — Stage 1498 P1
- `docs/TRANSFER_SLITFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-slitform-gate-honesty-pack-remaining-gate.json` — Stage 1497 I1
- `docs/TRANSFER_SLITFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-slitform-gate-honesty-pack-rg-blockers.json` — Stage 1497 B1
- `docs/TRANSFER_SLITFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-slitform-gate-honesty-pack-rg-pointers.json` — Stage 1497 P1
- `docs/TRANSFER_NOTCHFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-notchform-gate-honesty-pack-remaining-gate.json` — Stage 1496 I1
- `docs/TRANSFER_NOTCHFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-notchform-gate-honesty-pack-rg-blockers.json` — Stage 1496 B1
- `docs/TRANSFER_NOTCHFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-notchform-gate-honesty-pack-rg-pointers.json` — Stage 1496 P1
- `docs/TRANSFER_TRIMFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-trimform-gate-honesty-pack-remaining-gate.json` — Stage 1495 I1
- `docs/TRANSFER_TRIMFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-trimform-gate-honesty-pack-rg-blockers.json` — Stage 1495 B1
- `docs/TRANSFER_TRIMFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-trimform-gate-honesty-pack-rg-pointers.json` — Stage 1495 P1
- `docs/TRANSFER_PIERCEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pierceform-gate-honesty-pack-remaining-gate.json` — Stage 1494 I1
- `docs/TRANSFER_PIERCEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pierceform-gate-honesty-pack-rg-blockers.json` — Stage 1494 B1
- `docs/TRANSFER_PIERCEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pierceform-gate-honesty-pack-rg-pointers.json` — Stage 1494 P1
- `docs/TRANSFER_BLANKFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-blankform-gate-honesty-pack-remaining-gate.json` — Stage 1493 I1
- `docs/TRANSFER_BLANKFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-blankform-gate-honesty-pack-rg-blockers.json` — Stage 1493 B1
- `docs/TRANSFER_BLANKFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-blankform-gate-honesty-pack-rg-pointers.json` — Stage 1493 P1
- `docs/TRANSFER_COINFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-coinform-gate-honesty-pack-remaining-gate.json` — Stage 1492 I1
- `docs/TRANSFER_COINFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-coinform-gate-honesty-pack-rg-blockers.json` — Stage 1492 B1
- `docs/TRANSFER_COINFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-coinform-gate-honesty-pack-rg-pointers.json` — Stage 1492 P1
- `docs/TRANSFER_FORGEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-forgeform-gate-honesty-pack-remaining-gate.json` — Stage 1491 I1
- `docs/TRANSFER_FORGEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-forgeform-gate-honesty-pack-rg-blockers.json` — Stage 1491 B1
- `docs/TRANSFER_FORGEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-forgeform-gate-honesty-pack-rg-pointers.json` — Stage 1491 P1
- `docs/TRANSFER_STAMPFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stampform-gate-honesty-pack-remaining-gate.json` — Stage 1490 I1
- `docs/TRANSFER_STAMPFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stampform-gate-honesty-pack-rg-blockers.json` — Stage 1490 B1
- `docs/TRANSFER_STAMPFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stampform-gate-honesty-pack-rg-pointers.json` — Stage 1490 P1
- `docs/TRANSFER_EMBOSSFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-embossform-gate-honesty-pack-remaining-gate.json` — Stage 1489 I1
- `docs/TRANSFER_EMBOSSFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-embossform-gate-honesty-pack-rg-blockers.json` — Stage 1489 B1
- `docs/TRANSFER_EMBOSSFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-embossform-gate-honesty-pack-rg-pointers.json` — Stage 1489 P1
- `docs/TRANSFER_OFFSETFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-offsetform-gate-honesty-pack-remaining-gate.json` — Stage 1488 I1
- `docs/TRANSFER_OFFSETFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-offsetform-gate-honesty-pack-rg-blockers.json` — Stage 1488 B1
- `docs/TRANSFER_OFFSETFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-offsetform-gate-honesty-pack-rg-pointers.json` — Stage 1488 P1
- `docs/TRANSFER_JOGGLEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-joggleform-gate-honesty-pack-remaining-gate.json` — Stage 1487 I1
- `docs/TRANSFER_JOGGLEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-joggleform-gate-honesty-pack-rg-blockers.json` — Stage 1487 B1
- `docs/TRANSFER_JOGGLEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-joggleform-gate-honesty-pack-rg-pointers.json` — Stage 1487 P1
- `docs/TRANSFER_BEADFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-beadform-gate-honesty-pack-remaining-gate.json` — Stage 1486 I1
- `docs/TRANSFER_BEADFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-beadform-gate-honesty-pack-rg-blockers.json` — Stage 1486 B1
- `docs/TRANSFER_BEADFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-beadform-gate-honesty-pack-rg-pointers.json` — Stage 1486 P1
- `docs/TRANSFER_CURLFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-curlform-gate-honesty-pack-remaining-gate.json` — Stage 1485 I1
- `docs/TRANSFER_CURLFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-curlform-gate-honesty-pack-rg-blockers.json` — Stage 1485 B1
- `docs/TRANSFER_CURLFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-curlform-gate-honesty-pack-rg-pointers.json` — Stage 1485 P1
- `docs/TRANSFER_HEMFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hemform-gate-honesty-pack-remaining-gate.json` — Stage 1484 I1
- `docs/TRANSFER_HEMFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hemform-gate-honesty-pack-rg-blockers.json` — Stage 1484 B1
- `docs/TRANSFER_HEMFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hemform-gate-honesty-pack-rg-pointers.json` — Stage 1484 P1
- `docs/TRANSFER_EDGEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-edgeform-gate-honesty-pack-remaining-gate.json` — Stage 1483 I1
- `docs/TRANSFER_EDGEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-edgeform-gate-honesty-pack-rg-blockers.json` — Stage 1483 B1
- `docs/TRANSFER_EDGEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-edgeform-gate-honesty-pack-rg-pointers.json` — Stage 1483 P1
- `docs/TRANSFER_FLANGEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-flangeform-gate-honesty-pack-remaining-gate.json` — Stage 1482 I1
- `docs/TRANSFER_FLANGEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-flangeform-gate-honesty-pack-rg-blockers.json` — Stage 1482 B1
- `docs/TRANSFER_FLANGEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-flangeform-gate-honesty-pack-rg-pointers.json` — Stage 1482 P1
- `docs/TRANSFER_CREASEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-creaseform-gate-honesty-pack-remaining-gate.json` — Stage 1481 I1
- `docs/TRANSFER_CREASEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-creaseform-gate-honesty-pack-rg-blockers.json` — Stage 1481 B1
- `docs/TRANSFER_CREASEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-creaseform-gate-honesty-pack-rg-pointers.json` — Stage 1481 P1
- `docs/TRANSFER_PANELFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-panelform-gate-honesty-pack-remaining-gate.json` — Stage 1480 I1
- `docs/TRANSFER_PANELFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-panelform-gate-honesty-pack-rg-blockers.json` — Stage 1480 B1
- `docs/TRANSFER_PANELFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-panelform-gate-honesty-pack-rg-pointers.json` — Stage 1480 P1
- `docs/TRANSFER_SWEEPFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sweepform-gate-honesty-pack-remaining-gate.json` — Stage 1479 I1
- `docs/TRANSFER_SWEEPFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sweepform-gate-honesty-pack-rg-blockers.json` — Stage 1479 B1
- `docs/TRANSFER_SWEEPFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sweepform-gate-honesty-pack-rg-pointers.json` — Stage 1479 P1
- `docs/TRANSFER_BULGEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bulgeform-gate-honesty-pack-remaining-gate.json` — Stage 1478 I1
- `docs/TRANSFER_BULGEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bulgeform-gate-honesty-pack-rg-blockers.json` — Stage 1478 B1
- `docs/TRANSFER_BULGEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bulgeform-gate-honesty-pack-rg-pointers.json` — Stage 1478 P1
- `docs/TRANSFER_TUBEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tubeform-gate-honesty-pack-remaining-gate.json` — Stage 1477 I1
- `docs/TRANSFER_TUBEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tubeform-gate-honesty-pack-rg-blockers.json` — Stage 1477 B1
- `docs/TRANSFER_TUBEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tubeform-gate-honesty-pack-rg-pointers.json` — Stage 1477 P1
- `docs/TRANSFER_ROLLBEND_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rollbend-gate-honesty-pack-remaining-gate.json` — Stage 1476 I1
- `docs/TRANSFER_ROLLBEND_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rollbend-gate-honesty-pack-rg-blockers.json` — Stage 1476 B1
- `docs/TRANSFER_ROLLBEND_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rollbend-gate-honesty-pack-rg-pointers.json` — Stage 1476 P1
- `docs/TRANSFER_FLOWFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-flowform-gate-honesty-pack-remaining-gate.json` — Stage 1475 I1
- `docs/TRANSFER_FLOWFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-flowform-gate-honesty-pack-rg-blockers.json` — Stage 1475 B1
- `docs/TRANSFER_FLOWFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-flowform-gate-honesty-pack-rg-pointers.json` — Stage 1475 P1
- `docs/TRANSFER_SUPERFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-superform-gate-honesty-pack-remaining-gate.json` — Stage 1474 I1
- `docs/TRANSFER_SUPERFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-superform-gate-honesty-pack-rg-blockers.json` — Stage 1474 B1
- `docs/TRANSFER_SUPERFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-superform-gate-honesty-pack-rg-pointers.json` — Stage 1474 P1
- `docs/TRANSFER_HYDROFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hydroform-gate-honesty-pack-remaining-gate.json` — Stage 1473 I1
- `docs/TRANSFER_HYDROFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hydroform-gate-honesty-pack-rg-blockers.json` — Stage 1473 B1
- `docs/TRANSFER_HYDROFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hydroform-gate-honesty-pack-rg-pointers.json` — Stage 1473 P1
- `docs/TRANSFER_STRETCHFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stretchform-gate-honesty-pack-remaining-gate.json` — Stage 1472 I1
- `docs/TRANSFER_STRETCHFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stretchform-gate-honesty-pack-rg-blockers.json` — Stage 1472 B1
- `docs/TRANSFER_STRETCHFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stretchform-gate-honesty-pack-rg-pointers.json` — Stage 1472 P1
- `docs/TRANSFER_SPINFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spinform-gate-honesty-pack-remaining-gate.json` — Stage 1471 I1
- `docs/TRANSFER_SPINFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spinform-gate-honesty-pack-rg-blockers.json` — Stage 1471 B1
- `docs/TRANSFER_SPINFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spinform-gate-honesty-pack-rg-pointers.json` — Stage 1471 P1
- `docs/TRANSFER_PRESSFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pressform-gate-honesty-pack-remaining-gate.json` — Stage 1470 I1
- `docs/TRANSFER_PRESSFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pressform-gate-honesty-pack-rg-blockers.json` — Stage 1470 B1
- `docs/TRANSFER_PRESSFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pressform-gate-honesty-pack-rg-pointers.json` — Stage 1470 P1
- `docs/TRANSFER_BENDFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bendform-gate-honesty-pack-remaining-gate.json` — Stage 1469 I1
- `docs/TRANSFER_BENDFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bendform-gate-honesty-pack-rg-blockers.json` — Stage 1469 B1
- `docs/TRANSFER_BENDFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bendform-gate-honesty-pack-rg-pointers.json` — Stage 1469 P1
- `docs/TRANSFER_ROLLFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rollform-gate-honesty-pack-remaining-gate.json` — Stage 1468 I1
- `docs/TRANSFER_ROLLFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rollform-gate-honesty-pack-rg-blockers.json` — Stage 1468 B1
- `docs/TRANSFER_ROLLFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rollform-gate-honesty-pack-rg-pointers.json` — Stage 1468 P1
- `docs/TRANSFER_DRAWFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-drawform-gate-honesty-pack-remaining-gate.json` — Stage 1467 I1
- `docs/TRANSFER_DRAWFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-drawform-gate-honesty-pack-rg-blockers.json` — Stage 1467 B1
- `docs/TRANSFER_DRAWFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-drawform-gate-honesty-pack-rg-pointers.json` — Stage 1467 P1
- `docs/TRANSFER_EXTRUDE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-extrude-gate-honesty-pack-remaining-gate.json` — Stage 1466 I1
- `docs/TRANSFER_EXTRUDE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-extrude-gate-honesty-pack-rg-blockers.json` — Stage 1466 B1
- `docs/TRANSFER_EXTRUDE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-extrude-gate-honesty-pack-rg-pointers.json` — Stage 1466 P1
- `docs/TRANSFER_UPSET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-upset-gate-honesty-pack-remaining-gate.json` — Stage 1465 I1
- `docs/TRANSFER_UPSET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-upset-gate-honesty-pack-rg-blockers.json` — Stage 1465 B1
- `docs/TRANSFER_UPSET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-upset-gate-honesty-pack-rg-pointers.json` — Stage 1465 P1
- `docs/TRANSFER_SWAGEFORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-swageform-gate-honesty-pack-remaining-gate.json` — Stage 1464 I1
- `docs/TRANSFER_SWAGEFORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-swageform-gate-honesty-pack-rg-blockers.json` — Stage 1464 B1
- `docs/TRANSFER_SWAGEFORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-swageform-gate-honesty-pack-rg-pointers.json` — Stage 1464 P1
- `docs/TRANSFER_FORGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-forge-gate-honesty-pack-remaining-gate.json` — Stage 1463 I1
- `docs/TRANSFER_FORGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-forge-gate-honesty-pack-rg-blockers.json` — Stage 1463 B1
- `docs/TRANSFER_FORGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-forge-gate-honesty-pack-rg-pointers.json` — Stage 1463 P1
- `docs/TRANSFER_STAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stamp-gate-honesty-pack-remaining-gate.json` — Stage 1462 I1
- `docs/TRANSFER_STAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stamp-gate-honesty-pack-rg-blockers.json` — Stage 1462 B1
- `docs/TRANSFER_STAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stamp-gate-honesty-pack-rg-pointers.json` — Stage 1462 P1
- `docs/TRANSFER_EMBOSS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-emboss-gate-honesty-pack-remaining-gate.json` — Stage 1461 I1
- `docs/TRANSFER_EMBOSS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-emboss-gate-honesty-pack-rg-blockers.json` — Stage 1461 B1
- `docs/TRANSFER_EMBOSS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-emboss-gate-honesty-pack-rg-pointers.json` — Stage 1461 P1
- `docs/TRANSFER_OFFSET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-offset-gate-honesty-pack-remaining-gate.json` — Stage 1460 I1
- `docs/TRANSFER_OFFSET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-offset-gate-honesty-pack-rg-blockers.json` — Stage 1460 B1
- `docs/TRANSFER_OFFSET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-offset-gate-honesty-pack-rg-pointers.json` — Stage 1460 P1
- `docs/TRANSFER_JOGGLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-joggle-gate-honesty-pack-remaining-gate.json` — Stage 1459 I1
- `docs/TRANSFER_JOGGLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-joggle-gate-honesty-pack-rg-blockers.json` — Stage 1459 B1
- `docs/TRANSFER_JOGGLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-joggle-gate-honesty-pack-rg-pointers.json` — Stage 1459 P1
- `docs/TRANSFER_CURL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-curl-gate-honesty-pack-remaining-gate.json` — Stage 1458 I1
- `docs/TRANSFER_CURL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-curl-gate-honesty-pack-rg-blockers.json` — Stage 1458 B1
- `docs/TRANSFER_CURL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-curl-gate-honesty-pack-rg-pointers.json` — Stage 1458 P1
- `docs/TRANSFER_HEM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hem-gate-honesty-pack-remaining-gate.json` — Stage 1457 I1
- `docs/TRANSFER_HEM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hem-gate-honesty-pack-rg-blockers.json` — Stage 1457 B1
- `docs/TRANSFER_HEM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hem-gate-honesty-pack-rg-pointers.json` — Stage 1457 P1
- `docs/TRANSFER_BEAD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bead-gate-honesty-pack-remaining-gate.json` — Stage 1456 I1
- `docs/TRANSFER_BEAD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bead-gate-honesty-pack-rg-blockers.json` — Stage 1456 B1
- `docs/TRANSFER_BEAD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bead-gate-honesty-pack-rg-pointers.json` — Stage 1456 P1
- `docs/TRANSFER_CREASE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crease-gate-honesty-pack-remaining-gate.json` — Stage 1455 I1
- `docs/TRANSFER_CREASE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crease-gate-honesty-pack-rg-blockers.json` — Stage 1455 B1
- `docs/TRANSFER_CREASE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crease-gate-honesty-pack-rg-pointers.json` — Stage 1455 P1
- `docs/TRANSFER_NIBBLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nibble-gate-honesty-pack-remaining-gate.json` — Stage 1454 I1
- `docs/TRANSFER_NIBBLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nibble-gate-honesty-pack-rg-blockers.json` — Stage 1454 B1
- `docs/TRANSFER_NIBBLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nibble-gate-honesty-pack-rg-pointers.json` — Stage 1454 P1
- `docs/TRANSFER_SLIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-slit-gate-honesty-pack-remaining-gate.json` — Stage 1453 I1
- `docs/TRANSFER_SLIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-slit-gate-honesty-pack-rg-blockers.json` — Stage 1453 B1
- `docs/TRANSFER_SLIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-slit-gate-honesty-pack-rg-pointers.json` — Stage 1453 P1
- `docs/TRANSFER_LANCING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lancing-gate-honesty-pack-remaining-gate.json` — Stage 1452 I1
- `docs/TRANSFER_LANCING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lancing-gate-honesty-pack-rg-blockers.json` — Stage 1452 B1
- `docs/TRANSFER_LANCING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lancing-gate-honesty-pack-rg-pointers.json` — Stage 1452 P1
- `docs/TRANSFER_NOTCH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-notch-gate-honesty-pack-remaining-gate.json` — Stage 1451 I1
- `docs/TRANSFER_NOTCH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-notch-gate-honesty-pack-rg-blockers.json` — Stage 1451 B1
- `docs/TRANSFER_NOTCH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-notch-gate-honesty-pack-rg-pointers.json` — Stage 1451 P1
- `docs/TRANSFER_TRIM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-trim-gate-honesty-pack-remaining-gate.json` — Stage 1450 I1
- `docs/TRANSFER_TRIM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-trim-gate-honesty-pack-rg-blockers.json` — Stage 1450 B1
- `docs/TRANSFER_TRIM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-trim-gate-honesty-pack-rg-pointers.json` — Stage 1450 P1
- `docs/TRANSFER_PIERCE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pierce-gate-honesty-pack-remaining-gate.json` — Stage 1449 I1
- `docs/TRANSFER_PIERCE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pierce-gate-honesty-pack-rg-blockers.json` — Stage 1449 B1
- `docs/TRANSFER_PIERCE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pierce-gate-honesty-pack-rg-pointers.json` — Stage 1449 P1
- `docs/TRANSFER_DRAW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-draw-gate-honesty-pack-remaining-gate.json` — Stage 1448 I1
- `docs/TRANSFER_DRAW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-draw-gate-honesty-pack-rg-blockers.json` — Stage 1448 B1
- `docs/TRANSFER_DRAW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-draw-gate-honesty-pack-rg-pointers.json` — Stage 1448 P1
- `docs/TRANSFER_COINING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-coining-gate-honesty-pack-remaining-gate.json` — Stage 1447 I1
- `docs/TRANSFER_COINING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-coining-gate-honesty-pack-rg-blockers.json` — Stage 1447 B1
- `docs/TRANSFER_COINING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-coining-gate-honesty-pack-rg-pointers.json` — Stage 1447 P1
- `docs/TRANSFER_BLANK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-blank-gate-honesty-pack-remaining-gate.json` — Stage 1446 I1
- `docs/TRANSFER_BLANK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-blank-gate-honesty-pack-rg-blockers.json` — Stage 1446 B1
- `docs/TRANSFER_BLANK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-blank-gate-honesty-pack-rg-pointers.json` — Stage 1446 P1
- `docs/TRANSFER_FORMDIE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-formdie-gate-honesty-pack-remaining-gate.json` — Stage 1445 I1
- `docs/TRANSFER_FORMDIE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-formdie-gate-honesty-pack-rg-blockers.json` — Stage 1445 B1
- `docs/TRANSFER_FORMDIE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-formdie-gate-honesty-pack-rg-pointers.json` — Stage 1445 P1
- `docs/TRANSFER_MANDRELBAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mandrelbar-gate-honesty-pack-remaining-gate.json` — Stage 1444 I1
- `docs/TRANSFER_MANDRELBAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mandrelbar-gate-honesty-pack-rg-blockers.json` — Stage 1444 B1
- `docs/TRANSFER_MANDRELBAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mandrelbar-gate-honesty-pack-rg-pointers.json` — Stage 1444 P1
- `docs/TRANSFER_ANVIL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-anvil-gate-honesty-pack-remaining-gate.json` — Stage 1443 I1
- `docs/TRANSFER_ANVIL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-anvil-gate-honesty-pack-rg-blockers.json` — Stage 1443 B1
- `docs/TRANSFER_ANVIL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-anvil-gate-honesty-pack-rg-pointers.json` — Stage 1443 P1
- `docs/TRANSFER_DIE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-die-gate-honesty-pack-remaining-gate.json` — Stage 1442 I1
- `docs/TRANSFER_DIE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-die-gate-honesty-pack-rg-blockers.json` — Stage 1442 B1
- `docs/TRANSFER_DIE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-die-gate-honesty-pack-rg-pointers.json` — Stage 1442 P1
- `docs/TRANSFER_BUCKING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bucking-gate-honesty-pack-remaining-gate.json` — Stage 1441 I1
- `docs/TRANSFER_BUCKING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bucking-gate-honesty-pack-rg-blockers.json` — Stage 1441 B1
- `docs/TRANSFER_BUCKING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bucking-gate-honesty-pack-rg-pointers.json` — Stage 1441 P1
- `docs/TRANSFER_DOLLY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dolly-gate-honesty-pack-remaining-gate.json` — Stage 1440 I1
- `docs/TRANSFER_DOLLY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dolly-gate-honesty-pack-rg-blockers.json` — Stage 1440 B1
- `docs/TRANSFER_DOLLY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dolly-gate-honesty-pack-rg-pointers.json` — Stage 1440 P1
- `docs/TRANSFER_PUNCH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-punch-gate-honesty-pack-remaining-gate.json` — Stage 1439 I1
- `docs/TRANSFER_PUNCH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-punch-gate-honesty-pack-rg-blockers.json` — Stage 1439 B1
- `docs/TRANSFER_PUNCH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-punch-gate-honesty-pack-rg-pointers.json` — Stage 1439 P1
- `docs/TRANSFER_RIVETSET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rivetset-gate-honesty-pack-remaining-gate.json` — Stage 1438 I1
- `docs/TRANSFER_RIVETSET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rivetset-gate-honesty-pack-rg-blockers.json` — Stage 1438 B1
- `docs/TRANSFER_RIVETSET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rivetset-gate-honesty-pack-rg-pointers.json` — Stage 1438 P1
- `docs/TRANSFER_CRIMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crimp-gate-honesty-pack-remaining-gate.json` — Stage 1437 I1
- `docs/TRANSFER_CRIMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crimp-gate-honesty-pack-rg-blockers.json` — Stage 1437 B1
- `docs/TRANSFER_CRIMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crimp-gate-honesty-pack-rg-pointers.json` — Stage 1437 P1
- `docs/TRANSFER_PEEN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-peen-gate-honesty-pack-remaining-gate.json` — Stage 1436 I1
- `docs/TRANSFER_PEEN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-peen-gate-honesty-pack-rg-blockers.json` — Stage 1436 B1
- `docs/TRANSFER_PEEN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-peen-gate-honesty-pack-rg-pointers.json` — Stage 1436 P1
- `docs/TRANSFER_WEDGESOCKET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-wedgesocket-gate-honesty-pack-remaining-gate.json` — Stage 1435 I1
- `docs/TRANSFER_WEDGESOCKET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-wedgesocket-gate-honesty-pack-rg-blockers.json` — Stage 1435 B1
- `docs/TRANSFER_WEDGESOCKET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-wedgesocket-gate-honesty-pack-rg-pointers.json` — Stage 1435 P1
- `docs/TRANSFER_CABLESTOP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cablestop-gate-honesty-pack-remaining-gate.json` — Stage 1434 I1
- `docs/TRANSFER_CABLESTOP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cablestop-gate-honesty-pack-rg-blockers.json` — Stage 1434 B1
- `docs/TRANSFER_CABLESTOP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cablestop-gate-honesty-pack-rg-pointers.json` — Stage 1434 P1
- `docs/TRANSFER_FERRULECLAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ferruleclamp-gate-honesty-pack-remaining-gate.json` — Stage 1433 I1
- `docs/TRANSFER_FERRULECLAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ferruleclamp-gate-honesty-pack-rg-blockers.json` — Stage 1433 B1
- `docs/TRANSFER_FERRULECLAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ferruleclamp-gate-honesty-pack-rg-pointers.json` — Stage 1433 P1
- `docs/TRANSFER_SWAGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-swage-gate-honesty-pack-remaining-gate.json` — Stage 1432 I1
- `docs/TRANSFER_SWAGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-swage-gate-honesty-pack-rg-blockers.json` — Stage 1432 B1
- `docs/TRANSFER_SWAGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-swage-gate-honesty-pack-rg-pointers.json` — Stage 1432 P1
- `docs/TRANSFER_LOADBINDER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-loadbinder-gate-honesty-pack-remaining-gate.json` — Stage 1431 I1
- `docs/TRANSFER_LOADBINDER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-loadbinder-gate-honesty-pack-rg-blockers.json` — Stage 1431 B1
- `docs/TRANSFER_LOADBINDER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-loadbinder-gate-honesty-pack-rg-pointers.json` — Stage 1431 P1
- `docs/TRANSFER_CABLECLAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cableclamp-gate-honesty-pack-remaining-gate.json` — Stage 1430 I1
- `docs/TRANSFER_CABLECLAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cableclamp-gate-honesty-pack-rg-blockers.json` — Stage 1430 B1
- `docs/TRANSFER_CABLECLAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cableclamp-gate-honesty-pack-rg-pointers.json` — Stage 1430 P1
- `docs/TRANSFER_THIMBLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-thimble-gate-honesty-pack-remaining-gate.json` — Stage 1429 I1
- `docs/TRANSFER_THIMBLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-thimble-gate-honesty-pack-rg-blockers.json` — Stage 1429 B1
- `docs/TRANSFER_THIMBLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-thimble-gate-honesty-pack-rg-pointers.json` — Stage 1429 P1
- `docs/TRANSFER_WIRECLIP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-wireclip-gate-honesty-pack-remaining-gate.json` — Stage 1428 I1
- `docs/TRANSFER_WIRECLIP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-wireclip-gate-honesty-pack-rg-blockers.json` — Stage 1428 B1
- `docs/TRANSFER_WIRECLIP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-wireclip-gate-honesty-pack-rg-pointers.json` — Stage 1428 P1
- `docs/TRANSFER_UBOLT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ubolt-gate-honesty-pack-remaining-gate.json` — Stage 1427 I1
- `docs/TRANSFER_UBOLT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ubolt-gate-honesty-pack-rg-blockers.json` — Stage 1427 B1
- `docs/TRANSFER_UBOLT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ubolt-gate-honesty-pack-rg-pointers.json` — Stage 1427 P1
- `docs/TRANSFER_PADAYE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-padaye-gate-honesty-pack-remaining-gate.json` — Stage 1426 I1
- `docs/TRANSFER_PADAYE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-padaye-gate-honesty-pack-rg-blockers.json` — Stage 1426 B1
- `docs/TRANSFER_PADAYE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-padaye-gate-honesty-pack-rg-pointers.json` — Stage 1426 P1
- `docs/TRANSFER_CLEVISHOOK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clevishook-gate-honesty-pack-remaining-gate.json` — Stage 1425 I1
- `docs/TRANSFER_CLEVISHOOK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clevishook-gate-honesty-pack-rg-blockers.json` — Stage 1425 B1
- `docs/TRANSFER_CLEVISHOOK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clevishook-gate-honesty-pack-rg-pointers.json` — Stage 1425 P1
- `docs/TRANSFER_EYENUT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-eyenut-gate-honesty-pack-remaining-gate.json` — Stage 1424 I1
- `docs/TRANSFER_EYENUT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-eyenut-gate-honesty-pack-rg-blockers.json` — Stage 1424 B1
- `docs/TRANSFER_EYENUT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-eyenut-gate-honesty-pack-rg-pointers.json` — Stage 1424 P1
- `docs/TRANSFER_EYEBOLT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-eyebolt-gate-honesty-pack-remaining-gate.json` — Stage 1423 I1
- `docs/TRANSFER_EYEBOLT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-eyebolt-gate-honesty-pack-rg-blockers.json` — Stage 1423 B1
- `docs/TRANSFER_EYEBOLT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-eyebolt-gate-honesty-pack-rg-pointers.json` — Stage 1423 P1
- `docs/TRANSFER_TURNBUCKLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-turnbuckle-gate-honesty-pack-remaining-gate.json` — Stage 1422 I1
- `docs/TRANSFER_TURNBUCKLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-turnbuckle-gate-honesty-pack-rg-blockers.json` — Stage 1422 B1
- `docs/TRANSFER_TURNBUCKLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-turnbuckle-gate-honesty-pack-rg-pointers.json` — Stage 1422 P1
- `docs/TRANSFER_SWIVELHOOK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-swivelhook-gate-honesty-pack-remaining-gate.json` — Stage 1421 I1
- `docs/TRANSFER_SWIVELHOOK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-swivelhook-gate-honesty-pack-rg-blockers.json` — Stage 1421 B1
- `docs/TRANSFER_SWIVELHOOK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-swivelhook-gate-honesty-pack-rg-pointers.json` — Stage 1421 P1
- `docs/TRANSFER_CARABINER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-carabiner-gate-honesty-pack-remaining-gate.json` — Stage 1420 I1
- `docs/TRANSFER_CARABINER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-carabiner-gate-honesty-pack-rg-blockers.json` — Stage 1420 B1
- `docs/TRANSFER_CARABINER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-carabiner-gate-honesty-pack-rg-pointers.json` — Stage 1420 P1
- `docs/TRANSFER_SNAPHOOK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-snaphook-gate-honesty-pack-remaining-gate.json` — Stage 1419 I1
- `docs/TRANSFER_SNAPHOOK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-snaphook-gate-honesty-pack-rg-blockers.json` — Stage 1419 B1
- `docs/TRANSFER_SNAPHOOK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-snaphook-gate-honesty-pack-rg-pointers.json` — Stage 1419 P1
- `docs/TRANSFER_TOGGLEPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-togglepin-gate-honesty-pack-remaining-gate.json` — Stage 1418 I1
- `docs/TRANSFER_TOGGLEPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-togglepin-gate-honesty-pack-rg-blockers.json` — Stage 1418 B1
- `docs/TRANSFER_TOGGLEPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-togglepin-gate-honesty-pack-rg-pointers.json` — Stage 1418 P1
- `docs/TRANSFER_SAFETYPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-safetypin-gate-honesty-pack-remaining-gate.json` — Stage 1417 I1
- `docs/TRANSFER_SAFETYPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-safetypin-gate-honesty-pack-rg-blockers.json` — Stage 1417 B1
- `docs/TRANSFER_SAFETYPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-safetypin-gate-honesty-pack-rg-pointers.json` — Stage 1417 P1
- `docs/TRANSFER_SCREWPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-screwpin-gate-honesty-pack-remaining-gate.json` — Stage 1416 I1
- `docs/TRANSFER_SCREWPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-screwpin-gate-honesty-pack-rg-blockers.json` — Stage 1416 B1
- `docs/TRANSFER_SCREWPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-screwpin-gate-honesty-pack-rg-pointers.json` — Stage 1416 P1
- `docs/TRANSFER_ANCHORSHACKLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-anchorshackle-gate-honesty-pack-remaining-gate.json` — Stage 1415 I1
- `docs/TRANSFER_ANCHORSHACKLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-anchorshackle-gate-honesty-pack-rg-blockers.json` — Stage 1415 B1
- `docs/TRANSFER_ANCHORSHACKLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-anchorshackle-gate-honesty-pack-rg-pointers.json` — Stage 1415 P1
- `docs/TRANSFER_DEESHACKLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-deeshackle-gate-honesty-pack-remaining-gate.json` — Stage 1414 I1
- `docs/TRANSFER_DEESHACKLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-deeshackle-gate-honesty-pack-rg-blockers.json` — Stage 1414 B1
- `docs/TRANSFER_DEESHACKLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-deeshackle-gate-honesty-pack-rg-pointers.json` — Stage 1414 P1
- `docs/TRANSFER_BOWSHACKLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bowshackle-gate-honesty-pack-remaining-gate.json` — Stage 1413 I1
- `docs/TRANSFER_BOWSHACKLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bowshackle-gate-honesty-pack-rg-blockers.json` — Stage 1413 B1
- `docs/TRANSFER_BOWSHACKLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bowshackle-gate-honesty-pack-rg-pointers.json` — Stage 1413 P1
- `docs/TRANSFER_COTTERLESS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cotterless-gate-honesty-pack-remaining-gate.json` — Stage 1412 I1
- `docs/TRANSFER_COTTERLESS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cotterless-gate-honesty-pack-rg-blockers.json` — Stage 1412 B1
- `docs/TRANSFER_COTTERLESS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cotterless-gate-honesty-pack-rg-pointers.json` — Stage 1412 P1
- `docs/TRANSFER_LYNCH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lynch-gate-honesty-pack-remaining-gate.json` — Stage 1411 I1
- `docs/TRANSFER_LYNCH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lynch-gate-honesty-pack-rg-blockers.json` — Stage 1411 B1
- `docs/TRANSFER_LYNCH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lynch-gate-honesty-pack-rg-pointers.json` — Stage 1411 P1
- `docs/TRANSFER_RCLIP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rclip-gate-honesty-pack-remaining-gate.json` — Stage 1410 I1
- `docs/TRANSFER_RCLIP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rclip-gate-honesty-pack-rg-blockers.json` — Stage 1410 B1
- `docs/TRANSFER_RCLIP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rclip-gate-honesty-pack-rg-pointers.json` — Stage 1410 P1
- `docs/TRANSFER_HITCHPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hitchpin-gate-honesty-pack-remaining-gate.json` — Stage 1409 I1
- `docs/TRANSFER_HITCHPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hitchpin-gate-honesty-pack-rg-blockers.json` — Stage 1409 B1
- `docs/TRANSFER_HITCHPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hitchpin-gate-honesty-pack-rg-pointers.json` — Stage 1409 P1
- `docs/TRANSFER_QUICKPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quickpin-gate-honesty-pack-remaining-gate.json` — Stage 1408 I1
- `docs/TRANSFER_QUICKPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quickpin-gate-honesty-pack-rg-blockers.json` — Stage 1408 B1
- `docs/TRANSFER_QUICKPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quickpin-gate-honesty-pack-rg-pointers.json` — Stage 1408 P1
- `docs/TRANSFER_HAIRPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hairpin-gate-honesty-pack-remaining-gate.json` — Stage 1407 I1
- `docs/TRANSFER_HAIRPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hairpin-gate-honesty-pack-rg-blockers.json` — Stage 1407 B1
- `docs/TRANSFER_HAIRPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hairpin-gate-honesty-pack-rg-pointers.json` — Stage 1407 P1
- `docs/TRANSFER_SPLITPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-splitpin-gate-honesty-pack-remaining-gate.json` — Stage 1406 I1
- `docs/TRANSFER_SPLITPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-splitpin-gate-honesty-pack-rg-blockers.json` — Stage 1406 B1
- `docs/TRANSFER_SPLITPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-splitpin-gate-honesty-pack-rg-pointers.json` — Stage 1406 P1
- `docs/TRANSFER_SHEARPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shearpin-gate-honesty-pack-remaining-gate.json` — Stage 1405 I1
- `docs/TRANSFER_SHEARPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shearpin-gate-honesty-pack-rg-blockers.json` — Stage 1405 B1
- `docs/TRANSFER_SHEARPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shearpin-gate-honesty-pack-rg-pointers.json` — Stage 1405 P1
- `docs/TRANSFER_RIVETPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rivetpin-gate-honesty-pack-remaining-gate.json` — Stage 1404 I1
- `docs/TRANSFER_RIVETPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rivetpin-gate-honesty-pack-rg-blockers.json` — Stage 1404 B1
- `docs/TRANSFER_RIVETPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rivetpin-gate-honesty-pack-rg-pointers.json` — Stage 1404 P1
- `docs/TRANSFER_LINCHPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-linchpin-gate-honesty-pack-remaining-gate.json` — Stage 1403 I1
- `docs/TRANSFER_LINCHPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-linchpin-gate-honesty-pack-rg-blockers.json` — Stage 1403 B1
- `docs/TRANSFER_LINCHPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-linchpin-gate-honesty-pack-rg-pointers.json` — Stage 1403 P1
- `docs/TRANSFER_TAPERPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-taperpin-gate-honesty-pack-remaining-gate.json` — Stage 1402 I1
- `docs/TRANSFER_TAPERPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-taperpin-gate-honesty-pack-rg-blockers.json` — Stage 1402 B1
- `docs/TRANSFER_TAPERPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-taperpin-gate-honesty-pack-rg-pointers.json` — Stage 1402 P1
- `docs/TRANSFER_GROOVEPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-groovepin-gate-honesty-pack-remaining-gate.json` — Stage 1401 I1
- `docs/TRANSFER_GROOVEPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-groovepin-gate-honesty-pack-rg-blockers.json` — Stage 1401 B1
- `docs/TRANSFER_GROOVEPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-groovepin-gate-honesty-pack-rg-pointers.json` — Stage 1401 P1
- `docs/TRANSFER_ROLLPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rollpin-gate-honesty-pack-remaining-gate.json` — Stage 1400 I1
- `docs/TRANSFER_ROLLPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rollpin-gate-honesty-pack-rg-blockers.json` — Stage 1400 B1
- `docs/TRANSFER_ROLLPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rollpin-gate-honesty-pack-rg-pointers.json` — Stage 1400 P1
- `docs/TRANSFER_SPRINGPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-springpin-gate-honesty-pack-remaining-gate.json` — Stage 1399 I1
- `docs/TRANSFER_SPRINGPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-springpin-gate-honesty-pack-rg-blockers.json` — Stage 1399 B1
- `docs/TRANSFER_SPRINGPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-springpin-gate-honesty-pack-rg-pointers.json` — Stage 1399 P1
- `docs/TRANSFER_CLEVISPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clevispin-gate-honesty-pack-remaining-gate.json` — Stage 1398 I1
- `docs/TRANSFER_CLEVISPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clevispin-gate-honesty-pack-rg-blockers.json` — Stage 1398 B1
- `docs/TRANSFER_CLEVISPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clevispin-gate-honesty-pack-rg-pointers.json` — Stage 1398 P1
- `docs/TRANSFER_COTTERPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cotterpin-gate-honesty-pack-remaining-gate.json` — Stage 1397 I1
- `docs/TRANSFER_COTTERPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cotterpin-gate-honesty-pack-rg-blockers.json` — Stage 1397 B1
- `docs/TRANSFER_COTTERPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cotterpin-gate-honesty-pack-rg-pointers.json` — Stage 1397 P1
- `docs/TRANSFER_DOWELPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dowelpin-gate-honesty-pack-remaining-gate.json` — Stage 1396 I1
- `docs/TRANSFER_DOWELPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dowelpin-gate-honesty-pack-rg-blockers.json` — Stage 1396 B1
- `docs/TRANSFER_DOWELPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dowelpin-gate-honesty-pack-rg-pointers.json` — Stage 1396 P1
- `docs/TRANSFER_STANDOFF_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-standoff-gate-honesty-pack-remaining-gate.json` — Stage 1395 I1
- `docs/TRANSFER_STANDOFF_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-standoff-gate-honesty-pack-rg-blockers.json` — Stage 1395 B1
- `docs/TRANSFER_STANDOFF_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-standoff-gate-honesty-pack-rg-pointers.json` — Stage 1395 P1
- `docs/TRANSFER_SETSCREW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-setscrew-gate-honesty-pack-remaining-gate.json` — Stage 1394 I1
- `docs/TRANSFER_SETSCREW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-setscrew-gate-honesty-pack-rg-blockers.json` — Stage 1394 B1
- `docs/TRANSFER_SETSCREW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-setscrew-gate-honesty-pack-rg-pointers.json` — Stage 1394 P1
- `docs/TRANSFER_JAMNUT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-jamnut-gate-honesty-pack-remaining-gate.json` — Stage 1393 I1
- `docs/TRANSFER_JAMNUT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-jamnut-gate-honesty-pack-rg-blockers.json` — Stage 1393 B1
- `docs/TRANSFER_JAMNUT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-jamnut-gate-honesty-pack-rg-pointers.json` — Stage 1393 P1
- `docs/TRANSFER_CASTLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-castle-gate-honesty-pack-remaining-gate.json` — Stage 1392 I1
- `docs/TRANSFER_CASTLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-castle-gate-honesty-pack-rg-blockers.json` — Stage 1392 B1
- `docs/TRANSFER_CASTLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-castle-gate-honesty-pack-rg-pointers.json` — Stage 1392 P1
- `docs/TRANSFER_CIRCLIP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-circlip-gate-honesty-pack-remaining-gate.json` — Stage 1391 I1
- `docs/TRANSFER_CIRCLIP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-circlip-gate-honesty-pack-rg-blockers.json` — Stage 1391 B1
- `docs/TRANSFER_CIRCLIP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-circlip-gate-honesty-pack-rg-pointers.json` — Stage 1391 P1
- `docs/TRANSFER_ADAPTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-adapter-gate-honesty-pack-remaining-gate.json` — Stage 1390 I1
- `docs/TRANSFER_ADAPTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-adapter-gate-honesty-pack-rg-blockers.json` — Stage 1390 B1
- `docs/TRANSFER_ADAPTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-adapter-gate-honesty-pack-rg-pointers.json` — Stage 1390 P1
- `docs/TRANSFER_LOCKNUT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-locknut-gate-honesty-pack-remaining-gate.json` — Stage 1389 I1
- `docs/TRANSFER_LOCKNUT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-locknut-gate-honesty-pack-rg-blockers.json` — Stage 1389 B1
- `docs/TRANSFER_LOCKNUT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-locknut-gate-honesty-pack-rg-pointers.json` — Stage 1389 P1
- `docs/TRANSFER_SHIM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shim-gate-honesty-pack-remaining-gate.json` — Stage 1388 I1
- `docs/TRANSFER_SHIM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shim-gate-honesty-pack-rg-blockers.json` — Stage 1388 B1
- `docs/TRANSFER_SHIM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shim-gate-honesty-pack-rg-pointers.json` — Stage 1388 P1
- `docs/TRANSFER_PRELOAD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-preload-gate-honesty-pack-remaining-gate.json` — Stage 1387 I1
- `docs/TRANSFER_PRELOAD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-preload-gate-honesty-pack-rg-blockers.json` — Stage 1387 B1
- `docs/TRANSFER_PRELOAD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-preload-gate-honesty-pack-rg-pointers.json` — Stage 1387 P1
- `docs/TRANSFER_CONTACT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-contact-gate-honesty-pack-remaining-gate.json` — Stage 1386 I1
- `docs/TRANSFER_CONTACT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-contact-gate-honesty-pack-rg-blockers.json` — Stage 1386 B1
- `docs/TRANSFER_CONTACT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-contact-gate-honesty-pack-rg-pointers.json` — Stage 1386 P1
- `docs/TRANSFER_PILLOWBLOCK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pillowblock-gate-honesty-pack-remaining-gate.json` — Stage 1385 I1
- `docs/TRANSFER_PILLOWBLOCK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pillowblock-gate-honesty-pack-rg-blockers.json` — Stage 1385 B1
- `docs/TRANSFER_PILLOWBLOCK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pillowblock-gate-honesty-pack-rg-pointers.json` — Stage 1385 P1
- `docs/TRANSFER_ANGULAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-angular-gate-honesty-pack-remaining-gate.json` — Stage 1384 I1
- `docs/TRANSFER_ANGULAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-angular-gate-honesty-pack-rg-blockers.json` — Stage 1384 B1
- `docs/TRANSFER_ANGULAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-angular-gate-honesty-pack-rg-pointers.json` — Stage 1384 P1
- `docs/TRANSFER_RADIAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-radial-gate-honesty-pack-remaining-gate.json` — Stage 1383 I1
- `docs/TRANSFER_RADIAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-radial-gate-honesty-pack-rg-blockers.json` — Stage 1383 B1
- `docs/TRANSFER_RADIAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-radial-gate-honesty-pack-rg-pointers.json` — Stage 1383 P1
- `docs/TRANSFER_SPHERICAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spherical-gate-honesty-pack-remaining-gate.json` — Stage 1382 I1
- `docs/TRANSFER_SPHERICAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spherical-gate-honesty-pack-rg-blockers.json` — Stage 1382 B1
- `docs/TRANSFER_SPHERICAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spherical-gate-honesty-pack-rg-pointers.json` — Stage 1382 P1
- `docs/TRANSFER_CONE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cone-gate-honesty-pack-remaining-gate.json` — Stage 1381 I1
- `docs/TRANSFER_CONE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cone-gate-honesty-pack-rg-blockers.json` — Stage 1381 B1
- `docs/TRANSFER_CONE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cone-gate-honesty-pack-rg-pointers.json` — Stage 1381 P1
- `docs/TRANSFER_CUP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cup-gate-honesty-pack-remaining-gate.json` — Stage 1380 I1
- `docs/TRANSFER_CUP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cup-gate-honesty-pack-rg-blockers.json` — Stage 1380 B1
- `docs/TRANSFER_CUP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cup-gate-honesty-pack-rg-pointers.json` — Stage 1380 P1
- `docs/TRANSFER_THRUST_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-thrust-gate-honesty-pack-remaining-gate.json` — Stage 1379 I1
- `docs/TRANSFER_THRUST_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-thrust-gate-honesty-pack-rg-blockers.json` — Stage 1379 B1
- `docs/TRANSFER_THRUST_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-thrust-gate-honesty-pack-rg-pointers.json` — Stage 1379 P1
- `docs/TRANSFER_TAPERED_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tapered-gate-honesty-pack-remaining-gate.json` — Stage 1378 I1
- `docs/TRANSFER_TAPERED_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tapered-gate-honesty-pack-rg-blockers.json` — Stage 1378 B1
- `docs/TRANSFER_TAPERED_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tapered-gate-honesty-pack-rg-pointers.json` — Stage 1378 P1
- `docs/TRANSFER_OUTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-outer-gate-honesty-pack-remaining-gate.json` — Stage 1377 I1
- `docs/TRANSFER_OUTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-outer-gate-honesty-pack-rg-blockers.json` — Stage 1377 B1
- `docs/TRANSFER_OUTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-outer-gate-honesty-pack-rg-pointers.json` — Stage 1377 P1
- `docs/TRANSFER_INNER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-inner-gate-honesty-pack-remaining-gate.json` — Stage 1376 I1
- `docs/TRANSFER_INNER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-inner-gate-honesty-pack-rg-blockers.json` — Stage 1376 B1
- `docs/TRANSFER_INNER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-inner-gate-honesty-pack-rg-pointers.json` — Stage 1376 P1
- `docs/TRANSFER_BALL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ball-gate-honesty-pack-remaining-gate.json` — Stage 1375 I1
- `docs/TRANSFER_BALL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ball-gate-honesty-pack-rg-blockers.json` — Stage 1375 B1
- `docs/TRANSFER_BALL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ball-gate-honesty-pack-rg-pointers.json` — Stage 1375 P1
- `docs/TRANSFER_ROLLER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-roller-gate-honesty-pack-remaining-gate.json` — Stage 1374 I1
- `docs/TRANSFER_ROLLER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-roller-gate-honesty-pack-rg-blockers.json` — Stage 1374 B1
- `docs/TRANSFER_ROLLER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-roller-gate-honesty-pack-rg-pointers.json` — Stage 1374 P1
- `docs/TRANSFER_BELLOWS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bellows-gate-honesty-pack-remaining-gate.json` — Stage 1373 I1
- `docs/TRANSFER_BELLOWS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bellows-gate-honesty-pack-rg-blockers.json` — Stage 1373 B1
- `docs/TRANSFER_BELLOWS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bellows-gate-honesty-pack-rg-pointers.json` — Stage 1373 P1
- `docs/TRANSFER_CAGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cage-gate-honesty-pack-remaining-gate.json` — Stage 1372 I1
- `docs/TRANSFER_CAGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cage-gate-honesty-pack-rg-blockers.json` — Stage 1372 B1
- `docs/TRANSFER_CAGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cage-gate-honesty-pack-rg-pointers.json` — Stage 1372 P1
- `docs/TRANSFER_NEEDLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-needle-gate-honesty-pack-remaining-gate.json` — Stage 1371 I1
- `docs/TRANSFER_NEEDLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-needle-gate-honesty-pack-rg-blockers.json` — Stage 1371 B1
- `docs/TRANSFER_NEEDLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-needle-gate-honesty-pack-rg-pointers.json` — Stage 1371 P1
- `docs/TRANSFER_BOOT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-boot-gate-honesty-pack-remaining-gate.json` — Stage 1370 I1
- `docs/TRANSFER_BOOT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-boot-gate-honesty-pack-rg-blockers.json` — Stage 1370 B1
- `docs/TRANSFER_BOOT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-boot-gate-honesty-pack-rg-pointers.json` — Stage 1370 P1
- `docs/TRANSFER_TRIPOD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tripod-gate-honesty-pack-remaining-gate.json` — Stage 1369 I1
- `docs/TRANSFER_TRIPOD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tripod-gate-honesty-pack-rg-blockers.json` — Stage 1369 B1
- `docs/TRANSFER_TRIPOD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tripod-gate-honesty-pack-rg-pointers.json` — Stage 1369 P1
- `docs/TRANSFER_CROSS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cross-gate-honesty-pack-remaining-gate.json` — Stage 1368 I1
- `docs/TRANSFER_CROSS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cross-gate-honesty-pack-rg-blockers.json` — Stage 1368 B1
- `docs/TRANSFER_CROSS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cross-gate-honesty-pack-rg-pointers.json` — Stage 1368 P1
- `docs/TRANSFER_UJOINT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ujoint-gate-honesty-pack-remaining-gate.json` — Stage 1367 I1
- `docs/TRANSFER_UJOINT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ujoint-gate-honesty-pack-rg-blockers.json` — Stage 1367 B1
- `docs/TRANSFER_UJOINT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ujoint-gate-honesty-pack-rg-pointers.json` — Stage 1367 P1
- `docs/TRANSFER_CVJOINT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cvjoint-gate-honesty-pack-remaining-gate.json` — Stage 1366 I1
- `docs/TRANSFER_CVJOINT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cvjoint-gate-honesty-pack-rg-blockers.json` — Stage 1366 B1
- `docs/TRANSFER_CVJOINT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cvjoint-gate-honesty-pack-rg-pointers.json` — Stage 1366 P1
- `docs/TRANSFER_HALFSHAFT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-halfshaft-gate-honesty-pack-remaining-gate.json` — Stage 1365 I1
- `docs/TRANSFER_HALFSHAFT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-halfshaft-gate-honesty-pack-rg-blockers.json` — Stage 1365 B1
- `docs/TRANSFER_HALFSHAFT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-halfshaft-gate-honesty-pack-rg-pointers.json` — Stage 1365 P1
- `docs/TRANSFER_SIDEGEAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sidegear-gate-honesty-pack-remaining-gate.json` — Stage 1364 I1
- `docs/TRANSFER_SIDEGEAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sidegear-gate-honesty-pack-rg-blockers.json` — Stage 1364 B1
- `docs/TRANSFER_SIDEGEAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sidegear-gate-honesty-pack-rg-pointers.json` — Stage 1364 P1
- `docs/TRANSFER_SPIDER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spider-gate-honesty-pack-remaining-gate.json` — Stage 1363 I1
- `docs/TRANSFER_SPIDER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spider-gate-honesty-pack-rg-blockers.json` — Stage 1363 B1
- `docs/TRANSFER_SPIDER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spider-gate-honesty-pack-rg-pointers.json` — Stage 1363 P1
- `docs/TRANSFER_DIFFERENTIAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-differential-gate-honesty-pack-remaining-gate.json` — Stage 1362 I1
- `docs/TRANSFER_DIFFERENTIAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-differential-gate-honesty-pack-rg-blockers.json` — Stage 1362 B1
- `docs/TRANSFER_DIFFERENTIAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-differential-gate-honesty-pack-rg-pointers.json` — Stage 1362 P1
- `docs/TRANSFER_CROWN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crown-gate-honesty-pack-remaining-gate.json` — Stage 1361 I1
- `docs/TRANSFER_CROWN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crown-gate-honesty-pack-rg-blockers.json` — Stage 1361 B1
- `docs/TRANSFER_CROWN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crown-gate-honesty-pack-rg-pointers.json` — Stage 1361 P1
- `docs/TRANSFER_ANNULUS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-annulus-gate-honesty-pack-remaining-gate.json` — Stage 1360 I1
- `docs/TRANSFER_ANNULUS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-annulus-gate-honesty-pack-rg-blockers.json` — Stage 1360 B1
- `docs/TRANSFER_ANNULUS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-annulus-gate-honesty-pack-rg-pointers.json` — Stage 1360 P1
- `docs/TRANSFER_CARRIER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-carrier-gate-honesty-pack-remaining-gate.json` — Stage 1359 I1
- `docs/TRANSFER_CARRIER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-carrier-gate-honesty-pack-rg-blockers.json` — Stage 1359 B1
- `docs/TRANSFER_CARRIER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-carrier-gate-honesty-pack-rg-pointers.json` — Stage 1359 P1
- `docs/TRANSFER_RING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ring-gate-honesty-pack-remaining-gate.json` — Stage 1358 I1
- `docs/TRANSFER_RING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ring-gate-honesty-pack-rg-blockers.json` — Stage 1358 B1
- `docs/TRANSFER_RING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ring-gate-honesty-pack-rg-pointers.json` — Stage 1358 P1
- `docs/TRANSFER_SUN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sun-gate-honesty-pack-remaining-gate.json` — Stage 1357 I1
- `docs/TRANSFER_SUN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sun-gate-honesty-pack-rg-blockers.json` — Stage 1357 B1
- `docs/TRANSFER_SUN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sun-gate-honesty-pack-rg-pointers.json` — Stage 1357 P1
- `docs/TRANSFER_PLANET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-planet-gate-honesty-pack-remaining-gate.json` — Stage 1356 I1
- `docs/TRANSFER_PLANET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-planet-gate-honesty-pack-rg-blockers.json` — Stage 1356 B1
- `docs/TRANSFER_PLANET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-planet-gate-honesty-pack-rg-pointers.json` — Stage 1356 P1
- `docs/TRANSFER_IDLER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-idler-gate-honesty-pack-remaining-gate.json` — Stage 1355 I1
- `docs/TRANSFER_IDLER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-idler-gate-honesty-pack-rg-blockers.json` — Stage 1355 B1
- `docs/TRANSFER_IDLER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-idler-gate-honesty-pack-rg-pointers.json` — Stage 1355 P1
- `docs/TRANSFER_SPUR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spur-gate-honesty-pack-remaining-gate.json` — Stage 1354 I1
- `docs/TRANSFER_SPUR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spur-gate-honesty-pack-rg-blockers.json` — Stage 1354 B1
- `docs/TRANSFER_SPUR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spur-gate-honesty-pack-rg-pointers.json` — Stage 1354 P1
- `docs/TRANSFER_BEVEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bevel-gate-honesty-pack-remaining-gate.json` — Stage 1353 I1
- `docs/TRANSFER_BEVEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bevel-gate-honesty-pack-rg-blockers.json` — Stage 1353 B1
- `docs/TRANSFER_BEVEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bevel-gate-honesty-pack-rg-pointers.json` — Stage 1353 P1
- `docs/TRANSFER_WORM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-worm-gate-honesty-pack-remaining-gate.json` — Stage 1352 I1
- `docs/TRANSFER_WORM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-worm-gate-honesty-pack-rg-blockers.json` — Stage 1352 B1
- `docs/TRANSFER_WORM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-worm-gate-honesty-pack-rg-pointers.json` — Stage 1352 P1
- `docs/TRANSFER_RACK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rack-gate-honesty-pack-remaining-gate.json` — Stage 1351 I1
- `docs/TRANSFER_RACK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rack-gate-honesty-pack-rg-blockers.json` — Stage 1351 B1
- `docs/TRANSFER_RACK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rack-gate-honesty-pack-rg-pointers.json` — Stage 1351 P1
- `docs/TRANSFER_HELIX_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-helix-gate-honesty-pack-remaining-gate.json` — Stage 1350 I1
- `docs/TRANSFER_HELIX_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-helix-gate-honesty-pack-rg-blockers.json` — Stage 1350 B1
- `docs/TRANSFER_HELIX_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-helix-gate-honesty-pack-rg-pointers.json` — Stage 1350 P1
- `docs/TRANSFER_INVOLUTE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-involute-gate-honesty-pack-remaining-gate.json` — Stage 1349 I1
- `docs/TRANSFER_INVOLUTE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-involute-gate-honesty-pack-rg-blockers.json` — Stage 1349 B1
- `docs/TRANSFER_INVOLUTE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-involute-gate-honesty-pack-rg-pointers.json` — Stage 1349 P1
- `docs/TRANSFER_SERRATION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-serration-gate-honesty-pack-remaining-gate.json` — Stage 1348 I1
- `docs/TRANSFER_SERRATION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-serration-gate-honesty-pack-rg-blockers.json` — Stage 1348 B1
- `docs/TRANSFER_SERRATION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-serration-gate-honesty-pack-rg-pointers.json` — Stage 1348 P1
- `docs/TRANSFER_SPLINE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spline-gate-honesty-pack-remaining-gate.json` — Stage 1347 I1
- `docs/TRANSFER_SPLINE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spline-gate-honesty-pack-rg-blockers.json` — Stage 1347 B1
- `docs/TRANSFER_SPLINE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spline-gate-honesty-pack-rg-pointers.json` — Stage 1347 P1
- `docs/TRANSFER_WOODRUFF_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-woodruff-gate-honesty-pack-remaining-gate.json` — Stage 1346 I1
- `docs/TRANSFER_WOODRUFF_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-woodruff-gate-honesty-pack-rg-blockers.json` — Stage 1346 B1
- `docs/TRANSFER_WOODRUFF_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-woodruff-gate-honesty-pack-rg-pointers.json` — Stage 1346 P1
- `docs/TRANSFER_LAND_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-land-gate-honesty-pack-remaining-gate.json` — Stage 1345 I1
- `docs/TRANSFER_LAND_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-land-gate-honesty-pack-rg-blockers.json` — Stage 1345 B1
- `docs/TRANSFER_LAND_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-land-gate-honesty-pack-rg-pointers.json` — Stage 1345 P1
- `docs/TRANSFER_UNDERCUT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-undercut-gate-honesty-pack-remaining-gate.json` — Stage 1344 I1
- `docs/TRANSFER_UNDERCUT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-undercut-gate-honesty-pack-rg-blockers.json` — Stage 1344 B1
- `docs/TRANSFER_UNDERCUT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-undercut-gate-honesty-pack-rg-pointers.json` — Stage 1344 P1
- `docs/TRANSFER_RELIEF_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-relief-gate-honesty-pack-remaining-gate.json` — Stage 1343 I1
- `docs/TRANSFER_RELIEF_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-relief-gate-honesty-pack-rg-blockers.json` — Stage 1343 B1
- `docs/TRANSFER_RELIEF_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-relief-gate-honesty-pack-rg-pointers.json` — Stage 1343 P1
- `docs/TRANSFER_KEYSEAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-keyseat-gate-honesty-pack-remaining-gate.json` — Stage 1342 I1
- `docs/TRANSFER_KEYSEAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-keyseat-gate-honesty-pack-rg-blockers.json` — Stage 1342 B1
- `docs/TRANSFER_KEYSEAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-keyseat-gate-honesty-pack-rg-pointers.json` — Stage 1342 P1
- `docs/TRANSFER_FILLET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-fillet-gate-honesty-pack-remaining-gate.json` — Stage 1341 I1
- `docs/TRANSFER_FILLET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-fillet-gate-honesty-pack-rg-blockers.json` — Stage 1341 B1
- `docs/TRANSFER_FILLET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-fillet-gate-honesty-pack-rg-pointers.json` — Stage 1341 P1
- `docs/TRANSFER_RECESS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-recess-gate-honesty-pack-remaining-gate.json` — Stage 1340 I1
- `docs/TRANSFER_RECESS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-recess-gate-honesty-pack-rg-blockers.json` — Stage 1340 B1
- `docs/TRANSFER_RECESS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-recess-gate-honesty-pack-rg-pointers.json` — Stage 1340 P1
- `docs/TRANSFER_SPOTFACE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spotface-gate-honesty-pack-remaining-gate.json` — Stage 1339 I1
- `docs/TRANSFER_SPOTFACE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spotface-gate-honesty-pack-rg-blockers.json` — Stage 1339 B1
- `docs/TRANSFER_SPOTFACE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spotface-gate-honesty-pack-rg-pointers.json` — Stage 1339 P1
- `docs/TRANSFER_CHAMFER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chamfer-gate-honesty-pack-remaining-gate.json` — Stage 1338 I1
- `docs/TRANSFER_CHAMFER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chamfer-gate-honesty-pack-rg-blockers.json` — Stage 1338 B1
- `docs/TRANSFER_CHAMFER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chamfer-gate-honesty-pack-rg-pointers.json` — Stage 1338 P1
- `docs/TRANSFER_DEBURR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-deburr-gate-honesty-pack-remaining-gate.json` — Stage 1337 I1
- `docs/TRANSFER_DEBURR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-deburr-gate-honesty-pack-rg-blockers.json` — Stage 1337 B1
- `docs/TRANSFER_DEBURR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-deburr-gate-honesty-pack-rg-pointers.json` — Stage 1337 P1
- `docs/TRANSFER_PILOT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pilot-gate-honesty-pack-remaining-gate.json` — Stage 1336 I1
- `docs/TRANSFER_PILOT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pilot-gate-honesty-pack-rg-blockers.json` — Stage 1336 B1
- `docs/TRANSFER_PILOT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pilot-gate-honesty-pack-rg-pointers.json` — Stage 1336 P1
- `docs/TRANSFER_COUNTERBORE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-counterbore-gate-honesty-pack-remaining-gate.json` — Stage 1335 I1
- `docs/TRANSFER_COUNTERBORE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-counterbore-gate-honesty-pack-rg-blockers.json` — Stage 1335 B1
- `docs/TRANSFER_COUNTERBORE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-counterbore-gate-honesty-pack-rg-pointers.json` — Stage 1335 P1
- `docs/TRANSFER_COUNTERSINK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-countersink-gate-honesty-pack-remaining-gate.json` — Stage 1334 I1
- `docs/TRANSFER_COUNTERSINK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-countersink-gate-honesty-pack-rg-blockers.json` — Stage 1334 B1
- `docs/TRANSFER_COUNTERSINK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-countersink-gate-honesty-pack-rg-pointers.json` — Stage 1334 P1
- `docs/TRANSFER_DRIFT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-drift-gate-honesty-pack-remaining-gate.json` — Stage 1333 I1
- `docs/TRANSFER_DRIFT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-drift-gate-honesty-pack-rg-blockers.json` — Stage 1333 B1
- `docs/TRANSFER_DRIFT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-drift-gate-honesty-pack-rg-pointers.json` — Stage 1333 P1
- `docs/TRANSFER_TAPER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-taper-gate-honesty-pack-remaining-gate.json` — Stage 1332 I1
- `docs/TRANSFER_TAPER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-taper-gate-honesty-pack-rg-blockers.json` — Stage 1332 B1
- `docs/TRANSFER_TAPER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-taper-gate-honesty-pack-rg-pointers.json` — Stage 1332 P1
- `docs/TRANSFER_BROACH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-broach-gate-honesty-pack-remaining-gate.json` — Stage 1331 I1
- `docs/TRANSFER_BROACH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-broach-gate-honesty-pack-rg-blockers.json` — Stage 1331 B1
- `docs/TRANSFER_BROACH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-broach-gate-honesty-pack-rg-pointers.json` — Stage 1331 P1
- `docs/TRANSFER_REAMER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-reamer-gate-honesty-pack-remaining-gate.json` — Stage 1330 I1
- `docs/TRANSFER_REAMER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-reamer-gate-honesty-pack-rg-blockers.json` — Stage 1330 B1
- `docs/TRANSFER_REAMER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-reamer-gate-honesty-pack-rg-pointers.json` — Stage 1330 P1
- `docs/TRANSFER_CHUCK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chuck-gate-honesty-pack-remaining-gate.json` — Stage 1329 I1
- `docs/TRANSFER_CHUCK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chuck-gate-honesty-pack-rg-blockers.json` — Stage 1329 B1
- `docs/TRANSFER_CHUCK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chuck-gate-honesty-pack-rg-pointers.json` — Stage 1329 P1
- `docs/TRANSFER_COLLET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-collet-gate-honesty-pack-remaining-gate.json` — Stage 1328 I1
- `docs/TRANSFER_COLLET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-collet-gate-honesty-pack-rg-blockers.json` — Stage 1328 B1
- `docs/TRANSFER_COLLET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-collet-gate-honesty-pack-rg-pointers.json` — Stage 1328 P1
- `docs/TRANSFER_MANDREL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mandrel-gate-honesty-pack-remaining-gate.json` — Stage 1327 I1
- `docs/TRANSFER_MANDREL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mandrel-gate-honesty-pack-rg-blockers.json` — Stage 1327 B1
- `docs/TRANSFER_MANDREL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mandrel-gate-honesty-pack-rg-pointers.json` — Stage 1327 P1
- `docs/TRANSFER_ARBOR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-arbor-gate-honesty-pack-remaining-gate.json` — Stage 1326 I1
- `docs/TRANSFER_ARBOR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-arbor-gate-honesty-pack-rg-blockers.json` — Stage 1326 B1
- `docs/TRANSFER_ARBOR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-arbor-gate-honesty-pack-rg-pointers.json` — Stage 1326 P1
- `docs/TRANSFER_QUILL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quill-gate-honesty-pack-remaining-gate.json` — Stage 1325 I1
- `docs/TRANSFER_QUILL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quill-gate-honesty-pack-rg-blockers.json` — Stage 1325 B1
- `docs/TRANSFER_QUILL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quill-gate-honesty-pack-rg-pointers.json` — Stage 1325 P1
- `docs/TRANSFER_SOCKET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-socket-gate-honesty-pack-remaining-gate.json` — Stage 1324 I1
- `docs/TRANSFER_SOCKET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-socket-gate-honesty-pack-rg-blockers.json` — Stage 1324 B1
- `docs/TRANSFER_SOCKET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-socket-gate-honesty-pack-rg-pointers.json` — Stage 1324 P1
- `docs/TRANSFER_FULCRUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-fulcrum-gate-honesty-pack-remaining-gate.json` — Stage 1323 I1
- `docs/TRANSFER_FULCRUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-fulcrum-gate-honesty-pack-rg-blockers.json` — Stage 1323 B1
- `docs/TRANSFER_FULCRUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-fulcrum-gate-honesty-pack-rg-pointers.json` — Stage 1323 P1
- `docs/TRANSFER_PINTLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pintle-gate-honesty-pack-remaining-gate.json` — Stage 1322 I1
- `docs/TRANSFER_PINTLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pintle-gate-honesty-pack-rg-blockers.json` — Stage 1322 B1
- `docs/TRANSFER_PINTLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pintle-gate-honesty-pack-rg-pointers.json` — Stage 1322 P1
- `docs/TRANSFER_TENON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tenon-gate-honesty-pack-remaining-gate.json` — Stage 1321 I1
- `docs/TRANSFER_TENON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tenon-gate-honesty-pack-rg-blockers.json` — Stage 1321 B1
- `docs/TRANSFER_TENON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tenon-gate-honesty-pack-rg-pointers.json` — Stage 1321 P1
- `docs/TRANSFER_NIPPLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nipple-gate-honesty-pack-remaining-gate.json` — Stage 1320 I1
- `docs/TRANSFER_NIPPLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nipple-gate-honesty-pack-rg-blockers.json` — Stage 1320 B1
- `docs/TRANSFER_NIPPLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nipple-gate-honesty-pack-rg-pointers.json` — Stage 1320 P1
- `docs/TRANSFER_GUDGEON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gudgeon-gate-honesty-pack-remaining-gate.json` — Stage 1319 I1
- `docs/TRANSFER_GUDGEON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gudgeon-gate-honesty-pack-rg-blockers.json` — Stage 1319 B1
- `docs/TRANSFER_GUDGEON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gudgeon-gate-honesty-pack-rg-pointers.json` — Stage 1319 P1
- `docs/TRANSFER_KINGPIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kingpin-gate-honesty-pack-remaining-gate.json` — Stage 1318 I1
- `docs/TRANSFER_KINGPIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kingpin-gate-honesty-pack-rg-blockers.json` — Stage 1318 B1
- `docs/TRANSFER_KINGPIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kingpin-gate-honesty-pack-rg-pointers.json` — Stage 1318 P1
- `docs/TRANSFER_JOURNAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-journal-gate-honesty-pack-remaining-gate.json` — Stage 1317 I1
- `docs/TRANSFER_JOURNAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-journal-gate-honesty-pack-rg-blockers.json` — Stage 1317 B1
- `docs/TRANSFER_JOURNAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-journal-gate-honesty-pack-rg-pointers.json` — Stage 1317 P1
- `docs/TRANSFER_SWIVEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-swivel-gate-honesty-pack-remaining-gate.json` — Stage 1316 I1
- `docs/TRANSFER_SWIVEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-swivel-gate-honesty-pack-rg-blockers.json` — Stage 1316 B1
- `docs/TRANSFER_SWIVEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-swivel-gate-honesty-pack-rg-pointers.json` — Stage 1316 P1
- `docs/TRANSFER_GIMBAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gimbal-gate-honesty-pack-remaining-gate.json` — Stage 1315 I1
- `docs/TRANSFER_GIMBAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gimbal-gate-honesty-pack-rg-blockers.json` — Stage 1315 B1
- `docs/TRANSFER_GIMBAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gimbal-gate-honesty-pack-rg-pointers.json` — Stage 1315 P1
- `docs/TRANSFER_PIVOT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pivot-gate-honesty-pack-remaining-gate.json` — Stage 1314 I1
- `docs/TRANSFER_PIVOT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pivot-gate-honesty-pack-rg-blockers.json` — Stage 1314 B1
- `docs/TRANSFER_PIVOT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pivot-gate-honesty-pack-rg-pointers.json` — Stage 1314 P1
- `docs/TRANSFER_TRUNNION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-trunnion-gate-honesty-pack-remaining-gate.json` — Stage 1313 I1
- `docs/TRANSFER_TRUNNION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-trunnion-gate-honesty-pack-rg-blockers.json` — Stage 1313 B1
- `docs/TRANSFER_TRUNNION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-trunnion-gate-honesty-pack-rg-pointers.json` — Stage 1313 P1
- `docs/TRANSFER_YOKE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-yoke-gate-honesty-pack-remaining-gate.json` — Stage 1312 I1
- `docs/TRANSFER_YOKE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-yoke-gate-honesty-pack-rg-blockers.json` — Stage 1312 B1
- `docs/TRANSFER_YOKE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-yoke-gate-honesty-pack-rg-pointers.json` — Stage 1312 P1
- `docs/TRANSFER_CAPSTAN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-capstan-gate-honesty-pack-remaining-gate.json` — Stage 1311 I1
- `docs/TRANSFER_CAPSTAN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-capstan-gate-honesty-pack-rg-blockers.json` — Stage 1311 B1
- `docs/TRANSFER_CAPSTAN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-capstan-gate-honesty-pack-rg-pointers.json` — Stage 1311 P1
- `docs/TRANSFER_BUNG_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bung-gate-honesty-pack-remaining-gate.json` — Stage 1310 I1
- `docs/TRANSFER_BUNG_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bung-gate-honesty-pack-rg-blockers.json` — Stage 1310 B1
- `docs/TRANSFER_BUNG_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bung-gate-honesty-pack-rg-pointers.json` — Stage 1310 P1
- `docs/TRANSFER_SPIGOT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spigot-gate-honesty-pack-remaining-gate.json` — Stage 1309 I1
- `docs/TRANSFER_SPIGOT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spigot-gate-honesty-pack-rg-blockers.json` — Stage 1309 B1
- `docs/TRANSFER_SPIGOT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spigot-gate-honesty-pack-rg-pointers.json` — Stage 1309 P1
- `docs/TRANSFER_CLEVIS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clevis-gate-honesty-pack-remaining-gate.json` — Stage 1308 I1
- `docs/TRANSFER_CLEVIS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clevis-gate-honesty-pack-rg-blockers.json` — Stage 1308 B1
- `docs/TRANSFER_CLEVIS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clevis-gate-honesty-pack-rg-pointers.json` — Stage 1308 P1
- `docs/TRANSFER_FERRULE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ferrule-gate-honesty-pack-remaining-gate.json` — Stage 1307 I1
- `docs/TRANSFER_FERRULE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ferrule-gate-honesty-pack-rg-blockers.json` — Stage 1307 B1
- `docs/TRANSFER_FERRULE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ferrule-gate-honesty-pack-rg-pointers.json` — Stage 1307 P1
- `docs/TRANSFER_GROMMET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-grommet-gate-honesty-pack-remaining-gate.json` — Stage 1306 I1
- `docs/TRANSFER_GROMMET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-grommet-gate-honesty-pack-rg-blockers.json` — Stage 1306 B1
- `docs/TRANSFER_GROMMET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-grommet-gate-honesty-pack-rg-pointers.json` — Stage 1306 P1
- `docs/TRANSFER_SCREW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-screw-gate-honesty-pack-remaining-gate.json` — Stage 1305 I1
- `docs/TRANSFER_SCREW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-screw-gate-honesty-pack-rg-blockers.json` — Stage 1305 B1
- `docs/TRANSFER_SCREW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-screw-gate-honesty-pack-rg-pointers.json` — Stage 1305 P1
- `docs/TRANSFER_NUT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nut-gate-honesty-pack-remaining-gate.json` — Stage 1304 I1
- `docs/TRANSFER_NUT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nut-gate-honesty-pack-rg-blockers.json` — Stage 1304 B1
- `docs/TRANSFER_NUT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nut-gate-honesty-pack-rg-pointers.json` — Stage 1304 P1
- `docs/TRANSFER_PINION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pinion-gate-honesty-pack-remaining-gate.json` — Stage 1303 I1
- `docs/TRANSFER_PINION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pinion-gate-honesty-pack-rg-blockers.json` — Stage 1303 B1
- `docs/TRANSFER_PINION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pinion-gate-honesty-pack-rg-pointers.json` — Stage 1303 P1
- `docs/TRANSFER_SNAPRING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-snapring-gate-honesty-pack-remaining-gate.json` — Stage 1302 I1
- `docs/TRANSFER_SNAPRING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-snapring-gate-honesty-pack-rg-blockers.json` — Stage 1302 B1
- `docs/TRANSFER_SNAPRING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-snapring-gate-honesty-pack-rg-pointers.json` — Stage 1302 P1
- `docs/TRANSFER_STUD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stud-gate-honesty-pack-remaining-gate.json` — Stage 1301 I1
- `docs/TRANSFER_STUD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stud-gate-honesty-pack-rg-blockers.json` — Stage 1301 B1
- `docs/TRANSFER_STUD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stud-gate-honesty-pack-rg-pointers.json` — Stage 1301 P1
- `docs/TRANSFER_RIVET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rivet-gate-honesty-pack-remaining-gate.json` — Stage 1300 I1
- `docs/TRANSFER_RIVET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rivet-gate-honesty-pack-rg-blockers.json` — Stage 1300 B1
- `docs/TRANSFER_RIVET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rivet-gate-honesty-pack-rg-pointers.json` — Stage 1300 P1
- `docs/TRANSFER_DOWEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dowel-gate-honesty-pack-remaining-gate.json` — Stage 1299 I1
- `docs/TRANSFER_DOWEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dowel-gate-honesty-pack-rg-blockers.json` — Stage 1299 B1
- `docs/TRANSFER_DOWEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dowel-gate-honesty-pack-rg-pointers.json` — Stage 1299 P1
- `docs/TRANSFER_COTTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cotter-gate-honesty-pack-remaining-gate.json` — Stage 1298 I1
- `docs/TRANSFER_COTTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cotter-gate-honesty-pack-rg-blockers.json` — Stage 1298 B1
- `docs/TRANSFER_COTTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cotter-gate-honesty-pack-rg-pointers.json` — Stage 1298 P1
- `docs/TRANSFER_CLIP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clip-gate-honesty-pack-remaining-gate.json` — Stage 1297 I1
- `docs/TRANSFER_CLIP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clip-gate-honesty-pack-rg-blockers.json` — Stage 1297 B1
- `docs/TRANSFER_CLIP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clip-gate-honesty-pack-rg-pointers.json` — Stage 1297 P1
- `docs/TRANSFER_SPRING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spring-gate-honesty-pack-remaining-gate.json` — Stage 1296 I1
- `docs/TRANSFER_SPRING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spring-gate-honesty-pack-rg-blockers.json` — Stage 1296 B1
- `docs/TRANSFER_SPRING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spring-gate-honesty-pack-rg-pointers.json` — Stage 1296 P1
- `docs/TRANSFER_RACE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-race-gate-honesty-pack-remaining-gate.json` — Stage 1295 I1
- `docs/TRANSFER_RACE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-race-gate-honesty-pack-rg-blockers.json` — Stage 1295 B1
- `docs/TRANSFER_RACE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-race-gate-honesty-pack-rg-pointers.json` — Stage 1295 P1
- `docs/TRANSFER_SEAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-seal-gate-honesty-pack-remaining-gate.json` — Stage 1294 I1
- `docs/TRANSFER_SEAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-seal-gate-honesty-pack-rg-blockers.json` — Stage 1294 B1
- `docs/TRANSFER_SEAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-seal-gate-honesty-pack-rg-pointers.json` — Stage 1294 P1
- `docs/TRANSFER_GASKET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gasket-gate-honesty-pack-remaining-gate.json` — Stage 1293 I1
- `docs/TRANSFER_GASKET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gasket-gate-honesty-pack-rg-blockers.json` — Stage 1293 B1
- `docs/TRANSFER_GASKET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gasket-gate-honesty-pack-rg-pointers.json` — Stage 1293 P1
- `docs/TRANSFER_WASHER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-washer-gate-honesty-pack-remaining-gate.json` — Stage 1292 I1
- `docs/TRANSFER_WASHER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-washer-gate-honesty-pack-rg-blockers.json` — Stage 1292 B1
- `docs/TRANSFER_WASHER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-washer-gate-honesty-pack-rg-pointers.json` — Stage 1292 P1
- `docs/TRANSFER_RETAINER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-retainer-gate-honesty-pack-remaining-gate.json` — Stage 1291 I1
- `docs/TRANSFER_RETAINER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-retainer-gate-honesty-pack-rg-blockers.json` — Stage 1291 B1
- `docs/TRANSFER_RETAINER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-retainer-gate-honesty-pack-rg-pointers.json` — Stage 1291 P1
- `docs/TRANSFER_SPACER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spacer-gate-honesty-pack-remaining-gate.json` — Stage 1290 I1
- `docs/TRANSFER_SPACER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spacer-gate-honesty-pack-rg-blockers.json` — Stage 1290 B1
- `docs/TRANSFER_SPACER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spacer-gate-honesty-pack-rg-pointers.json` — Stage 1290 P1
- `docs/TRANSFER_COUPLING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-coupling-gate-honesty-pack-remaining-gate.json` — Stage 1289 I1
- `docs/TRANSFER_COUPLING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-coupling-gate-honesty-pack-rg-blockers.json` — Stage 1289 B1
- `docs/TRANSFER_COUPLING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-coupling-gate-honesty-pack-rg-pointers.json` — Stage 1289 P1
- `docs/TRANSFER_SLEEVE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sleeve-gate-honesty-pack-remaining-gate.json` — Stage 1288 I1
- `docs/TRANSFER_SLEEVE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sleeve-gate-honesty-pack-rg-blockers.json` — Stage 1288 B1
- `docs/TRANSFER_SLEEVE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sleeve-gate-honesty-pack-rg-pointers.json` — Stage 1288 P1
- `docs/TRANSFER_BUSHING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bushing-gate-honesty-pack-remaining-gate.json` — Stage 1287 I1
- `docs/TRANSFER_BUSHING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bushing-gate-honesty-pack-rg-blockers.json` — Stage 1287 B1
- `docs/TRANSFER_BUSHING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bushing-gate-honesty-pack-rg-pointers.json` — Stage 1287 P1
- `docs/TRANSFER_AXLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-axle-gate-honesty-pack-remaining-gate.json` — Stage 1286 I1
- `docs/TRANSFER_AXLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-axle-gate-honesty-pack-rg-blockers.json` — Stage 1286 B1
- `docs/TRANSFER_AXLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-axle-gate-honesty-pack-rg-pointers.json` — Stage 1286 P1
- `docs/TRANSFER_HUB_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hub-gate-honesty-pack-remaining-gate.json` — Stage 1285 I1
- `docs/TRANSFER_HUB_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hub-gate-honesty-pack-rg-blockers.json` — Stage 1285 B1
- `docs/TRANSFER_HUB_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hub-gate-honesty-pack-rg-pointers.json` — Stage 1285 P1
- `docs/TRANSFER_FLANGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-flange-gate-honesty-pack-remaining-gate.json` — Stage 1284 I1
- `docs/TRANSFER_FLANGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-flange-gate-honesty-pack-rg-blockers.json` — Stage 1284 B1
- `docs/TRANSFER_FLANGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-flange-gate-honesty-pack-rg-pointers.json` — Stage 1284 P1
- `docs/TRANSFER_COLLAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-collar-gate-honesty-pack-remaining-gate.json` — Stage 1283 I1
- `docs/TRANSFER_COLLAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-collar-gate-honesty-pack-rg-blockers.json` — Stage 1283 B1
- `docs/TRANSFER_COLLAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-collar-gate-honesty-pack-rg-pointers.json` — Stage 1283 P1
- `docs/TRANSFER_LUG_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lug-gate-honesty-pack-remaining-gate.json` — Stage 1282 I1
- `docs/TRANSFER_LUG_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lug-gate-honesty-pack-rg-blockers.json` — Stage 1282 B1
- `docs/TRANSFER_LUG_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lug-gate-honesty-pack-rg-pointers.json` — Stage 1282 P1
- `docs/TRANSFER_KEYWAY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-keyway-gate-honesty-pack-remaining-gate.json` — Stage 1281 I1
- `docs/TRANSFER_KEYWAY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-keyway-gate-honesty-pack-rg-blockers.json` — Stage 1281 B1
- `docs/TRANSFER_KEYWAY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-keyway-gate-honesty-pack-rg-pointers.json` — Stage 1281 P1
- `docs/TRANSFER_COMB_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-comb-gate-honesty-pack-remaining-gate.json` — Stage 1280 I1
- `docs/TRANSFER_COMB_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-comb-gate-honesty-pack-rg-blockers.json` — Stage 1280 B1
- `docs/TRANSFER_COMB_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-comb-gate-honesty-pack-rg-pointers.json` — Stage 1280 P1
- `docs/TRANSFER_RAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ramp-gate-honesty-pack-remaining-gate.json` — Stage 1279 I1
- `docs/TRANSFER_RAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ramp-gate-honesty-pack-rg-blockers.json` — Stage 1279 B1
- `docs/TRANSFER_RAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ramp-gate-honesty-pack-rg-pointers.json` — Stage 1279 P1
- `docs/TRANSFER_GROOVE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-groove-gate-honesty-pack-remaining-gate.json` — Stage 1278 I1
- `docs/TRANSFER_GROOVE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-groove-gate-honesty-pack-rg-blockers.json` — Stage 1278 B1
- `docs/TRANSFER_GROOVE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-groove-gate-honesty-pack-rg-pointers.json` — Stage 1278 P1
- `docs/TRANSFER_SHEAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shear-gate-honesty-pack-remaining-gate.json` — Stage 1277 I1
- `docs/TRANSFER_SHEAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shear-gate-honesty-pack-rg-blockers.json` — Stage 1277 B1
- `docs/TRANSFER_SHEAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shear-gate-honesty-pack-rg-pointers.json` — Stage 1277 P1
- `docs/TRANSFER_DRIVER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-driver-gate-honesty-pack-remaining-gate.json` — Stage 1276 I1
- `docs/TRANSFER_DRIVER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-driver-gate-honesty-pack-rg-blockers.json` — Stage 1276 B1
- `docs/TRANSFER_DRIVER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-driver-gate-honesty-pack-rg-pointers.json` — Stage 1276 P1
- `docs/TRANSFER_CORE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-core-gate-honesty-pack-remaining-gate.json` — Stage 1275 I1
- `docs/TRANSFER_CORE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-core-gate-honesty-pack-rg-blockers.json` — Stage 1275 B1
- `docs/TRANSFER_CORE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-core-gate-honesty-pack-rg-pointers.json` — Stage 1275 P1
- `docs/TRANSFER_PLUG_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-plug-gate-honesty-pack-remaining-gate.json` — Stage 1274 I1
- `docs/TRANSFER_PLUG_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-plug-gate-honesty-pack-rg-blockers.json` — Stage 1274 B1
- `docs/TRANSFER_PLUG_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-plug-gate-honesty-pack-rg-pointers.json` — Stage 1274 P1
- `docs/TRANSFER_SPINDLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spindle-gate-honesty-pack-remaining-gate.json` — Stage 1273 I1
- `docs/TRANSFER_SPINDLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spindle-gate-honesty-pack-rg-blockers.json` — Stage 1273 B1
- `docs/TRANSFER_SPINDLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spindle-gate-honesty-pack-rg-pointers.json` — Stage 1273 P1
- `docs/TRANSFER_SIDEBAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sidebar-gate-honesty-pack-remaining-gate.json` — Stage 1272 I1
- `docs/TRANSFER_SIDEBAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sidebar-gate-honesty-pack-rg-blockers.json` — Stage 1272 B1
- `docs/TRANSFER_SIDEBAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sidebar-gate-honesty-pack-rg-pointers.json` — Stage 1272 P1
- `docs/TRANSFER_DISK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-disk-gate-honesty-pack-remaining-gate.json` — Stage 1271 I1
- `docs/TRANSFER_DISK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-disk-gate-honesty-pack-rg-blockers.json` — Stage 1271 B1
- `docs/TRANSFER_DISK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-disk-gate-honesty-pack-rg-pointers.json` — Stage 1271 P1
- `docs/TRANSFER_LEVER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lever-gate-honesty-pack-remaining-gate.json` — Stage 1270 I1
- `docs/TRANSFER_LEVER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lever-gate-honesty-pack-rg-blockers.json` — Stage 1270 B1
- `docs/TRANSFER_LEVER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lever-gate-honesty-pack-rg-pointers.json` — Stage 1270 P1
- `docs/TRANSFER_WAFER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-wafer-gate-honesty-pack-remaining-gate.json` — Stage 1269 I1
- `docs/TRANSFER_WAFER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-wafer-gate-honesty-pack-rg-blockers.json` — Stage 1269 B1
- `docs/TRANSFER_WAFER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-wafer-gate-honesty-pack-rg-pointers.json` — Stage 1269 P1
- `docs/TRANSFER_PIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pin-gate-honesty-pack-remaining-gate.json` — Stage 1268 I1
- `docs/TRANSFER_PIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pin-gate-honesty-pack-rg-blockers.json` — Stage 1268 B1
- `docs/TRANSFER_PIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pin-gate-honesty-pack-rg-pointers.json` — Stage 1268 P1
- `docs/TRANSFER_CAM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cam-gate-honesty-pack-remaining-gate.json` — Stage 1267 I1
- `docs/TRANSFER_CAM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cam-gate-honesty-pack-rg-blockers.json` — Stage 1267 B1
- `docs/TRANSFER_CAM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cam-gate-honesty-pack-rg-pointers.json` — Stage 1267 P1
- `docs/TRANSFER_BARREL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-barrel-gate-honesty-pack-remaining-gate.json` — Stage 1266 I1
- `docs/TRANSFER_BARREL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-barrel-gate-honesty-pack-rg-blockers.json` — Stage 1266 B1
- `docs/TRANSFER_BARREL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-barrel-gate-honesty-pack-rg-pointers.json` — Stage 1266 P1
- `docs/TRANSFER_STEM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stem-gate-honesty-pack-remaining-gate.json` — Stage 1265 I1
- `docs/TRANSFER_STEM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stem-gate-honesty-pack-rg-blockers.json` — Stage 1265 B1
- `docs/TRANSFER_STEM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stem-gate-honesty-pack-rg-pointers.json` — Stage 1265 P1
- `docs/TRANSFER_BOW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bow-gate-honesty-pack-remaining-gate.json` — Stage 1264 I1
- `docs/TRANSFER_BOW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bow-gate-honesty-pack-rg-blockers.json` — Stage 1264 B1
- `docs/TRANSFER_BOW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bow-gate-honesty-pack-rg-pointers.json` — Stage 1264 P1
- `docs/TRANSFER_SHACKLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shackle-gate-honesty-pack-remaining-gate.json` — Stage 1263 I1
- `docs/TRANSFER_SHACKLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shackle-gate-honesty-pack-rg-blockers.json` — Stage 1263 B1
- `docs/TRANSFER_SHACKLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shackle-gate-honesty-pack-rg-pointers.json` — Stage 1263 P1
- `docs/TRANSFER_BIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bit-gate-honesty-pack-remaining-gate.json` — Stage 1262 I1
- `docs/TRANSFER_BIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bit-gate-honesty-pack-rg-blockers.json` — Stage 1262 B1
- `docs/TRANSFER_BIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bit-gate-honesty-pack-rg-pointers.json` — Stage 1262 P1
- `docs/TRANSFER_WARDS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-wards-gate-honesty-pack-remaining-gate.json` — Stage 1261 I1
- `docs/TRANSFER_WARDS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-wards-gate-honesty-pack-rg-blockers.json` — Stage 1261 B1
- `docs/TRANSFER_WARDS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-wards-gate-honesty-pack-rg-pointers.json` — Stage 1261 P1
- `docs/TRANSFER_TUMBLER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tumbler-gate-honesty-pack-remaining-gate.json` — Stage 1260 I1
- `docs/TRANSFER_TUMBLER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tumbler-gate-honesty-pack-rg-blockers.json` — Stage 1260 B1
- `docs/TRANSFER_TUMBLER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tumbler-gate-honesty-pack-rg-pointers.json` — Stage 1260 P1
- `docs/TRANSFER_CYLINDER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cylinder-gate-honesty-pack-remaining-gate.json` — Stage 1259 I1
- `docs/TRANSFER_CYLINDER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cylinder-gate-honesty-pack-rg-blockers.json` — Stage 1259 B1
- `docs/TRANSFER_CYLINDER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cylinder-gate-honesty-pack-rg-pointers.json` — Stage 1259 P1
- `docs/TRANSFER_MORTISE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mortise-gate-honesty-pack-remaining-gate.json` — Stage 1258 I1
- `docs/TRANSFER_MORTISE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mortise-gate-honesty-pack-rg-blockers.json` — Stage 1258 B1
- `docs/TRANSFER_MORTISE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mortise-gate-honesty-pack-rg-pointers.json` — Stage 1258 P1
- `docs/TRANSFER_KEYHOLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-keyhole-gate-honesty-pack-remaining-gate.json` — Stage 1257 I1
- `docs/TRANSFER_KEYHOLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-keyhole-gate-honesty-pack-rg-blockers.json` — Stage 1257 B1
- `docs/TRANSFER_KEYHOLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-keyhole-gate-honesty-pack-rg-pointers.json` — Stage 1257 P1
- `docs/TRANSFER_PADLOCK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-padlock-gate-honesty-pack-remaining-gate.json` — Stage 1256 I1
- `docs/TRANSFER_PADLOCK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-padlock-gate-honesty-pack-rg-blockers.json` — Stage 1256 B1
- `docs/TRANSFER_PADLOCK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-padlock-gate-honesty-pack-rg-pointers.json` — Stage 1256 P1
- `docs/TRANSFER_HASP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hasp-gate-honesty-pack-remaining-gate.json` — Stage 1255 I1
- `docs/TRANSFER_HASP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hasp-gate-honesty-pack-rg-blockers.json` — Stage 1255 B1
- `docs/TRANSFER_HASP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hasp-gate-honesty-pack-rg-pointers.json` — Stage 1255 P1
- `docs/TRANSFER_KEEPER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-keeper-gate-honesty-pack-remaining-gate.json` — Stage 1254 I1
- `docs/TRANSFER_KEEPER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-keeper-gate-honesty-pack-rg-blockers.json` — Stage 1254 B1
- `docs/TRANSFER_KEEPER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-keeper-gate-honesty-pack-rg-pointers.json` — Stage 1254 P1
- `docs/TRANSFER_STRIKE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-strike-gate-honesty-pack-remaining-gate.json` — Stage 1253 I1
- `docs/TRANSFER_STRIKE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-strike-gate-honesty-pack-rg-blockers.json` — Stage 1253 B1
- `docs/TRANSFER_STRIKE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-strike-gate-honesty-pack-rg-pointers.json` — Stage 1253 P1
- `docs/TRANSFER_HANDLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-handle-gate-honesty-pack-remaining-gate.json` — Stage 1252 I1
- `docs/TRANSFER_HANDLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-handle-gate-honesty-pack-rg-blockers.json` — Stage 1252 B1
- `docs/TRANSFER_HANDLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-handle-gate-honesty-pack-rg-pointers.json` — Stage 1252 P1
- `docs/TRANSFER_BOLT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bolt-gate-honesty-pack-remaining-gate.json` — Stage 1251 I1
- `docs/TRANSFER_BOLT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bolt-gate-honesty-pack-rg-blockers.json` — Stage 1251 B1
- `docs/TRANSFER_BOLT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bolt-gate-honesty-pack-rg-pointers.json` — Stage 1251 P1
- `docs/TRANSFER_LATCH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-latch-gate-honesty-pack-remaining-gate.json` — Stage 1250 I1
- `docs/TRANSFER_LATCH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-latch-gate-honesty-pack-rg-blockers.json` — Stage 1250 B1
- `docs/TRANSFER_LATCH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-latch-gate-honesty-pack-rg-pointers.json` — Stage 1250 P1
- `docs/TRANSFER_HINGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hinge-gate-honesty-pack-remaining-gate.json` — Stage 1249 I1
- `docs/TRANSFER_HINGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hinge-gate-honesty-pack-rg-blockers.json` — Stage 1249 B1
- `docs/TRANSFER_HINGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hinge-gate-honesty-pack-rg-pointers.json` — Stage 1249 P1
- `docs/TRANSFER_GLAZING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-glazing-gate-honesty-pack-remaining-gate.json` — Stage 1248 I1
- `docs/TRANSFER_GLAZING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-glazing-gate-honesty-pack-rg-blockers.json` — Stage 1248 B1
- `docs/TRANSFER_GLAZING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-glazing-gate-honesty-pack-rg-pointers.json` — Stage 1248 P1
- `docs/TRANSFER_MUNTIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-muntin-gate-honesty-pack-remaining-gate.json` — Stage 1247 I1
- `docs/TRANSFER_MUNTIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-muntin-gate-honesty-pack-rg-blockers.json` — Stage 1247 B1
- `docs/TRANSFER_MUNTIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-muntin-gate-honesty-pack-rg-pointers.json` — Stage 1247 P1
- `docs/TRANSFER_PANEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-panel-gate-honesty-pack-remaining-gate.json` — Stage 1246 I1
- `docs/TRANSFER_PANEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-panel-gate-honesty-pack-rg-blockers.json` — Stage 1246 B1
- `docs/TRANSFER_PANEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-panel-gate-honesty-pack-rg-pointers.json` — Stage 1246 P1
- `docs/TRANSFER_STILE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stile-gate-honesty-pack-remaining-gate.json` — Stage 1245 I1
- `docs/TRANSFER_STILE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stile-gate-honesty-pack-rg-blockers.json` — Stage 1245 B1
- `docs/TRANSFER_STILE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stile-gate-honesty-pack-rg-pointers.json` — Stage 1245 P1
- `docs/TRANSFER_RAIL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rail-gate-honesty-pack-remaining-gate.json` — Stage 1244 I1
- `docs/TRANSFER_RAIL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rail-gate-honesty-pack-rg-blockers.json` — Stage 1244 B1
- `docs/TRANSFER_RAIL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rail-gate-honesty-pack-rg-pointers.json` — Stage 1244 P1
- `docs/TRANSFER_SASH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sash-gate-honesty-pack-remaining-gate.json` — Stage 1243 I1
- `docs/TRANSFER_SASH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sash-gate-honesty-pack-rg-blockers.json` — Stage 1243 B1
- `docs/TRANSFER_SASH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sash-gate-honesty-pack-rg-pointers.json` — Stage 1243 P1
- `docs/TRANSFER_CASEMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-casement-gate-honesty-pack-remaining-gate.json` — Stage 1242 I1
- `docs/TRANSFER_CASEMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-casement-gate-honesty-pack-rg-blockers.json` — Stage 1242 B1
- `docs/TRANSFER_CASEMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-casement-gate-honesty-pack-rg-pointers.json` — Stage 1242 P1
- `docs/TRANSFER_STOP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stop-gate-honesty-pack-remaining-gate.json` — Stage 1241 I1
- `docs/TRANSFER_STOP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stop-gate-honesty-pack-rg-blockers.json` — Stage 1241 B1
- `docs/TRANSFER_STOP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stop-gate-honesty-pack-rg-pointers.json` — Stage 1241 P1
- `docs/TRANSFER_ASTRAGAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-astragal-gate-honesty-pack-remaining-gate.json` — Stage 1240 I1
- `docs/TRANSFER_ASTRAGAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-astragal-gate-honesty-pack-rg-blockers.json` — Stage 1240 B1
- `docs/TRANSFER_ASTRAGAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-astragal-gate-honesty-pack-rg-pointers.json` — Stage 1240 P1
- `docs/TRANSFER_REVEAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-reveal-gate-honesty-pack-remaining-gate.json` — Stage 1239 I1
- `docs/TRANSFER_REVEAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-reveal-gate-honesty-pack-rg-blockers.json` — Stage 1239 B1
- `docs/TRANSFER_REVEAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-reveal-gate-honesty-pack-rg-pointers.json` — Stage 1239 P1
- `docs/TRANSFER_SILL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sill-gate-honesty-pack-remaining-gate.json` — Stage 1238 I1
- `docs/TRANSFER_SILL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sill-gate-honesty-pack-rg-blockers.json` — Stage 1238 B1
- `docs/TRANSFER_SILL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sill-gate-honesty-pack-rg-pointers.json` — Stage 1238 P1
- `docs/TRANSFER_TRANSOM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-transom-gate-honesty-pack-remaining-gate.json` — Stage 1237 I1
- `docs/TRANSFER_TRANSOM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-transom-gate-honesty-pack-rg-blockers.json` — Stage 1237 B1
- `docs/TRANSFER_TRANSOM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-transom-gate-honesty-pack-rg-pointers.json` — Stage 1237 P1
- `docs/TRANSFER_LINTEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lintel-gate-honesty-pack-remaining-gate.json` — Stage 1236 I1
- `docs/TRANSFER_LINTEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lintel-gate-honesty-pack-rg-blockers.json` — Stage 1236 B1
- `docs/TRANSFER_LINTEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lintel-gate-honesty-pack-rg-pointers.json` — Stage 1236 P1
- `docs/TRANSFER_JAMB_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-jamb-gate-honesty-pack-remaining-gate.json` — Stage 1235 I1
- `docs/TRANSFER_JAMB_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-jamb-gate-honesty-pack-rg-blockers.json` — Stage 1235 B1
- `docs/TRANSFER_JAMB_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-jamb-gate-honesty-pack-rg-pointers.json` — Stage 1235 P1
- `docs/TRANSFER_TYMPANUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tympanum-gate-honesty-pack-remaining-gate.json` — Stage 1234 I1
- `docs/TRANSFER_TYMPANUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tympanum-gate-honesty-pack-rg-blockers.json` — Stage 1234 B1
- `docs/TRANSFER_TYMPANUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tympanum-gate-honesty-pack-rg-pointers.json` — Stage 1234 P1
- `docs/TRANSFER_SPANDREL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spandrel-gate-honesty-pack-remaining-gate.json` — Stage 1233 I1
- `docs/TRANSFER_SPANDREL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spandrel-gate-honesty-pack-rg-blockers.json` — Stage 1233 B1
- `docs/TRANSFER_SPANDREL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spandrel-gate-honesty-pack-rg-pointers.json` — Stage 1233 P1
- `docs/TRANSFER_INTRADOS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-intrados-gate-honesty-pack-remaining-gate.json` — Stage 1232 I1
- `docs/TRANSFER_INTRADOS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-intrados-gate-honesty-pack-rg-blockers.json` — Stage 1232 B1
- `docs/TRANSFER_INTRADOS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-intrados-gate-honesty-pack-rg-pointers.json` — Stage 1232 P1
- `docs/TRANSFER_EXTRADOS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-extrados-gate-honesty-pack-remaining-gate.json` — Stage 1231 I1
- `docs/TRANSFER_EXTRADOS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-extrados-gate-honesty-pack-rg-blockers.json` — Stage 1231 B1
- `docs/TRANSFER_EXTRADOS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-extrados-gate-honesty-pack-rg-pointers.json` — Stage 1231 P1
- `docs/TRANSFER_SOFFIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-soffit-gate-honesty-pack-remaining-gate.json` — Stage 1230 I1
- `docs/TRANSFER_SOFFIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-soffit-gate-honesty-pack-rg-blockers.json` — Stage 1230 B1
- `docs/TRANSFER_SOFFIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-soffit-gate-honesty-pack-rg-pointers.json` — Stage 1230 P1
- `docs/TRANSFER_ARCHIVOLT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-archivolt-gate-honesty-pack-remaining-gate.json` — Stage 1229 I1
- `docs/TRANSFER_ARCHIVOLT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-archivolt-gate-honesty-pack-rg-blockers.json` — Stage 1229 B1
- `docs/TRANSFER_ARCHIVOLT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-archivolt-gate-honesty-pack-rg-pointers.json` — Stage 1229 P1
- `docs/TRANSFER_SPRINGER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-springer-gate-honesty-pack-remaining-gate.json` — Stage 1228 I1
- `docs/TRANSFER_SPRINGER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-springer-gate-honesty-pack-rg-blockers.json` — Stage 1228 B1
- `docs/TRANSFER_SPRINGER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-springer-gate-honesty-pack-rg-pointers.json` — Stage 1228 P1
- `docs/TRANSFER_IMPOST_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-impost-gate-honesty-pack-remaining-gate.json` — Stage 1227 I1
- `docs/TRANSFER_IMPOST_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-impost-gate-honesty-pack-rg-blockers.json` — Stage 1227 B1
- `docs/TRANSFER_IMPOST_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-impost-gate-honesty-pack-rg-pointers.json` — Stage 1227 P1
- `docs/TRANSFER_VOUSSOIR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-voussoir-gate-honesty-pack-remaining-gate.json` — Stage 1226 I1
- `docs/TRANSFER_VOUSSOIR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-voussoir-gate-honesty-pack-rg-blockers.json` — Stage 1226 B1
- `docs/TRANSFER_VOUSSOIR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-voussoir-gate-honesty-pack-rg-pointers.json` — Stage 1226 P1
- `docs/TRANSFER_KEYSTONE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-keystone-gate-honesty-pack-remaining-gate.json` — Stage 1225 I1
- `docs/TRANSFER_KEYSTONE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-keystone-gate-honesty-pack-rg-blockers.json` — Stage 1225 B1
- `docs/TRANSFER_KEYSTONE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-keystone-gate-honesty-pack-rg-pointers.json` — Stage 1225 P1
- `docs/TRANSFER_CORBEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-corbel-gate-honesty-pack-remaining-gate.json` — Stage 1224 I1
- `docs/TRANSFER_CORBEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-corbel-gate-honesty-pack-rg-blockers.json` — Stage 1224 B1
- `docs/TRANSFER_CORBEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-corbel-gate-honesty-pack-rg-pointers.json` — Stage 1224 P1
- `docs/TRANSFER_BOSS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-boss-gate-honesty-pack-remaining-gate.json` — Stage 1223 I1
- `docs/TRANSFER_BOSS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-boss-gate-honesty-pack-rg-blockers.json` — Stage 1223 B1
- `docs/TRANSFER_BOSS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-boss-gate-honesty-pack-rg-pointers.json` — Stage 1223 P1
- `docs/TRANSFER_GARGOYLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gargoyle-gate-honesty-pack-remaining-gate.json` — Stage 1222 I1
- `docs/TRANSFER_GARGOYLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gargoyle-gate-honesty-pack-rg-blockers.json` — Stage 1222 B1
- `docs/TRANSFER_GARGOYLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gargoyle-gate-honesty-pack-rg-pointers.json` — Stage 1222 P1
- `docs/TRANSFER_CROCKET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crocket-gate-honesty-pack-remaining-gate.json` — Stage 1221 I1
- `docs/TRANSFER_CROCKET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crocket-gate-honesty-pack-rg-blockers.json` — Stage 1221 B1
- `docs/TRANSFER_CROCKET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crocket-gate-honesty-pack-rg-pointers.json` — Stage 1221 P1
- `docs/TRANSFER_FINIAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-finial-gate-honesty-pack-remaining-gate.json` — Stage 1220 I1
- `docs/TRANSFER_FINIAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-finial-gate-honesty-pack-rg-blockers.json` — Stage 1220 B1
- `docs/TRANSFER_FINIAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-finial-gate-honesty-pack-rg-pointers.json` — Stage 1220 P1
- `docs/TRANSFER_OCULUS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-oculus-gate-honesty-pack-remaining-gate.json` — Stage 1219 I1
- `docs/TRANSFER_OCULUS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-oculus-gate-honesty-pack-rg-blockers.json` — Stage 1219 B1
- `docs/TRANSFER_OCULUS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-oculus-gate-honesty-pack-rg-pointers.json` — Stage 1219 P1
- `docs/TRANSFER_MULLION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mullion-gate-honesty-pack-remaining-gate.json` — Stage 1218 I1
- `docs/TRANSFER_MULLION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mullion-gate-honesty-pack-rg-blockers.json` — Stage 1218 B1
- `docs/TRANSFER_MULLION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mullion-gate-honesty-pack-rg-pointers.json` — Stage 1218 P1
- `docs/TRANSFER_TRACERY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tracery-gate-honesty-pack-remaining-gate.json` — Stage 1217 I1
- `docs/TRANSFER_TRACERY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tracery-gate-honesty-pack-rg-blockers.json` — Stage 1217 B1
- `docs/TRANSFER_TRACERY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tracery-gate-honesty-pack-rg-pointers.json` — Stage 1217 P1
- `docs/TRANSFER_LANCET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lancet-gate-honesty-pack-remaining-gate.json` — Stage 1216 I1
- `docs/TRANSFER_LANCET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lancet-gate-honesty-pack-rg-blockers.json` — Stage 1216 B1
- `docs/TRANSFER_LANCET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lancet-gate-honesty-pack-rg-pointers.json` — Stage 1216 P1
- `docs/TRANSFER_QUIRE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quire-gate-honesty-pack-remaining-gate.json` — Stage 1215 I1
- `docs/TRANSFER_QUIRE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quire-gate-honesty-pack-rg-blockers.json` — Stage 1215 B1
- `docs/TRANSFER_QUIRE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quire-gate-honesty-pack-rg-pointers.json` — Stage 1215 P1
- `docs/TRANSFER_CLERESTORY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clerestory-gate-honesty-pack-remaining-gate.json` — Stage 1214 I1
- `docs/TRANSFER_CLERESTORY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clerestory-gate-honesty-pack-rg-blockers.json` — Stage 1214 B1
- `docs/TRANSFER_CLERESTORY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clerestory-gate-honesty-pack-rg-pointers.json` — Stage 1214 P1
- `docs/TRANSFER_REREDOS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-reredos-gate-honesty-pack-remaining-gate.json` — Stage 1213 I1
- `docs/TRANSFER_REREDOS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-reredos-gate-honesty-pack-rg-blockers.json` — Stage 1213 B1
- `docs/TRANSFER_REREDOS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-reredos-gate-honesty-pack-rg-pointers.json` — Stage 1213 P1
- `docs/TRANSFER_PULPIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pulpit-gate-honesty-pack-remaining-gate.json` — Stage 1212 I1
- `docs/TRANSFER_PULPIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pulpit-gate-honesty-pack-rg-blockers.json` — Stage 1212 B1
- `docs/TRANSFER_PULPIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pulpit-gate-honesty-pack-rg-pointers.json` — Stage 1212 P1
- `docs/TRANSFER_CHANCEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chancel-gate-honesty-pack-remaining-gate.json` — Stage 1211 I1
- `docs/TRANSFER_CHANCEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chancel-gate-honesty-pack-rg-blockers.json` — Stage 1211 B1
- `docs/TRANSFER_CHANCEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chancel-gate-honesty-pack-rg-pointers.json` — Stage 1211 P1
- `docs/TRANSFER_PRESBYTERY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-presbytery-gate-honesty-pack-remaining-gate.json` — Stage 1210 I1
- `docs/TRANSFER_PRESBYTERY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-presbytery-gate-honesty-pack-rg-blockers.json` — Stage 1210 B1
- `docs/TRANSFER_PRESBYTERY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-presbytery-gate-honesty-pack-rg-pointers.json` — Stage 1210 P1
- `docs/TRANSFER_TRIFORIUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-triforium-gate-honesty-pack-remaining-gate.json` — Stage 1209 I1
- `docs/TRANSFER_TRIFORIUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-triforium-gate-honesty-pack-rg-blockers.json` — Stage 1209 B1
- `docs/TRANSFER_TRIFORIUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-triforium-gate-honesty-pack-rg-pointers.json` — Stage 1209 P1
- `docs/TRANSFER_ROSE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rose-gate-honesty-pack-remaining-gate.json` — Stage 1208 I1
- `docs/TRANSFER_ROSE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rose-gate-honesty-pack-rg-blockers.json` — Stage 1208 B1
- `docs/TRANSFER_ROSE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rose-gate-honesty-pack-rg-pointers.json` — Stage 1208 P1
- `docs/TRANSFER_SACRISTY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sacristy-gate-honesty-pack-remaining-gate.json` — Stage 1207 I1
- `docs/TRANSFER_SACRISTY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sacristy-gate-honesty-pack-rg-blockers.json` — Stage 1207 B1
- `docs/TRANSFER_SACRISTY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sacristy-gate-honesty-pack-rg-pointers.json` — Stage 1207 P1
- `docs/TRANSFER_AMBULATORY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ambulatory-gate-honesty-pack-remaining-gate.json` — Stage 1206 I1
- `docs/TRANSFER_AMBULATORY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ambulatory-gate-honesty-pack-rg-blockers.json` — Stage 1206 B1
- `docs/TRANSFER_AMBULATORY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ambulatory-gate-honesty-pack-rg-pointers.json` — Stage 1206 P1
- `docs/TRANSFER_COFFER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-coffer-gate-honesty-pack-remaining-gate.json` — Stage 1205 I1
- `docs/TRANSFER_COFFER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-coffer-gate-honesty-pack-rg-blockers.json` — Stage 1205 B1
- `docs/TRANSFER_COFFER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-coffer-gate-honesty-pack-rg-pointers.json` — Stage 1205 P1
- `docs/TRANSFER_VESTIBULE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-vestibule-gate-honesty-pack-remaining-gate.json` — Stage 1204 I1
- `docs/TRANSFER_VESTIBULE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-vestibule-gate-honesty-pack-rg-blockers.json` — Stage 1204 B1
- `docs/TRANSFER_VESTIBULE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-vestibule-gate-honesty-pack-rg-pointers.json` — Stage 1204 P1
- `docs/TRANSFER_NAVE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-nave-gate-honesty-pack-remaining-gate.json` — Stage 1203 I1
- `docs/TRANSFER_NAVE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-nave-gate-honesty-pack-rg-blockers.json` — Stage 1203 B1
- `docs/TRANSFER_NAVE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-nave-gate-honesty-pack-rg-pointers.json` — Stage 1203 P1
- `docs/TRANSFER_CRYPT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crypt-gate-honesty-pack-remaining-gate.json` — Stage 1202 I1
- `docs/TRANSFER_CRYPT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crypt-gate-honesty-pack-rg-blockers.json` — Stage 1202 B1
- `docs/TRANSFER_CRYPT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crypt-gate-honesty-pack-rg-pointers.json` — Stage 1202 P1
- `docs/TRANSFER_DORMER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dormer-gate-honesty-pack-remaining-gate.json` — Stage 1201 I1
- `docs/TRANSFER_DORMER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dormer-gate-honesty-pack-rg-blockers.json` — Stage 1201 B1
- `docs/TRANSFER_DORMER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dormer-gate-honesty-pack-rg-pointers.json` — Stage 1201 P1
- `docs/TRANSFER_CHAPTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chapter-gate-honesty-pack-remaining-gate.json` — Stage 1200 I1
- `docs/TRANSFER_CHAPTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chapter-gate-honesty-pack-rg-blockers.json` — Stage 1200 B1
- `docs/TRANSFER_CHAPTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chapter-gate-honesty-pack-rg-pointers.json` — Stage 1200 P1
- `docs/TRANSFER_TRANSEPT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-transept-gate-honesty-pack-remaining-gate.json` — Stage 1199 I1
- `docs/TRANSFER_TRANSEPT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-transept-gate-honesty-pack-rg-blockers.json` — Stage 1199 B1
- `docs/TRANSFER_TRANSEPT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-transept-gate-honesty-pack-rg-pointers.json` — Stage 1199 P1
- `docs/TRANSFER_TABERNACLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tabernacle-gate-honesty-pack-remaining-gate.json` — Stage 1198 I1
- `docs/TRANSFER_TABERNACLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tabernacle-gate-honesty-pack-rg-blockers.json` — Stage 1198 B1
- `docs/TRANSFER_TABERNACLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tabernacle-gate-honesty-pack-rg-pointers.json` — Stage 1198 P1
- `docs/TRANSFER_SEPULCHER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sepulcher-gate-honesty-pack-remaining-gate.json` — Stage 1197 I1
- `docs/TRANSFER_SEPULCHER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sepulcher-gate-honesty-pack-rg-blockers.json` — Stage 1197 B1
- `docs/TRANSFER_SEPULCHER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sepulcher-gate-honesty-pack-rg-pointers.json` — Stage 1197 P1
- `docs/TRANSFER_MAUSOLEUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mausoleum-gate-honesty-pack-remaining-gate.json` — Stage 1196 I1
- `docs/TRANSFER_MAUSOLEUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mausoleum-gate-honesty-pack-rg-blockers.json` — Stage 1196 B1
- `docs/TRANSFER_MAUSOLEUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mausoleum-gate-honesty-pack-rg-pointers.json` — Stage 1196 P1
- `docs/TRANSFER_REFECTORY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-refectory-gate-honesty-pack-remaining-gate.json` — Stage 1195 I1
- `docs/TRANSFER_REFECTORY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-refectory-gate-honesty-pack-rg-blockers.json` — Stage 1195 B1
- `docs/TRANSFER_REFECTORY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-refectory-gate-honesty-pack-rg-pointers.json` — Stage 1195 P1
- `docs/TRANSFER_SCRIPTORIUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-scriptorium-gate-honesty-pack-remaining-gate.json` — Stage 1194 I1
- `docs/TRANSFER_SCRIPTORIUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-scriptorium-gate-honesty-pack-rg-blockers.json` — Stage 1194 B1
- `docs/TRANSFER_SCRIPTORIUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-scriptorium-gate-honesty-pack-rg-pointers.json` — Stage 1194 P1
- `docs/TRANSFER_NARTHEX_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-narthex-gate-honesty-pack-remaining-gate.json` — Stage 1193 I1
- `docs/TRANSFER_NARTHEX_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-narthex-gate-honesty-pack-rg-blockers.json` — Stage 1193 B1
- `docs/TRANSFER_NARTHEX_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-narthex-gate-honesty-pack-rg-pointers.json` — Stage 1193 P1
- `docs/TRANSFER_OSSUARY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ossuary-gate-honesty-pack-remaining-gate.json` — Stage 1192 I1
- `docs/TRANSFER_OSSUARY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ossuary-gate-honesty-pack-rg-blockers.json` — Stage 1192 B1
- `docs/TRANSFER_OSSUARY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ossuary-gate-honesty-pack-rg-pointers.json` — Stage 1192 P1
- `docs/TRANSFER_SANCTUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sanctum-gate-honesty-pack-remaining-gate.json` — Stage 1191 I1
- `docs/TRANSFER_SANCTUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sanctum-gate-honesty-pack-rg-blockers.json` — Stage 1191 B1
- `docs/TRANSFER_SANCTUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sanctum-gate-honesty-pack-rg-pointers.json` — Stage 1191 P1
- `docs/TRANSFER_ADYTUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-adytum-gate-honesty-pack-remaining-gate.json` — Stage 1190 I1
- `docs/TRANSFER_ADYTUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-adytum-gate-honesty-pack-rg-blockers.json` — Stage 1190 B1
- `docs/TRANSFER_ADYTUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-adytum-gate-honesty-pack-rg-pointers.json` — Stage 1190 P1
- `docs/TRANSFER_LOCKBOX_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lockbox-gate-honesty-pack-remaining-gate.json` — Stage 1189 I1
- `docs/TRANSFER_LOCKBOX_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lockbox-gate-honesty-pack-rg-blockers.json` — Stage 1189 B1
- `docs/TRANSFER_LOCKBOX_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lockbox-gate-honesty-pack-rg-pointers.json` — Stage 1189 P1
- `docs/TRANSFER_SAFEKEEP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-safekeep-gate-honesty-pack-remaining-gate.json` — Stage 1188 I1
- `docs/TRANSFER_SAFEKEEP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-safekeep-gate-honesty-pack-rg-blockers.json` — Stage 1188 B1
- `docs/TRANSFER_SAFEKEEP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-safekeep-gate-honesty-pack-rg-pointers.json` — Stage 1188 P1
- `docs/TRANSFER_STRONGBOX_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-strongbox-gate-honesty-pack-remaining-gate.json` — Stage 1187 I1
- `docs/TRANSFER_STRONGBOX_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-strongbox-gate-honesty-pack-rg-blockers.json` — Stage 1187 B1
- `docs/TRANSFER_STRONGBOX_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-strongbox-gate-honesty-pack-rg-pointers.json` — Stage 1187 P1
- `docs/TRANSFER_RELIQUARY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-reliquary-gate-honesty-pack-remaining-gate.json` — Stage 1186 I1
- `docs/TRANSFER_RELIQUARY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-reliquary-gate-honesty-pack-rg-blockers.json` — Stage 1186 B1
- `docs/TRANSFER_RELIQUARY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-reliquary-gate-honesty-pack-rg-pointers.json` — Stage 1186 P1
- `docs/TRANSFER_CENOTAPH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cenotaph-gate-honesty-pack-remaining-gate.json` — Stage 1185 I1
- `docs/TRANSFER_CENOTAPH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cenotaph-gate-honesty-pack-rg-blockers.json` — Stage 1185 B1
- `docs/TRANSFER_CENOTAPH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cenotaph-gate-honesty-pack-rg-pointers.json` — Stage 1185 P1
- `docs/TRANSFER_CHOIR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-choir-gate-honesty-pack-remaining-gate.json` — Stage 1184 I1
- `docs/TRANSFER_CHOIR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-choir-gate-honesty-pack-rg-blockers.json` — Stage 1184 B1
- `docs/TRANSFER_CHOIR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-choir-gate-honesty-pack-rg-pointers.json` — Stage 1184 P1
- `docs/TRANSFER_APSE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-apse-gate-honesty-pack-remaining-gate.json` — Stage 1183 I1
- `docs/TRANSFER_APSE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-apse-gate-honesty-pack-rg-blockers.json` — Stage 1183 B1
- `docs/TRANSFER_APSE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-apse-gate-honesty-pack-rg-pointers.json` — Stage 1183 P1
- `docs/TRANSFER_CURTAIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-curtain-gate-honesty-pack-remaining-gate.json` — Stage 1182 I1
- `docs/TRANSFER_CURTAIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-curtain-gate-honesty-pack-rg-blockers.json` — Stage 1182 B1
- `docs/TRANSFER_CURTAIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-curtain-gate-honesty-pack-rg-pointers.json` — Stage 1182 P1
- `docs/TRANSFER_SHELL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shell-gate-honesty-pack-remaining-gate.json` — Stage 1181 I1
- `docs/TRANSFER_SHELL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shell-gate-honesty-pack-rg-blockers.json` — Stage 1181 B1
- `docs/TRANSFER_SHELL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shell-gate-honesty-pack-rg-pointers.json` — Stage 1181 P1
- `docs/TRANSFER_GORGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gorge-gate-honesty-pack-remaining-gate.json` — Stage 1180 I1
- `docs/TRANSFER_GORGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gorge-gate-honesty-pack-rg-blockers.json` — Stage 1180 B1
- `docs/TRANSFER_GORGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gorge-gate-honesty-pack-rg-pointers.json` — Stage 1180 P1
- `docs/TRANSFER_RINGWORK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ringwork-gate-honesty-pack-remaining-gate.json` — Stage 1179 I1
- `docs/TRANSFER_RINGWORK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ringwork-gate-honesty-pack-rg-blockers.json` — Stage 1179 B1
- `docs/TRANSFER_RINGWORK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ringwork-gate-honesty-pack-rg-pointers.json` — Stage 1179 P1
- `docs/TRANSFER_WARD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ward-gate-honesty-pack-remaining-gate.json` — Stage 1178 I1
- `docs/TRANSFER_WARD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ward-gate-honesty-pack-rg-blockers.json` — Stage 1178 B1
- `docs/TRANSFER_WARD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ward-gate-honesty-pack-rg-pointers.json` — Stage 1178 P1
- `docs/TRANSFER_MOTTE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-motte-gate-honesty-pack-remaining-gate.json` — Stage 1177 I1
- `docs/TRANSFER_MOTTE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-motte-gate-honesty-pack-rg-blockers.json` — Stage 1177 B1
- `docs/TRANSFER_MOTTE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-motte-gate-honesty-pack-rg-pointers.json` — Stage 1177 P1
- `docs/TRANSFER_STELA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stela-gate-honesty-pack-remaining-gate.json` — Stage 1176 I1
- `docs/TRANSFER_STELA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stela-gate-honesty-pack-rg-blockers.json` — Stage 1176 B1
- `docs/TRANSFER_STELA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stela-gate-honesty-pack-rg-pointers.json` — Stage 1176 P1
- `docs/TRANSFER_COLUMN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-column-gate-honesty-pack-remaining-gate.json` — Stage 1175 I1
- `docs/TRANSFER_COLUMN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-column-gate-honesty-pack-rg-blockers.json` — Stage 1175 B1
- `docs/TRANSFER_COLUMN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-column-gate-honesty-pack-rg-pointers.json` — Stage 1175 P1
- `docs/TRANSFER_PILLAR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pillar-gate-honesty-pack-remaining-gate.json` — Stage 1174 I1
- `docs/TRANSFER_PILLAR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pillar-gate-honesty-pack-rg-blockers.json` — Stage 1174 B1
- `docs/TRANSFER_PILLAR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pillar-gate-honesty-pack-rg-pointers.json` — Stage 1174 P1
- `docs/TRANSFER_CAMPANILE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-campanile-gate-honesty-pack-remaining-gate.json` — Stage 1173 I1
- `docs/TRANSFER_CAMPANILE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-campanile-gate-honesty-pack-rg-blockers.json` — Stage 1173 B1
- `docs/TRANSFER_CAMPANILE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-campanile-gate-honesty-pack-rg-pointers.json` — Stage 1173 P1
- `docs/TRANSFER_OUTPOST_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-outpost-gate-honesty-pack-remaining-gate.json` — Stage 1172 I1
- `docs/TRANSFER_OUTPOST_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-outpost-gate-honesty-pack-rg-blockers.json` — Stage 1172 B1
- `docs/TRANSFER_OUTPOST_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-outpost-gate-honesty-pack-rg-pointers.json` — Stage 1172 P1
- `docs/TRANSFER_BANQUETTE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-banquette-gate-honesty-pack-remaining-gate.json` — Stage 1171 I1
- `docs/TRANSFER_BANQUETTE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-banquette-gate-honesty-pack-rg-blockers.json` — Stage 1171 B1
- `docs/TRANSFER_BANQUETTE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-banquette-gate-honesty-pack-rg-pointers.json` — Stage 1171 P1
- `docs/TRANSFER_ALLURE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-allure-gate-honesty-pack-remaining-gate.json` — Stage 1170 I1
- `docs/TRANSFER_ALLURE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-allure-gate-honesty-pack-rg-blockers.json` — Stage 1170 B1
- `docs/TRANSFER_ALLURE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-allure-gate-honesty-pack-rg-pointers.json` — Stage 1170 P1
- `docs/TRANSFER_MEURTRIERE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-meurtriere-gate-honesty-pack-remaining-gate.json` — Stage 1169 I1
- `docs/TRANSFER_MEURTRIERE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-meurtriere-gate-honesty-pack-rg-blockers.json` — Stage 1169 B1
- `docs/TRANSFER_MEURTRIERE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-meurtriere-gate-honesty-pack-rg-pointers.json` — Stage 1169 P1
- `docs/TRANSFER_SALLYPORT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sallyport-gate-honesty-pack-remaining-gate.json` — Stage 1168 I1
- `docs/TRANSFER_SALLYPORT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sallyport-gate-honesty-pack-rg-blockers.json` — Stage 1168 B1
- `docs/TRANSFER_SALLYPORT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sallyport-gate-honesty-pack-rg-pointers.json` — Stage 1168 P1
- `docs/TRANSFER_BRETASCHE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bretasche-gate-honesty-pack-remaining-gate.json` — Stage 1167 I1
- `docs/TRANSFER_BRETASCHE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bretasche-gate-honesty-pack-rg-blockers.json` — Stage 1167 B1
- `docs/TRANSFER_BRETASCHE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bretasche-gate-honesty-pack-rg-pointers.json` — Stage 1167 P1
- `docs/TRANSFER_HOARDING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hoarding-gate-honesty-pack-remaining-gate.json` — Stage 1166 I1
- `docs/TRANSFER_HOARDING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hoarding-gate-honesty-pack-rg-blockers.json` — Stage 1166 B1
- `docs/TRANSFER_HOARDING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hoarding-gate-honesty-pack-rg-pointers.json` — Stage 1166 P1
- `docs/TRANSFER_MACHICOL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-machicol-gate-honesty-pack-remaining-gate.json` — Stage 1165 I1
- `docs/TRANSFER_MACHICOL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-machicol-gate-honesty-pack-rg-blockers.json` — Stage 1165 B1
- `docs/TRANSFER_MACHICOL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-machicol-gate-honesty-pack-rg-pointers.json` — Stage 1165 P1
- `docs/TRANSFER_CRENEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crenel-gate-honesty-pack-remaining-gate.json` — Stage 1164 I1
- `docs/TRANSFER_CRENEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crenel-gate-honesty-pack-rg-blockers.json` — Stage 1164 B1
- `docs/TRANSFER_CRENEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crenel-gate-honesty-pack-rg-pointers.json` — Stage 1164 P1
- `docs/TRANSFER_MERLON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-merlon-gate-honesty-pack-remaining-gate.json` — Stage 1163 I1
- `docs/TRANSFER_MERLON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-merlon-gate-honesty-pack-rg-blockers.json` — Stage 1163 B1
- `docs/TRANSFER_MERLON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-merlon-gate-honesty-pack-rg-pointers.json` — Stage 1163 P1
- `docs/TRANSFER_EMBRASURE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-embrasure-gate-honesty-pack-remaining-gate.json` — Stage 1162 I1
- `docs/TRANSFER_EMBRASURE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-embrasure-gate-honesty-pack-rg-blockers.json` — Stage 1162 B1
- `docs/TRANSFER_EMBRASURE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-embrasure-gate-honesty-pack-rg-pointers.json` — Stage 1162 P1
- `docs/TRANSFER_PARADOS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-parados-gate-honesty-pack-remaining-gate.json` — Stage 1161 I1
- `docs/TRANSFER_PARADOS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-parados-gate-honesty-pack-rg-blockers.json` — Stage 1161 B1
- `docs/TRANSFER_PARADOS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-parados-gate-honesty-pack-rg-pointers.json` — Stage 1161 P1
- `docs/TRANSFER_GLACIS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-glacis-gate-honesty-pack-remaining-gate.json` — Stage 1160 I1
- `docs/TRANSFER_GLACIS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-glacis-gate-honesty-pack-rg-blockers.json` — Stage 1160 B1
- `docs/TRANSFER_GLACIS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-glacis-gate-honesty-pack-rg-pointers.json` — Stage 1160 P1
- `docs/TRANSFER_CROWNWORK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-crownwork-gate-honesty-pack-remaining-gate.json` — Stage 1159 I1
- `docs/TRANSFER_CROWNWORK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-crownwork-gate-honesty-pack-rg-blockers.json` — Stage 1159 B1
- `docs/TRANSFER_CROWNWORK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-crownwork-gate-honesty-pack-rg-pointers.json` — Stage 1159 P1
- `docs/TRANSFER_HORNWORK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-hornwork-gate-honesty-pack-remaining-gate.json` — Stage 1158 I1
- `docs/TRANSFER_HORNWORK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-hornwork-gate-honesty-pack-rg-blockers.json` — Stage 1158 B1
- `docs/TRANSFER_HORNWORK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-hornwork-gate-honesty-pack-rg-pointers.json` — Stage 1158 P1
- `docs/TRANSFER_BAILEY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bailey-gate-honesty-pack-remaining-gate.json` — Stage 1157 I1
- `docs/TRANSFER_BAILEY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bailey-gate-honesty-pack-rg-blockers.json` — Stage 1157 B1
- `docs/TRANSFER_BAILEY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bailey-gate-honesty-pack-rg-pointers.json` — Stage 1157 P1
- `docs/TRANSFER_POSTERN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-postern-gate-honesty-pack-remaining-gate.json` — Stage 1156 I1
- `docs/TRANSFER_POSTERN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-postern-gate-honesty-pack-rg-blockers.json` — Stage 1156 B1
- `docs/TRANSFER_POSTERN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-postern-gate-honesty-pack-rg-pointers.json` — Stage 1156 P1
- `docs/TRANSFER_REDAN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-redan-gate-honesty-pack-remaining-gate.json` — Stage 1155 I1
- `docs/TRANSFER_REDAN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-redan-gate-honesty-pack-rg-blockers.json` — Stage 1155 B1
- `docs/TRANSFER_REDAN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-redan-gate-honesty-pack-rg-pointers.json` — Stage 1155 P1
- `docs/TRANSFER_RAVELIN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ravelin-gate-honesty-pack-remaining-gate.json` — Stage 1154 I1
- `docs/TRANSFER_RAVELIN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ravelin-gate-honesty-pack-rg-blockers.json` — Stage 1154 B1
- `docs/TRANSFER_RAVELIN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ravelin-gate-honesty-pack-rg-pointers.json` — Stage 1154 P1
- `docs/TRANSFER_BELFRY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-belfry-gate-honesty-pack-remaining-gate.json` — Stage 1153 I1
- `docs/TRANSFER_BELFRY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-belfry-gate-honesty-pack-rg-blockers.json` — Stage 1153 B1
- `docs/TRANSFER_BELFRY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-belfry-gate-honesty-pack-rg-pointers.json` — Stage 1153 P1
- `docs/TRANSFER_DOLMEN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-dolmen-gate-honesty-pack-remaining-gate.json` — Stage 1152 I1
- `docs/TRANSFER_DOLMEN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-dolmen-gate-honesty-pack-rg-blockers.json` — Stage 1152 B1
- `docs/TRANSFER_DOLMEN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-dolmen-gate-honesty-pack-rg-pointers.json` — Stage 1152 P1
- `docs/TRANSFER_MENHIR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-menhir-gate-honesty-pack-remaining-gate.json` — Stage 1151 I1
- `docs/TRANSFER_MENHIR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-menhir-gate-honesty-pack-rg-blockers.json` — Stage 1151 B1
- `docs/TRANSFER_MENHIR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-menhir-gate-honesty-pack-rg-pointers.json` — Stage 1151 P1
- `docs/TRANSFER_CAIRN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cairn-gate-honesty-pack-remaining-gate.json` — Stage 1150 I1
- `docs/TRANSFER_CAIRN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cairn-gate-honesty-pack-rg-blockers.json` — Stage 1150 B1
- `docs/TRANSFER_CAIRN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cairn-gate-honesty-pack-rg-pointers.json` — Stage 1150 P1
- `docs/TRANSFER_MONOLITH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-monolith-gate-honesty-pack-remaining-gate.json` — Stage 1149 I1
- `docs/TRANSFER_MONOLITH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-monolith-gate-honesty-pack-rg-blockers.json` — Stage 1149 B1
- `docs/TRANSFER_MONOLITH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-monolith-gate-honesty-pack-rg-pointers.json` — Stage 1149 P1
- `docs/TRANSFER_STELE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stele-gate-honesty-pack-remaining-gate.json` — Stage 1148 I1
- `docs/TRANSFER_STELE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stele-gate-honesty-pack-rg-blockers.json` — Stage 1148 B1
- `docs/TRANSFER_STELE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stele-gate-honesty-pack-rg-pointers.json` — Stage 1148 P1
- `docs/TRANSFER_TOWER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tower-gate-honesty-pack-remaining-gate.json` — Stage 1147 I1
- `docs/TRANSFER_TOWER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tower-gate-honesty-pack-rg-blockers.json` — Stage 1147 B1
- `docs/TRANSFER_TOWER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tower-gate-honesty-pack-rg-pointers.json` — Stage 1147 P1
- `docs/TRANSFER_DONJON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-donjon-gate-honesty-pack-remaining-gate.json` — Stage 1146 I1
- `docs/TRANSFER_DONJON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-donjon-gate-honesty-pack-rg-blockers.json` — Stage 1146 B1
- `docs/TRANSFER_DONJON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-donjon-gate-honesty-pack-rg-pointers.json` — Stage 1146 P1
- `docs/TRANSFER_BARBICAN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-barbican-gate-honesty-pack-remaining-gate.json` — Stage 1145 I1
- `docs/TRANSFER_BARBICAN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-barbican-gate-honesty-pack-rg-blockers.json` — Stage 1145 B1
- `docs/TRANSFER_BARBICAN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-barbican-gate-honesty-pack-rg-pointers.json` — Stage 1145 P1
- `docs/TRANSFER_PYLON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pylon-gate-honesty-pack-remaining-gate.json` — Stage 1144 I1
- `docs/TRANSFER_PYLON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pylon-gate-honesty-pack-rg-blockers.json` — Stage 1144 B1
- `docs/TRANSFER_PYLON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pylon-gate-honesty-pack-rg-pointers.json` — Stage 1144 P1
- `docs/TRANSFER_OBELISK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-obelisk-gate-honesty-pack-remaining-gate.json` — Stage 1143 I1
- `docs/TRANSFER_OBELISK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-obelisk-gate-honesty-pack-rg-blockers.json` — Stage 1143 B1
- `docs/TRANSFER_OBELISK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-obelisk-gate-honesty-pack-rg-pointers.json` — Stage 1143 P1
- `docs/TRANSFER_MINARET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-minaret-gate-honesty-pack-remaining-gate.json` — Stage 1142 I1
- `docs/TRANSFER_MINARET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-minaret-gate-honesty-pack-rg-blockers.json` — Stage 1142 B1
- `docs/TRANSFER_MINARET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-minaret-gate-honesty-pack-rg-pointers.json` — Stage 1142 P1
- `docs/TRANSFER_BATTLEMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-battlement-gate-honesty-pack-remaining-gate.json` — Stage 1141 I1
- `docs/TRANSFER_BATTLEMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-battlement-gate-honesty-pack-rg-blockers.json` — Stage 1141 B1
- `docs/TRANSFER_BATTLEMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-battlement-gate-honesty-pack-rg-pointers.json` — Stage 1141 P1
- `docs/TRANSFER_TURRET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-turret-gate-honesty-pack-remaining-gate.json` — Stage 1140 I1
- `docs/TRANSFER_TURRET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-turret-gate-honesty-pack-rg-blockers.json` — Stage 1140 B1
- `docs/TRANSFER_TURRET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-turret-gate-honesty-pack-rg-pointers.json` — Stage 1140 P1
- `docs/TRANSFER_SPIRE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-spire-gate-honesty-pack-remaining-gate.json` — Stage 1139 I1
- `docs/TRANSFER_SPIRE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-spire-gate-honesty-pack-rg-blockers.json` — Stage 1139 B1
- `docs/TRANSFER_SPIRE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-spire-gate-honesty-pack-rg-pointers.json` — Stage 1139 P1
- `docs/TRANSFER_LANTERN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lantern-gate-honesty-pack-remaining-gate.json` — Stage 1138 I1
- `docs/TRANSFER_LANTERN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lantern-gate-honesty-pack-rg-blockers.json` — Stage 1138 B1
- `docs/TRANSFER_LANTERN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lantern-gate-honesty-pack-rg-pointers.json` — Stage 1138 P1
- `docs/TRANSFER_TORII_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-torii-gate-honesty-pack-remaining-gate.json` — Stage 1137 I1
- `docs/TRANSFER_TORII_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-torii-gate-honesty-pack-rg-blockers.json` — Stage 1137 B1
- `docs/TRANSFER_TORII_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-torii-gate-honesty-pack-rg-pointers.json` — Stage 1137 P1
- `docs/TRANSFER_CUPOLA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cupola-gate-honesty-pack-remaining-gate.json` — Stage 1136 I1
- `docs/TRANSFER_CUPOLA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cupola-gate-honesty-pack-rg-blockers.json` — Stage 1136 B1
- `docs/TRANSFER_CUPOLA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cupola-gate-honesty-pack-rg-pointers.json` — Stage 1136 P1
- `docs/TRANSFER_ORIEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-oriel-gate-honesty-pack-remaining-gate.json` — Stage 1135 I1
- `docs/TRANSFER_ORIEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-oriel-gate-honesty-pack-rg-blockers.json` — Stage 1135 B1
- `docs/TRANSFER_ORIEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-oriel-gate-honesty-pack-rg-pointers.json` — Stage 1135 P1
- `docs/TRANSFER_LOOKOUT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lookout-gate-honesty-pack-remaining-gate.json` — Stage 1134 I1
- `docs/TRANSFER_LOOKOUT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lookout-gate-honesty-pack-rg-blockers.json` — Stage 1134 B1
- `docs/TRANSFER_LOOKOUT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lookout-gate-honesty-pack-rg-pointers.json` — Stage 1134 P1
- `docs/TRANSFER_MEANDER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-meander-gate-honesty-pack-remaining-gate.json` — Stage 1133 I1
- `docs/TRANSFER_MEANDER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-meander-gate-honesty-pack-rg-blockers.json` — Stage 1133 B1
- `docs/TRANSFER_MEANDER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-meander-gate-honesty-pack-rg-pointers.json` — Stage 1133 P1
- `docs/TRANSFER_MEWS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mews-gate-honesty-pack-remaining-gate.json` — Stage 1132 I1
- `docs/TRANSFER_MEWS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mews-gate-honesty-pack-rg-blockers.json` — Stage 1132 B1
- `docs/TRANSFER_MEWS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mews-gate-honesty-pack-rg-pointers.json` — Stage 1132 P1
- `docs/TRANSFER_BANDSTAND_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bandstand-gate-honesty-pack-remaining-gate.json` — Stage 1131 I1
- `docs/TRANSFER_BANDSTAND_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bandstand-gate-honesty-pack-rg-blockers.json` — Stage 1131 B1
- `docs/TRANSFER_BANDSTAND_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bandstand-gate-honesty-pack-rg-pointers.json` — Stage 1131 P1
- `docs/TRANSFER_KIOSK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-kiosk-gate-honesty-pack-remaining-gate.json` — Stage 1130 I1
- `docs/TRANSFER_KIOSK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-kiosk-gate-honesty-pack-rg-blockers.json` — Stage 1130 B1
- `docs/TRANSFER_KIOSK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-kiosk-gate-honesty-pack-rg-pointers.json` — Stage 1130 P1
- `docs/TRANSFER_BELVEDERE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-belvedere-gate-honesty-pack-remaining-gate.json` — Stage 1129 I1
- `docs/TRANSFER_BELVEDERE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-belvedere-gate-honesty-pack-rg-blockers.json` — Stage 1129 B1
- `docs/TRANSFER_BELVEDERE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-belvedere-gate-honesty-pack-rg-pointers.json` — Stage 1129 P1
- `docs/TRANSFER_PATIO_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-patio-gate-honesty-pack-remaining-gate.json` — Stage 1128 I1
- `docs/TRANSFER_PATIO_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-patio-gate-honesty-pack-rg-blockers.json` — Stage 1128 B1
- `docs/TRANSFER_PATIO_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-patio-gate-honesty-pack-rg-pointers.json` — Stage 1128 P1
- `docs/TRANSFER_CORSO_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-corso-gate-honesty-pack-remaining-gate.json` — Stage 1127 I1
- `docs/TRANSFER_CORSO_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-corso-gate-honesty-pack-rg-blockers.json` — Stage 1127 B1
- `docs/TRANSFER_CORSO_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-corso-gate-honesty-pack-rg-pointers.json` — Stage 1127 P1
- `docs/TRANSFER_PAVILION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pavilion-gate-honesty-pack-remaining-gate.json` — Stage 1126 I1
- `docs/TRANSFER_PAVILION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pavilion-gate-honesty-pack-rg-blockers.json` — Stage 1126 B1
- `docs/TRANSFER_PAVILION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pavilion-gate-honesty-pack-rg-pointers.json` — Stage 1126 P1
- `docs/TRANSFER_GAZEBO_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gazebo-gate-honesty-pack-remaining-gate.json` — Stage 1125 I1
- `docs/TRANSFER_GAZEBO_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gazebo-gate-honesty-pack-rg-blockers.json` — Stage 1125 B1
- `docs/TRANSFER_GAZEBO_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gazebo-gate-honesty-pack-rg-pointers.json` — Stage 1125 P1
- `docs/TRANSFER_PARAPET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-parapet-gate-honesty-pack-remaining-gate.json` — Stage 1124 I1
- `docs/TRANSFER_PARAPET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-parapet-gate-honesty-pack-rg-blockers.json` — Stage 1124 B1
- `docs/TRANSFER_PARAPET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-parapet-gate-honesty-pack-rg-pointers.json` — Stage 1124 P1
- `docs/TRANSFER_BALCONY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-balcony-gate-honesty-pack-remaining-gate.json` — Stage 1123 I1
- `docs/TRANSFER_BALCONY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-balcony-gate-honesty-pack-rg-blockers.json` — Stage 1123 B1
- `docs/TRANSFER_BALCONY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-balcony-gate-honesty-pack-rg-pointers.json` — Stage 1123 P1
- `docs/TRANSFER_VERANDA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-veranda-gate-honesty-pack-remaining-gate.json` — Stage 1122 I1
- `docs/TRANSFER_VERANDA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-veranda-gate-honesty-pack-rg-blockers.json` — Stage 1122 B1
- `docs/TRANSFER_VERANDA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-veranda-gate-honesty-pack-rg-pointers.json` — Stage 1122 P1
- `docs/TRANSFER_PIAZZA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-piazza-gate-honesty-pack-remaining-gate.json` — Stage 1121 I1
- `docs/TRANSFER_PIAZZA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-piazza-gate-honesty-pack-rg-blockers.json` — Stage 1121 B1
- `docs/TRANSFER_PIAZZA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-piazza-gate-honesty-pack-rg-pointers.json` — Stage 1121 P1
- `docs/TRANSFER_COLONNADE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-colonnade-gate-honesty-pack-remaining-gate.json` — Stage 1120 I1
- `docs/TRANSFER_COLONNADE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-colonnade-gate-honesty-pack-rg-blockers.json` — Stage 1120 B1
- `docs/TRANSFER_COLONNADE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-colonnade-gate-honesty-pack-rg-pointers.json` — Stage 1120 P1
- `docs/TRANSFER_PERGOLA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-pergola-gate-honesty-pack-remaining-gate.json` — Stage 1119 I1
- `docs/TRANSFER_PERGOLA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-pergola-gate-honesty-pack-rg-blockers.json` — Stage 1119 B1
- `docs/TRANSFER_PERGOLA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-pergola-gate-honesty-pack-rg-pointers.json` — Stage 1119 P1
- `docs/TRANSFER_ROTUNDA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rotunda-gate-honesty-pack-remaining-gate.json` — Stage 1118 I1
- `docs/TRANSFER_ROTUNDA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rotunda-gate-honesty-pack-rg-blockers.json` — Stage 1118 B1
- `docs/TRANSFER_ROTUNDA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rotunda-gate-honesty-pack-rg-pointers.json` — Stage 1118 P1
- `docs/TRANSFER_PORTICO_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-portico-gate-honesty-pack-remaining-gate.json` — Stage 1117 I1
- `docs/TRANSFER_PORTICO_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-portico-gate-honesty-pack-rg-blockers.json` — Stage 1117 B1
- `docs/TRANSFER_PORTICO_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-portico-gate-honesty-pack-rg-pointers.json` — Stage 1117 P1
- `docs/TRANSFER_LOGGIA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-loggia-gate-honesty-pack-remaining-gate.json` — Stage 1116 I1
- `docs/TRANSFER_LOGGIA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-loggia-gate-honesty-pack-rg-blockers.json` — Stage 1116 B1
- `docs/TRANSFER_LOGGIA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-loggia-gate-honesty-pack-rg-pointers.json` — Stage 1116 P1
- `docs/TRANSFER_FOYER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-foyer-gate-honesty-pack-remaining-gate.json` — Stage 1115 I1
- `docs/TRANSFER_FOYER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-foyer-gate-honesty-pack-rg-blockers.json` — Stage 1115 B1
- `docs/TRANSFER_FOYER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-foyer-gate-honesty-pack-rg-pointers.json` — Stage 1115 P1
- `docs/TRANSFER_GALLERY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gallery-gate-honesty-pack-remaining-gate.json` — Stage 1114 I1
- `docs/TRANSFER_GALLERY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gallery-gate-honesty-pack-rg-blockers.json` — Stage 1114 B1
- `docs/TRANSFER_GALLERY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gallery-gate-honesty-pack-rg-pointers.json` — Stage 1114 P1
- `docs/TRANSFER_QUADRANGLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quadrangle-gate-honesty-pack-remaining-gate.json` — Stage 1113 I1
- `docs/TRANSFER_QUADRANGLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quadrangle-gate-honesty-pack-rg-blockers.json` — Stage 1113 B1
- `docs/TRANSFER_QUADRANGLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quadrangle-gate-honesty-pack-rg-pointers.json` — Stage 1113 P1
- `docs/TRANSFER_CLOISTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cloister-gate-honesty-pack-remaining-gate.json` — Stage 1112 I1
- `docs/TRANSFER_CLOISTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cloister-gate-honesty-pack-rg-blockers.json` — Stage 1112 B1
- `docs/TRANSFER_CLOISTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cloister-gate-honesty-pack-rg-pointers.json` — Stage 1112 P1
- `docs/TRANSFER_ATRIUM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-atrium-gate-honesty-pack-remaining-gate.json` — Stage 1111 I1
- `docs/TRANSFER_ATRIUM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-atrium-gate-honesty-pack-rg-blockers.json` — Stage 1111 B1
- `docs/TRANSFER_ATRIUM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-atrium-gate-honesty-pack-rg-pointers.json` — Stage 1111 P1
- `docs/TRANSFER_COURTYARD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-courtyard-gate-honesty-pack-remaining-gate.json` — Stage 1110 I1
- `docs/TRANSFER_COURTYARD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-courtyard-gate-honesty-pack-rg-blockers.json` — Stage 1110 B1
- `docs/TRANSFER_COURTYARD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-courtyard-gate-honesty-pack-rg-pointers.json` — Stage 1110 P1
- `docs/TRANSFER_TERRACE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-terrace-gate-honesty-pack-remaining-gate.json` — Stage 1109 I1
- `docs/TRANSFER_TERRACE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-terrace-gate-honesty-pack-rg-blockers.json` — Stage 1109 B1
- `docs/TRANSFER_TERRACE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-terrace-gate-honesty-pack-rg-pointers.json` — Stage 1109 P1
- `docs/TRANSFER_MEZZANINE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-mezzanine-gate-honesty-pack-remaining-gate.json` — Stage 1108 I1
- `docs/TRANSFER_MEZZANINE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-mezzanine-gate-honesty-pack-rg-blockers.json` — Stage 1108 B1
- `docs/TRANSFER_MEZZANINE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-mezzanine-gate-honesty-pack-rg-pointers.json` — Stage 1108 P1
- `docs/TRANSFER_ARCADE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-arcade-gate-honesty-pack-remaining-gate.json` — Stage 1107 I1
- `docs/TRANSFER_ARCADE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-arcade-gate-honesty-pack-rg-blockers.json` — Stage 1107 B1
- `docs/TRANSFER_ARCADE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-arcade-gate-honesty-pack-rg-pointers.json` — Stage 1107 P1
- `docs/TRANSFER_ALLEY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-alley-gate-honesty-pack-remaining-gate.json` — Stage 1106 I1
- `docs/TRANSFER_ALLEY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-alley-gate-honesty-pack-rg-blockers.json` — Stage 1106 B1
- `docs/TRANSFER_ALLEY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-alley-gate-honesty-pack-rg-pointers.json` — Stage 1106 P1
- `docs/TRANSFER_PLAZA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-plaza-gate-honesty-pack-remaining-gate.json` — Stage 1105 I1
- `docs/TRANSFER_PLAZA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-plaza-gate-honesty-pack-rg-blockers.json` — Stage 1105 B1
- `docs/TRANSFER_PLAZA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-plaza-gate-honesty-pack-rg-pointers.json` — Stage 1105 P1
- `docs/TRANSFER_ESPLANADE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-esplanade-gate-honesty-pack-remaining-gate.json` — Stage 1104 I1
- `docs/TRANSFER_ESPLANADE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-esplanade-gate-honesty-pack-rg-blockers.json` — Stage 1104 B1
- `docs/TRANSFER_ESPLANADE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-esplanade-gate-honesty-pack-rg-pointers.json` — Stage 1104 P1
- `docs/TRANSFER_PARKWAY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-parkway-gate-honesty-pack-remaining-gate.json` — Stage 1103 I1
- `docs/TRANSFER_PARKWAY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-parkway-gate-honesty-pack-rg-blockers.json` — Stage 1103 B1
- `docs/TRANSFER_PARKWAY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-parkway-gate-honesty-pack-rg-pointers.json` — Stage 1103 P1
- `docs/TRANSFER_PROMENADE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-promenade-gate-honesty-pack-remaining-gate.json` — Stage 1102 I1
- `docs/TRANSFER_PROMENADE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-promenade-gate-honesty-pack-rg-blockers.json` — Stage 1102 B1
- `docs/TRANSFER_PROMENADE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-promenade-gate-honesty-pack-rg-pointers.json` — Stage 1102 P1
- `docs/TRANSFER_CAUSEWAY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-causeway-gate-honesty-pack-remaining-gate.json` — Stage 1101 I1
- `docs/TRANSFER_CAUSEWAY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-causeway-gate-honesty-pack-rg-blockers.json` — Stage 1101 B1
- `docs/TRANSFER_CAUSEWAY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-causeway-gate-honesty-pack-rg-pointers.json` — Stage 1101 P1
- `docs/TRANSFER_BOULEVARD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-boulevard-gate-honesty-pack-remaining-gate.json` — Stage 1100 I1
- `docs/TRANSFER_BOULEVARD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-boulevard-gate-honesty-pack-rg-blockers.json` — Stage 1100 B1
- `docs/TRANSFER_BOULEVARD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-boulevard-gate-honesty-pack-rg-pointers.json` — Stage 1100 P1
- `docs/TRANSFER_AVENUE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-avenue-gate-honesty-pack-remaining-gate.json` — Stage 1099 I1
- `docs/TRANSFER_AVENUE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-avenue-gate-honesty-pack-rg-blockers.json` — Stage 1099 B1
- `docs/TRANSFER_AVENUE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-avenue-gate-honesty-pack-rg-pointers.json` — Stage 1099 P1
- `docs/TRANSFER_CONDUIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-conduit-gate-honesty-pack-remaining-gate.json` — Stage 1098 I1
- `docs/TRANSFER_CONDUIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-conduit-gate-honesty-pack-rg-blockers.json` — Stage 1098 B1
- `docs/TRANSFER_CONDUIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-conduit-gate-honesty-pack-rg-pointers.json` — Stage 1098 P1
- `docs/TRANSFER_ARTERIAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-arterial-gate-honesty-pack-remaining-gate.json` — Stage 1097 I1
- `docs/TRANSFER_ARTERIAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-arterial-gate-honesty-pack-rg-blockers.json` — Stage 1097 B1
- `docs/TRANSFER_ARTERIAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-arterial-gate-honesty-pack-rg-pointers.json` — Stage 1097 P1
- `docs/TRANSFER_THOROUGHFARE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-thoroughfare-gate-honesty-pack-remaining-gate.json` — Stage 1096 I1
- `docs/TRANSFER_THOROUGHFARE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-thoroughfare-gate-honesty-pack-rg-blockers.json` — Stage 1096 B1
- `docs/TRANSFER_THOROUGHFARE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-thoroughfare-gate-honesty-pack-rg-pointers.json` — Stage 1096 P1
- `docs/TRANSFER_PASSAGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-passage-gate-honesty-pack-remaining-gate.json` — Stage 1095 I1
- `docs/TRANSFER_PASSAGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-passage-gate-honesty-pack-rg-blockers.json` — Stage 1095 B1
- `docs/TRANSFER_PASSAGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-passage-gate-honesty-pack-rg-pointers.json` — Stage 1095 P1
- `docs/TRANSFER_TRAIL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-trail-gate-honesty-pack-remaining-gate.json` — Stage 1094 I1
- `docs/TRANSFER_TRAIL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-trail-gate-honesty-pack-rg-blockers.json` — Stage 1094 B1
- `docs/TRANSFER_TRAIL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-trail-gate-honesty-pack-rg-pointers.json` — Stage 1094 P1
- `docs/TRANSFER_TRACK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-track-gate-honesty-pack-remaining-gate.json` — Stage 1093 I1
- `docs/TRANSFER_TRACK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-track-gate-honesty-pack-rg-blockers.json` — Stage 1093 B1
- `docs/TRANSFER_TRACK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-track-gate-honesty-pack-rg-pointers.json` — Stage 1093 P1
- `docs/TRANSFER_LANE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lane-gate-honesty-pack-remaining-gate.json` — Stage 1092 I1
- `docs/TRANSFER_LANE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lane-gate-honesty-pack-rg-blockers.json` — Stage 1092 B1
- `docs/TRANSFER_LANE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lane-gate-honesty-pack-rg-pointers.json` — Stage 1092 P1
- `docs/TRANSFER_PATH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-path-gate-honesty-pack-remaining-gate.json` — Stage 1091 I1
- `docs/TRANSFER_PATH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-path-gate-honesty-pack-rg-blockers.json` — Stage 1091 B1
- `docs/TRANSFER_PATH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-path-gate-honesty-pack-rg-pointers.json` — Stage 1091 P1
- `docs/TRANSFER_TRAJECTORY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-trajectory-gate-honesty-pack-remaining-gate.json` — Stage 1090 I1
- `docs/TRANSFER_TRAJECTORY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-trajectory-gate-honesty-pack-rg-blockers.json` — Stage 1090 B1
- `docs/TRANSFER_TRAJECTORY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-trajectory-gate-honesty-pack-rg-pointers.json` — Stage 1090 P1
- `docs/TRANSFER_COURSE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-course-gate-honesty-pack-remaining-gate.json` — Stage 1089 I1
- `docs/TRANSFER_COURSE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-course-gate-honesty-pack-rg-blockers.json` — Stage 1089 B1
- `docs/TRANSFER_COURSE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-course-gate-honesty-pack-rg-pointers.json` — Stage 1089 P1
- `docs/TRANSFER_VECTOR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-vector-gate-honesty-pack-remaining-gate.json` — Stage 1088 I1
- `docs/TRANSFER_VECTOR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-vector-gate-honesty-pack-rg-blockers.json` — Stage 1088 B1
- `docs/TRANSFER_VECTOR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-vector-gate-honesty-pack-rg-pointers.json` — Stage 1088 P1
- `docs/TRANSFER_HEADING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-heading-gate-honesty-pack-remaining-gate.json` — Stage 1087 I1
- `docs/TRANSFER_HEADING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-heading-gate-honesty-pack-rg-blockers.json` — Stage 1087 B1
- `docs/TRANSFER_HEADING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-heading-gate-honesty-pack-rg-pointers.json` — Stage 1087 P1
- `docs/TRANSFER_BEARING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bearing-gate-honesty-pack-remaining-gate.json` — Stage 1086 I1
- `docs/TRANSFER_BEARING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bearing-gate-honesty-pack-rg-blockers.json` — Stage 1086 B1
- `docs/TRANSFER_BEARING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bearing-gate-honesty-pack-rg-pointers.json` — Stage 1086 P1
- `docs/TRANSFER_AZIMUTH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-azimuth-gate-honesty-pack-remaining-gate.json` — Stage 1085 I1
- `docs/TRANSFER_AZIMUTH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-azimuth-gate-honesty-pack-rg-blockers.json` — Stage 1085 B1
- `docs/TRANSFER_AZIMUTH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-azimuth-gate-honesty-pack-rg-pointers.json` — Stage 1085 P1
- `docs/TRANSFER_COVERAGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-coverage-gate-honesty-pack-remaining-gate.json` — Stage 1084 I1
- `docs/TRANSFER_COVERAGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-coverage-gate-honesty-pack-rg-blockers.json` — Stage 1084 B1
- `docs/TRANSFER_COVERAGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-coverage-gate-honesty-pack-rg-pointers.json` — Stage 1084 P1
- `docs/TRANSFER_SWEEP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sweep-gate-honesty-pack-remaining-gate.json` — Stage 1083 I1
- `docs/TRANSFER_SWEEP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sweep-gate-honesty-pack-rg-blockers.json` — Stage 1083 B1
- `docs/TRANSFER_SWEEP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sweep-gate-honesty-pack-rg-pointers.json` — Stage 1083 P1
- `docs/TRANSFER_PURVIEW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-purview-gate-honesty-pack-remaining-gate.json` — Stage 1082 I1
- `docs/TRANSFER_PURVIEW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-purview-gate-honesty-pack-rg-blockers.json` — Stage 1082 B1
- `docs/TRANSFER_PURVIEW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-purview-gate-honesty-pack-rg-pointers.json` — Stage 1082 P1
- `docs/TRANSFER_AMBIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ambit-gate-honesty-pack-remaining-gate.json` — Stage 1081 I1
- `docs/TRANSFER_AMBIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ambit-gate-honesty-pack-rg-blockers.json` — Stage 1081 B1
- `docs/TRANSFER_AMBIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ambit-gate-honesty-pack-rg-pointers.json` — Stage 1081 P1
- `docs/TRANSFER_LONGITUDE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-longitude-gate-honesty-pack-remaining-gate.json` — Stage 1080 I1
- `docs/TRANSFER_LONGITUDE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-longitude-gate-honesty-pack-rg-blockers.json` — Stage 1080 B1
- `docs/TRANSFER_LONGITUDE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-longitude-gate-honesty-pack-rg-pointers.json` — Stage 1080 P1
- `docs/TRANSFER_LATITUDE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-latitude-gate-honesty-pack-remaining-gate.json` — Stage 1079 I1
- `docs/TRANSFER_LATITUDE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-latitude-gate-honesty-pack-rg-blockers.json` — Stage 1079 B1
- `docs/TRANSFER_LATITUDE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-latitude-gate-honesty-pack-rg-pointers.json` — Stage 1079 P1
- `docs/TRANSFER_COMPASS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-compass-gate-honesty-pack-remaining-gate.json` — Stage 1078 I1
- `docs/TRANSFER_COMPASS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-compass-gate-honesty-pack-rg-blockers.json` — Stage 1078 B1
- `docs/TRANSFER_COMPASS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-compass-gate-honesty-pack-rg-pointers.json` — Stage 1078 P1
- `docs/TRANSFER_ORBIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-orbit-gate-honesty-pack-remaining-gate.json` — Stage 1077 I1
- `docs/TRANSFER_ORBIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-orbit-gate-honesty-pack-rg-blockers.json` — Stage 1077 B1
- `docs/TRANSFER_ORBIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-orbit-gate-honesty-pack-rg-pointers.json` — Stage 1077 P1
- `docs/TRANSFER_ARC_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-arc-gate-honesty-pack-remaining-gate.json` — Stage 1076 I1
- `docs/TRANSFER_ARC_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-arc-gate-honesty-pack-rg-blockers.json` — Stage 1076 B1
- `docs/TRANSFER_ARC_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-arc-gate-honesty-pack-rg-pointers.json` — Stage 1076 P1
- `docs/TRANSFER_RADIUS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-radius-gate-honesty-pack-remaining-gate.json` — Stage 1075 I1
- `docs/TRANSFER_RADIUS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-radius-gate-honesty-pack-rg-blockers.json` — Stage 1075 B1
- `docs/TRANSFER_RADIUS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-radius-gate-honesty-pack-rg-pointers.json` — Stage 1075 P1
- `docs/TRANSFER_HORIZON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-horizon-gate-honesty-pack-remaining-gate.json` — Stage 1074 I1
- `docs/TRANSFER_HORIZON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-horizon-gate-honesty-pack-rg-blockers.json` — Stage 1074 B1
- `docs/TRANSFER_HORIZON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-horizon-gate-honesty-pack-rg-pointers.json` — Stage 1074 P1
- `docs/TRANSFER_REACH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-reach-gate-honesty-pack-remaining-gate.json` — Stage 1073 I1
- `docs/TRANSFER_REACH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-reach-gate-honesty-pack-rg-blockers.json` — Stage 1073 B1
- `docs/TRANSFER_REACH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-reach-gate-honesty-pack-rg-pointers.json` — Stage 1073 P1
- `docs/TRANSFER_DEPTH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-depth-gate-honesty-pack-remaining-gate.json` — Stage 1072 I1
- `docs/TRANSFER_DEPTH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-depth-gate-honesty-pack-rg-blockers.json` — Stage 1072 B1
- `docs/TRANSFER_DEPTH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-depth-gate-honesty-pack-rg-pointers.json` — Stage 1072 P1
- `docs/TRANSFER_WIDTH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-width-gate-honesty-pack-remaining-gate.json` — Stage 1071 I1
- `docs/TRANSFER_WIDTH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-width-gate-honesty-pack-rg-blockers.json` — Stage 1071 B1
- `docs/TRANSFER_WIDTH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-width-gate-honesty-pack-rg-pointers.json` — Stage 1071 P1
- `docs/TRANSFER_BREADTH_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-breadth-gate-honesty-pack-remaining-gate.json` — Stage 1070 I1
- `docs/TRANSFER_BREADTH_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-breadth-gate-honesty-pack-rg-blockers.json` — Stage 1070 B1
- `docs/TRANSFER_BREADTH_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-breadth-gate-honesty-pack-rg-pointers.json` — Stage 1070 P1
- `docs/TRANSFER_EXTENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-extent-gate-honesty-pack-remaining-gate.json` — Stage 1069 I1
- `docs/TRANSFER_EXTENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-extent-gate-honesty-pack-rg-blockers.json` — Stage 1069 B1
- `docs/TRANSFER_EXTENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-extent-gate-honesty-pack-rg-pointers.json` — Stage 1069 P1
- `docs/TRANSFER_WINDOW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-window-gate-honesty-pack-remaining-gate.json` — Stage 1068 I1
- `docs/TRANSFER_WINDOW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-window-gate-honesty-pack-rg-blockers.json` — Stage 1068 B1
- `docs/TRANSFER_WINDOW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-window-gate-honesty-pack-rg-pointers.json` — Stage 1068 P1
- `docs/TRANSFER_INTERVAL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-interval-gate-honesty-pack-remaining-gate.json` — Stage 1067 I1
- `docs/TRANSFER_INTERVAL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-interval-gate-honesty-pack-rg-blockers.json` — Stage 1067 B1
- `docs/TRANSFER_INTERVAL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-interval-gate-honesty-pack-rg-pointers.json` — Stage 1067 P1
- `docs/TRANSFER_SPAN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-span-gate-honesty-pack-remaining-gate.json` — Stage 1066 I1
- `docs/TRANSFER_SPAN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-span-gate-honesty-pack-rg-blockers.json` — Stage 1066 B1
- `docs/TRANSFER_SPAN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-span-gate-honesty-pack-rg-pointers.json` — Stage 1066 P1
- `docs/TRANSFER_RANGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-range-gate-honesty-pack-remaining-gate.json` — Stage 1065 I1
- `docs/TRANSFER_RANGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-range-gate-honesty-pack-rg-blockers.json` — Stage 1065 B1
- `docs/TRANSFER_RANGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-range-gate-honesty-pack-rg-pointers.json` — Stage 1065 P1
- `docs/TRANSFER_BRACKET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bracket-gate-honesty-pack-remaining-gate.json` — Stage 1064 I1
- `docs/TRANSFER_BRACKET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bracket-gate-honesty-pack-rg-blockers.json` — Stage 1064 B1
- `docs/TRANSFER_BRACKET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bracket-gate-honesty-pack-rg-pointers.json` — Stage 1064 P1
- `docs/TRANSFER_STRATA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-strata-gate-honesty-pack-remaining-gate.json` — Stage 1063 I1
- `docs/TRANSFER_STRATA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-strata-gate-honesty-pack-rg-blockers.json` — Stage 1063 B1
- `docs/TRANSFER_STRATA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-strata-gate-honesty-pack-rg-pointers.json` — Stage 1063 P1
- `docs/TRANSFER_CLASS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-class-gate-honesty-pack-remaining-gate.json` — Stage 1062 I1
- `docs/TRANSFER_CLASS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-class-gate-honesty-pack-rg-blockers.json` — Stage 1062 B1
- `docs/TRANSFER_CLASS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-class-gate-honesty-pack-rg-pointers.json` — Stage 1062 P1
- `docs/TRANSFER_BAND_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-band-gate-honesty-pack-remaining-gate.json` — Stage 1061 I1
- `docs/TRANSFER_BAND_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-band-gate-honesty-pack-rg-blockers.json` — Stage 1061 B1
- `docs/TRANSFER_BAND_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-band-gate-honesty-pack-rg-pointers.json` — Stage 1061 P1
- `docs/TRANSFER_LEVEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-level-gate-honesty-pack-remaining-gate.json` — Stage 1060 I1
- `docs/TRANSFER_LEVEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-level-gate-honesty-pack-rg-blockers.json` — Stage 1060 B1
- `docs/TRANSFER_LEVEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-level-gate-honesty-pack-rg-pointers.json` — Stage 1060 P1
- `docs/TRANSFER_TIER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tier-gate-honesty-pack-remaining-gate.json` — Stage 1059 I1
- `docs/TRANSFER_TIER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tier-gate-honesty-pack-rg-blockers.json` — Stage 1059 B1
- `docs/TRANSFER_TIER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tier-gate-honesty-pack-rg-pointers.json` — Stage 1059 P1
- `docs/TRANSFER_RATING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rating-gate-honesty-pack-remaining-gate.json` — Stage 1058 I1
- `docs/TRANSFER_RATING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rating-gate-honesty-pack-rg-blockers.json` — Stage 1058 B1
- `docs/TRANSFER_RATING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rating-gate-honesty-pack-rg-pointers.json` — Stage 1058 P1
- `docs/TRANSFER_GRADE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-grade-gate-honesty-pack-remaining-gate.json` — Stage 1057 I1
- `docs/TRANSFER_GRADE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-grade-gate-honesty-pack-rg-blockers.json` — Stage 1057 B1
- `docs/TRANSFER_GRADE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-grade-gate-honesty-pack-rg-pointers.json` — Stage 1057 P1
- `docs/TRANSFER_RANK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rank-gate-honesty-pack-remaining-gate.json` — Stage 1056 I1
- `docs/TRANSFER_RANK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rank-gate-honesty-pack-rg-blockers.json` — Stage 1056 B1
- `docs/TRANSFER_RANK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rank-gate-honesty-pack-rg-pointers.json` — Stage 1056 P1
- `docs/TRANSFER_SCORE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-score-gate-honesty-pack-remaining-gate.json` — Stage 1055 I1
- `docs/TRANSFER_SCORE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-score-gate-honesty-pack-rg-blockers.json` — Stage 1055 B1
- `docs/TRANSFER_SCORE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-score-gate-honesty-pack-rg-pointers.json` — Stage 1055 P1
- `docs/TRANSFER_GAUGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gauge-gate-honesty-pack-remaining-gate.json` — Stage 1054 I1
- `docs/TRANSFER_GAUGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gauge-gate-honesty-pack-rg-blockers.json` — Stage 1054 B1
- `docs/TRANSFER_GAUGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gauge-gate-honesty-pack-rg-pointers.json` — Stage 1054 P1
- `docs/TRANSFER_APPRAISE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-appraise-gate-honesty-pack-remaining-gate.json` — Stage 1053 I1
- `docs/TRANSFER_APPRAISE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-appraise-gate-honesty-pack-rg-blockers.json` — Stage 1053 B1
- `docs/TRANSFER_APPRAISE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-appraise-gate-honesty-pack-rg-pointers.json` — Stage 1053 P1
- `docs/TRANSFER_EVALUATE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-evaluate-gate-honesty-pack-remaining-gate.json` — Stage 1052 I1
- `docs/TRANSFER_EVALUATE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-evaluate-gate-honesty-pack-rg-blockers.json` — Stage 1052 B1
- `docs/TRANSFER_EVALUATE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-evaluate-gate-honesty-pack-rg-pointers.json` — Stage 1052 P1
- `docs/TRANSFER_ASSESS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-assess-gate-honesty-pack-remaining-gate.json` — Stage 1051 I1
- `docs/TRANSFER_ASSESS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-assess-gate-honesty-pack-rg-blockers.json` — Stage 1051 B1
- `docs/TRANSFER_ASSESS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-assess-gate-honesty-pack-rg-pointers.json` — Stage 1051 P1
- `docs/TRANSFER_EXAMINE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-examine-gate-honesty-pack-remaining-gate.json` — Stage 1050 I1
- `docs/TRANSFER_EXAMINE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-examine-gate-honesty-pack-rg-blockers.json` — Stage 1050 B1
- `docs/TRANSFER_EXAMINE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-examine-gate-honesty-pack-rg-pointers.json` — Stage 1050 P1
- `docs/TRANSFER_SCRUTINY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-scrutiny-gate-honesty-pack-remaining-gate.json` — Stage 1049 I1
- `docs/TRANSFER_SCRUTINY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-scrutiny-gate-honesty-pack-rg-blockers.json` — Stage 1049 B1
- `docs/TRANSFER_SCRUTINY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-scrutiny-gate-honesty-pack-rg-pointers.json` — Stage 1049 P1
- `docs/TRANSFER_REVIEW_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-review-gate-honesty-pack-remaining-gate.json` — Stage 1048 I1
- `docs/TRANSFER_REVIEW_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-review-gate-honesty-pack-rg-blockers.json` — Stage 1048 B1
- `docs/TRANSFER_REVIEW_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-review-gate-honesty-pack-rg-pointers.json` — Stage 1048 P1
- `docs/TRANSFER_CHECK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-check-gate-honesty-pack-remaining-gate.json` — Stage 1047 I1
- `docs/TRANSFER_CHECK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-check-gate-honesty-pack-rg-blockers.json` — Stage 1047 B1
- `docs/TRANSFER_CHECK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-check-gate-honesty-pack-rg-pointers.json` — Stage 1047 P1
- `docs/TRANSFER_CONFIRM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-confirm-gate-honesty-pack-remaining-gate.json` — Stage 1046 I1
- `docs/TRANSFER_CONFIRM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-confirm-gate-honesty-pack-rg-blockers.json` — Stage 1046 B1
- `docs/TRANSFER_CONFIRM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-confirm-gate-honesty-pack-rg-pointers.json` — Stage 1046 P1
- `docs/TRANSFER_VERIFY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-verify-gate-honesty-pack-remaining-gate.json` — Stage 1045 I1
- `docs/TRANSFER_VERIFY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-verify-gate-honesty-pack-rg-blockers.json` — Stage 1045 B1
- `docs/TRANSFER_VERIFY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-verify-gate-honesty-pack-rg-pointers.json` — Stage 1045 P1
- `docs/TRANSFER_VALIDATE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-validate-gate-honesty-pack-remaining-gate.json` — Stage 1044 I1
- `docs/TRANSFER_VALIDATE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-validate-gate-honesty-pack-rg-blockers.json` — Stage 1044 B1
- `docs/TRANSFER_VALIDATE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-validate-gate-honesty-pack-rg-pointers.json` — Stage 1044 P1
- `docs/TRANSFER_CERTIFY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-certify-gate-honesty-pack-remaining-gate.json` — Stage 1043 I1
- `docs/TRANSFER_CERTIFY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-certify-gate-honesty-pack-rg-blockers.json` — Stage 1043 B1
- `docs/TRANSFER_CERTIFY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-certify-gate-honesty-pack-rg-pointers.json` — Stage 1043 P1
- `docs/TRANSFER_ACCREDIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-accredit-gate-honesty-pack-remaining-gate.json` — Stage 1042 I1
- `docs/TRANSFER_ACCREDIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-accredit-gate-honesty-pack-rg-blockers.json` — Stage 1042 B1
- `docs/TRANSFER_ACCREDIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-accredit-gate-honesty-pack-rg-pointers.json` — Stage 1042 P1
- `docs/TRANSFER_AUTHORIZATION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-authorization-gate-honesty-pack-remaining-gate.json` — Stage 1041 I1
- `docs/TRANSFER_AUTHORIZATION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-authorization-gate-honesty-pack-rg-blockers.json` — Stage 1041 B1
- `docs/TRANSFER_AUTHORIZATION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-authorization-gate-honesty-pack-rg-pointers.json` — Stage 1041 P1
- `docs/TRANSFER_CLEARANCE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clearance-gate-honesty-pack-remaining-gate.json` — Stage 1040 I1
- `docs/TRANSFER_CLEARANCE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clearance-gate-honesty-pack-rg-blockers.json` — Stage 1040 B1
- `docs/TRANSFER_CLEARANCE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clearance-gate-honesty-pack-rg-pointers.json` — Stage 1040 P1
- `docs/TRANSFER_LICENSE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-license-gate-honesty-pack-remaining-gate.json` — Stage 1039 I1
- `docs/TRANSFER_LICENSE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-license-gate-honesty-pack-rg-blockers.json` — Stage 1039 B1
- `docs/TRANSFER_LICENSE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-license-gate-honesty-pack-rg-pointers.json` — Stage 1039 P1
- `docs/TRANSFER_PERMIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-permit-gate-honesty-pack-remaining-gate.json` — Stage 1038 I1
- `docs/TRANSFER_PERMIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-permit-gate-honesty-pack-rg-blockers.json` — Stage 1038 B1
- `docs/TRANSFER_PERMIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-permit-gate-honesty-pack-rg-pointers.json` — Stage 1038 P1
...
- `docs/TRANSFER_VOUCHER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-voucher-gate-honesty-pack-remaining-gate.json` — Stage 1035 I1
- `docs/TRANSFER_VOUCHER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-voucher-gate-honesty-pack-rg-blockers.json` — Stage 1035 B1
- `docs/TRANSFER_VOUCHER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-voucher-gate-honesty-pack-rg-pointers.json` — Stage 1035 P1
- `docs/TRANSFER_SUBSIDY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-subsidy-gate-honesty-pack-remaining-gate.json` — Stage 1034 I1
- `docs/TRANSFER_SUBSIDY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-subsidy-gate-honesty-pack-rg-blockers.json` — Stage 1034 B1
- `docs/TRANSFER_SUBSIDY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-subsidy-gate-honesty-pack-rg-pointers.json` — Stage 1034 P1
- `docs/TRANSFER_ENDOWMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-endowment-gate-honesty-pack-remaining-gate.json` — Stage 1033 I1
- `docs/TRANSFER_ENDOWMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-endowment-gate-honesty-pack-rg-blockers.json` — Stage 1033 B1
- `docs/TRANSFER_ENDOWMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-endowment-gate-honesty-pack-rg-pointers.json` — Stage 1033 P1
- `docs/TRANSFER_ALLOCATION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-allocation-gate-honesty-pack-remaining-gate.json` — Stage 1032 I1
- `docs/TRANSFER_ALLOCATION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-allocation-gate-honesty-pack-rg-blockers.json` — Stage 1032 B1
- `docs/TRANSFER_ALLOCATION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-allocation-gate-honesty-pack-rg-pointers.json` — Stage 1032 P1
- `docs/TRANSFER_GRANT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-grant-gate-honesty-pack-remaining-gate.json` — Stage 1031 I1
- `docs/TRANSFER_GRANT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-grant-gate-honesty-pack-rg-blockers.json` — Stage 1031 B1
- `docs/TRANSFER_GRANT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-grant-gate-honesty-pack-rg-pointers.json` — Stage 1031 P1
- `docs/TRANSFER_PROVISION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-provision-gate-honesty-pack-remaining-gate.json` — Stage 1030 I1
- `docs/TRANSFER_PROVISION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-provision-gate-honesty-pack-rg-blockers.json` — Stage 1030 B1
- `docs/TRANSFER_PROVISION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-provision-gate-honesty-pack-rg-pointers.json` — Stage 1030 P1
- `docs/TRANSFER_STIPEND_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stipend-gate-honesty-pack-remaining-gate.json` — Stage 1029 I1
- `docs/TRANSFER_STIPEND_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stipend-gate-honesty-pack-rg-blockers.json` — Stage 1029 B1
- `docs/TRANSFER_STIPEND_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stipend-gate-honesty-pack-rg-pointers.json` — Stage 1029 P1
- `docs/TRANSFER_ALLOTMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-allotment-gate-honesty-pack-remaining-gate.json` — Stage 1028 I1
- `docs/TRANSFER_ALLOTMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-allotment-gate-honesty-pack-rg-blockers.json` — Stage 1028 B1
- `docs/TRANSFER_ALLOTMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-allotment-gate-honesty-pack-rg-pointers.json` — Stage 1028 P1
- `docs/TRANSFER_ENTITLEMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-entitlement-gate-honesty-pack-remaining-gate.json` — Stage 1027 I1
- `docs/TRANSFER_ENTITLEMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-entitlement-gate-honesty-pack-rg-blockers.json` — Stage 1027 B1
- `docs/TRANSFER_ENTITLEMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-entitlement-gate-honesty-pack-rg-pointers.json` — Stage 1027 P1
- `docs/TRANSFER_CREDIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-credit-gate-honesty-pack-remaining-gate.json` — Stage 1026 I1
- `docs/TRANSFER_CREDIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-credit-gate-honesty-pack-rg-blockers.json` — Stage 1026 B1
- `docs/TRANSFER_CREDIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-credit-gate-honesty-pack-rg-pointers.json` — Stage 1026 P1
- `docs/TRANSFER_ALLOWANCE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-allowance-gate-honesty-pack-remaining-gate.json` — Stage 1025 I1
- `docs/TRANSFER_ALLOWANCE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-allowance-gate-honesty-pack-rg-blockers.json` — Stage 1025 B1
- `docs/TRANSFER_ALLOWANCE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-allowance-gate-honesty-pack-rg-pointers.json` — Stage 1025 P1
- `docs/TRANSFER_BUDGET_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-budget-gate-honesty-pack-remaining-gate.json` — Stage 1024 I1
- `docs/TRANSFER_BUDGET_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-budget-gate-honesty-pack-rg-blockers.json` — Stage 1024 B1
- `docs/TRANSFER_BUDGET_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-budget-gate-honesty-pack-rg-pointers.json` — Stage 1024 P1
- `docs/TRANSFER_METER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-meter-gate-honesty-pack-remaining-gate.json` — Stage 1023 I1
- `docs/TRANSFER_METER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-meter-gate-honesty-pack-rg-blockers.json` — Stage 1023 B1
- `docs/TRANSFER_METER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-meter-gate-honesty-pack-rg-pointers.json` — Stage 1023 P1
- `docs/TRANSFER_RATE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rate-gate-honesty-pack-remaining-gate.json` — Stage 1022 I1
- `docs/TRANSFER_RATE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rate-gate-honesty-pack-rg-blockers.json` — Stage 1022 B1
- `docs/TRANSFER_RATE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rate-gate-honesty-pack-rg-pointers.json` — Stage 1022 P1
- `docs/TRANSFER_BOTTLENECK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bottleneck-gate-honesty-pack-remaining-gate.json` — Stage 1021 I1
- `docs/TRANSFER_BOTTLENECK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bottleneck-gate-honesty-pack-rg-blockers.json` — Stage 1021 B1
- `docs/TRANSFER_BOTTLENECK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bottleneck-gate-honesty-pack-rg-pointers.json` — Stage 1021 P1
- `docs/TRANSFER_CHOKEPOINT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-chokepoint-gate-honesty-pack-remaining-gate.json` — Stage 1020 I1
- `docs/TRANSFER_CHOKEPOINT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-chokepoint-gate-honesty-pack-rg-blockers.json` — Stage 1020 B1
- `docs/TRANSFER_CHOKEPOINT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-chokepoint-gate-honesty-pack-rg-pointers.json` — Stage 1020 P1
- `docs/TRANSFER_DAMPER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-damper-gate-honesty-pack-remaining-gate.json` — Stage 1019 I1
- `docs/TRANSFER_DAMPER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-damper-gate-honesty-pack-rg-blockers.json` — Stage 1019 B1
- `docs/TRANSFER_DAMPER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-damper-gate-honesty-pack-rg-pointers.json` — Stage 1019 P1
- `docs/TRANSFER_CLAMP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-clamp-gate-honesty-pack-remaining-gate.json` — Stage 1018 I1
- `docs/TRANSFER_CLAMP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-clamp-gate-honesty-pack-rg-blockers.json` — Stage 1018 B1
- `docs/TRANSFER_CLAMP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-clamp-gate-honesty-pack-rg-pointers.json` — Stage 1018 P1
- `docs/TRANSFER_LIMIT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-limit-gate-honesty-pack-remaining-gate.json` — Stage 1017 I1
- `docs/TRANSFER_LIMIT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-limit-gate-honesty-pack-rg-blockers.json` — Stage 1017 B1
- `docs/TRANSFER_LIMIT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-limit-gate-honesty-pack-rg-pointers.json` — Stage 1017 P1
- `docs/TRANSFER_THRESHOLD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-threshold-gate-honesty-pack-remaining-gate.json` — Stage 1016 I1
- `docs/TRANSFER_THRESHOLD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-threshold-gate-honesty-pack-rg-blockers.json` — Stage 1016 B1
- `docs/TRANSFER_THRESHOLD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-threshold-gate-honesty-pack-rg-pointers.json` — Stage 1016 P1
- `docs/TRANSFER_FLOOR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-floor-gate-honesty-pack-remaining-gate.json` — Stage 1015 I1
- `docs/TRANSFER_FLOOR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-floor-gate-honesty-pack-rg-blockers.json` — Stage 1015 B1
- `docs/TRANSFER_FLOOR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-floor-gate-honesty-pack-rg-pointers.json` — Stage 1015 P1
- `docs/TRANSFER_CEILING_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-ceiling-gate-honesty-pack-remaining-gate.json` — Stage 1014 I1
- `docs/TRANSFER_CEILING_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-ceiling-gate-honesty-pack-rg-blockers.json` — Stage 1014 B1
- `docs/TRANSFER_CEILING_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-ceiling-gate-honesty-pack-rg-pointers.json` — Stage 1014 P1
- `docs/TRANSFER_CAP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cap-gate-honesty-pack-remaining-gate.json` — Stage 1013 I1
- `docs/TRANSFER_CAP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cap-gate-honesty-pack-rg-blockers.json` — Stage 1013 B1
- `docs/TRANSFER_CAP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cap-gate-honesty-pack-rg-pointers.json` — Stage 1013 P1
- `docs/TRANSFER_QUOTA_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quota-gate-honesty-pack-remaining-gate.json` — Stage 1012 I1
- `docs/TRANSFER_QUOTA_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quota-gate-honesty-pack-rg-blockers.json` — Stage 1012 B1
- `docs/TRANSFER_QUOTA_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quota-gate-honesty-pack-rg-pointers.json` — Stage 1012 P1
- `docs/TRANSFER_THROTTLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-throttle-gate-honesty-pack-remaining-gate.json` — Stage 1011 I1
- `docs/TRANSFER_THROTTLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-throttle-gate-honesty-pack-rg-blockers.json` — Stage 1011 B1
- `docs/TRANSFER_THROTTLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-throttle-gate-honesty-pack-rg-pointers.json` — Stage 1011 P1
- `docs/TRANSFER_VALVE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-valve-gate-honesty-pack-remaining-gate.json` — Stage 1010 I1
- `docs/TRANSFER_VALVE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-valve-gate-honesty-pack-rg-blockers.json` — Stage 1010 B1
- `docs/TRANSFER_VALVE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-valve-gate-honesty-pack-rg-pointers.json` — Stage 1010 P1
- `docs/TRANSFER_ARMOR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-armor-gate-honesty-pack-remaining-gate.json` — Stage 1009 I1
- `docs/TRANSFER_ARMOR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-armor-gate-honesty-pack-rg-blockers.json` — Stage 1009 B1
- `docs/TRANSFER_ARMOR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-armor-gate-honesty-pack-rg-pointers.json` — Stage 1009 P1
- `docs/TRANSFER_WARDEN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-warden-gate-honesty-pack-remaining-gate.json` — Stage 1008 I1
- `docs/TRANSFER_WARDEN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-warden-gate-honesty-pack-rg-blockers.json` — Stage 1008 B1
- `docs/TRANSFER_WARDEN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-warden-gate-honesty-pack-rg-pointers.json` — Stage 1008 P1
- `docs/TRANSFER_CUSTODIAN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-custodian-gate-honesty-pack-remaining-gate.json` — Stage 1007 I1
- `docs/TRANSFER_CUSTODIAN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-custodian-gate-honesty-pack-rg-blockers.json` — Stage 1007 B1
- `docs/TRANSFER_CUSTODIAN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-custodian-gate-honesty-pack-rg-pointers.json` — Stage 1007 P1
- `docs/TRANSFER_GUARDRAIL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-guardrail-gate-honesty-pack-remaining-gate.json` — Stage 1006 I1
- `docs/TRANSFER_GUARDRAIL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-guardrail-gate-honesty-pack-rg-blockers.json` — Stage 1006 B1
- `docs/TRANSFER_GUARDRAIL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-guardrail-gate-honesty-pack-rg-pointers.json` — Stage 1006 P1
- `docs/TRANSFER_INTERCEPT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-intercept-gate-honesty-pack-remaining-gate.json` — Stage 1005 I1
- `docs/TRANSFER_INTERCEPT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-intercept-gate-honesty-pack-rg-blockers.json` — Stage 1005 B1
- `docs/TRANSFER_INTERCEPT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-intercept-gate-honesty-pack-rg-pointers.json` — Stage 1005 P1
- `docs/TRANSFER_INSPECT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-inspect-gate-honesty-pack-remaining-gate.json` — Stage 1004 I1
- `docs/TRANSFER_INSPECT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-inspect-gate-honesty-pack-rg-blockers.json` — Stage 1004 B1
- `docs/TRANSFER_INSPECT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-inspect-gate-honesty-pack-rg-pointers.json` — Stage 1004 P1
- `docs/TRANSFER_SANITIZE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sanitize-gate-honesty-pack-remaining-gate.json` — Stage 1003 I1
- `docs/TRANSFER_SANITIZE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sanitize-gate-honesty-pack-rg-blockers.json` — Stage 1003 B1
- `docs/TRANSFER_SANITIZE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sanitize-gate-honesty-pack-rg-pointers.json` — Stage 1003 P1
- `docs/TRANSFER_SCRUB_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-scrub-gate-honesty-pack-remaining-gate.json` — Stage 1002 I1
- `docs/TRANSFER_SCRUB_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-scrub-gate-honesty-pack-rg-blockers.json` — Stage 1002 B1
- `docs/TRANSFER_SCRUB_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-scrub-gate-honesty-pack-rg-pointers.json` — Stage 1002 P1
- `docs/TRANSFER_SIEVE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sieve-gate-honesty-pack-remaining-gate.json` — Stage 1001 I1
- `docs/TRANSFER_SIEVE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sieve-gate-honesty-pack-rg-blockers.json` — Stage 1001 B1
- `docs/TRANSFER_SIEVE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sieve-gate-honesty-pack-rg-pointers.json` — Stage 1001 P1
- `docs/TRANSFER_SCREEN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-screen-gate-honesty-pack-remaining-gate.json` — Stage 1000 I1
- `docs/TRANSFER_SCREEN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-screen-gate-honesty-pack-rg-blockers.json` — Stage 1000 B1
- `docs/TRANSFER_SCREEN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-screen-gate-honesty-pack-rg-pointers.json` — Stage 1000 P1
- `docs/TRANSFER_FILTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-filter-gate-honesty-pack-remaining-gate.json` — Stage 999 I1
- `docs/TRANSFER_FILTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-filter-gate-honesty-pack-rg-blockers.json` — Stage 999 B1
- `docs/TRANSFER_FILTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-filter-gate-honesty-pack-rg-pointers.json` — Stage 999 P1
- `docs/TRANSFER_PROXY_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-proxy-gate-honesty-pack-remaining-gate.json` — Stage 998 I1
- `docs/TRANSFER_PROXY_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-proxy-gate-honesty-pack-rg-blockers.json` — Stage 998 B1
- `docs/TRANSFER_PROXY_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-proxy-gate-honesty-pack-rg-pointers.json` — Stage 998 P1
- `docs/TRANSFER_FIREWALL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-firewall-gate-honesty-pack-remaining-gate.json` — Stage 997 I1
- `docs/TRANSFER_FIREWALL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-firewall-gate-honesty-pack-rg-blockers.json` — Stage 997 B1
- `docs/TRANSFER_FIREWALL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-firewall-gate-honesty-pack-rg-pointers.json` — Stage 997 P1
- `docs/TRANSFER_SEPARATION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-separation-gate-honesty-pack-remaining-gate.json` — Stage 996 I1
- `docs/TRANSFER_SEPARATION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-separation-gate-honesty-pack-rg-blockers.json` — Stage 996 B1
- `docs/TRANSFER_SEPARATION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-separation-gate-honesty-pack-rg-pointers.json` — Stage 996 P1
- `docs/TRANSFER_SEGREGATION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-segregation-gate-honesty-pack-remaining-gate.json` — Stage 995 I1
- `docs/TRANSFER_SEGREGATION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-segregation-gate-honesty-pack-rg-blockers.json` — Stage 995 B1
- `docs/TRANSFER_SEGREGATION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-segregation-gate-honesty-pack-rg-pointers.json` — Stage 995 P1
- `docs/TRANSFER_CONTAINMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-containment-gate-honesty-pack-remaining-gate.json` — Stage 994 I1
- `docs/TRANSFER_CONTAINMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-containment-gate-honesty-pack-rg-blockers.json` — Stage 994 B1
- `docs/TRANSFER_CONTAINMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-containment-gate-honesty-pack-rg-pointers.json` — Stage 994 P1
- `docs/TRANSFER_ISOLATION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-isolation-gate-honesty-pack-remaining-gate.json` — Stage 993 I1
- `docs/TRANSFER_ISOLATION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-isolation-gate-honesty-pack-rg-blockers.json` — Stage 993 B1
- `docs/TRANSFER_ISOLATION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-isolation-gate-honesty-pack-rg-pointers.json` — Stage 993 P1
- `docs/TRANSFER_QUARANTINE_ZONE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-quarantine-zone-gate-honesty-pack-remaining-gate.json` — Stage 992 I1
- `docs/TRANSFER_QUARANTINE_ZONE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-quarantine-zone-gate-honesty-pack-rg-blockers.json` — Stage 992 B1
- `docs/TRANSFER_QUARANTINE_ZONE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-quarantine-zone-gate-honesty-pack-rg-pointers.json` — Stage 992 P1
- `docs/TRANSFER_LOCKDOWN_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lockdown-gate-honesty-pack-remaining-gate.json` — Stage 991 I1
- `docs/TRANSFER_LOCKDOWN_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lockdown-gate-honesty-pack-rg-blockers.json` — Stage 991 B1
- `docs/TRANSFER_LOCKDOWN_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lockdown-gate-honesty-pack-rg-pointers.json` — Stage 991 P1
- `docs/TRANSFER_CORDON_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cordon-gate-honesty-pack-remaining-gate.json` — Stage 990 I1
- `docs/TRANSFER_CORDON_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cordon-gate-honesty-pack-rg-blockers.json` — Stage 990 B1
- `docs/TRANSFER_CORDON_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cordon-gate-honesty-pack-rg-pointers.json` — Stage 990 P1
- `docs/TRANSFER_BARRICADE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-barricade-gate-honesty-pack-remaining-gate.json` — Stage 989 I1
- `docs/TRANSFER_BARRICADE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-barricade-gate-honesty-pack-rg-blockers.json` — Stage 989 B1
- `docs/TRANSFER_BARRICADE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-barricade-gate-honesty-pack-rg-pointers.json` — Stage 989 P1
- `docs/TRANSFER_PORTCULLIS_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-portcullis-gate-honesty-pack-remaining-gate.json` — Stage 988 I1
- `docs/TRANSFER_PORTCULLIS_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-portcullis-gate-honesty-pack-rg-blockers.json` — Stage 988 B1
- `docs/TRANSFER_PORTCULLIS_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-portcullis-gate-honesty-pack-rg-pointers.json` — Stage 988 P1
- `docs/TRANSFER_DRAWBRIDGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-drawbridge-gate-honesty-pack-remaining-gate.json` — Stage 987 I1
- `docs/TRANSFER_DRAWBRIDGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-drawbridge-gate-honesty-pack-rg-blockers.json` — Stage 987 B1
- `docs/TRANSFER_DRAWBRIDGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-drawbridge-gate-honesty-pack-rg-pointers.json` — Stage 987 P1
- `docs/TRANSFER_MOAT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-moat-gate-honesty-pack-remaining-gate.json` — Stage 986 I1
- `docs/TRANSFER_MOAT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-moat-gate-honesty-pack-rg-blockers.json` — Stage 986 B1
- `docs/TRANSFER_MOAT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-moat-gate-honesty-pack-rg-pointers.json` — Stage 986 P1
- `docs/TRANSFER_RAMPART_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-rampart-gate-honesty-pack-remaining-gate.json` — Stage 985 I1
- `docs/TRANSFER_RAMPART_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-rampart-gate-honesty-pack-rg-blockers.json` — Stage 985 B1
- `docs/TRANSFER_RAMPART_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-rampart-gate-honesty-pack-rg-pointers.json` — Stage 985 P1
- `docs/TRANSFER_REDOUBT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-redoubt-gate-honesty-pack-remaining-gate.json` — Stage 984 I1
- `docs/TRANSFER_REDOUBT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-redoubt-gate-honesty-pack-rg-blockers.json` — Stage 984 B1
- `docs/TRANSFER_REDOUBT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-redoubt-gate-honesty-pack-rg-pointers.json` — Stage 984 P1
- `docs/TRANSFER_STRONGHOLD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stronghold-gate-honesty-pack-remaining-gate.json` — Stage 983 I1
- `docs/TRANSFER_STRONGHOLD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stronghold-gate-honesty-pack-rg-blockers.json` — Stage 983 B1
- `docs/TRANSFER_STRONGHOLD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stronghold-gate-honesty-pack-rg-pointers.json` — Stage 983 P1
- `docs/TRANSFER_KEEP_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-keep-gate-honesty-pack-remaining-gate.json` — Stage 982 I1
- `docs/TRANSFER_KEEP_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-keep-gate-honesty-pack-rg-blockers.json` — Stage 982 B1
- `docs/TRANSFER_KEEP_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-keep-gate-honesty-pack-rg-pointers.json` — Stage 982 P1
- `docs/TRANSFER_CITADEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-citadel-gate-honesty-pack-remaining-gate.json` — Stage 981 I1
- `docs/TRANSFER_CITADEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-citadel-gate-honesty-pack-rg-blockers.json` — Stage 981 B1
- `docs/TRANSFER_CITADEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-citadel-gate-honesty-pack-rg-pointers.json` — Stage 981 P1
- `docs/TRANSFER_BASTION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bastion-gate-honesty-pack-remaining-gate.json` — Stage 980 I1
- `docs/TRANSFER_BASTION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bastion-gate-honesty-pack-rg-blockers.json` — Stage 980 B1
- `docs/TRANSFER_BASTION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bastion-gate-honesty-pack-rg-pointers.json` — Stage 980 P1
- `docs/TRANSFER_BULWARK_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-bulwark-gate-honesty-pack-remaining-gate.json` — Stage 979 I1
- `docs/TRANSFER_BULWARK_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-bulwark-gate-honesty-pack-rg-blockers.json` — Stage 979 B1
- `docs/TRANSFER_BULWARK_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-bulwark-gate-honesty-pack-rg-pointers.json` — Stage 979 P1
- `docs/TRANSFER_SHIELD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shield-gate-honesty-pack-remaining-gate.json` — Stage 978 I1
- `docs/TRANSFER_SHIELD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shield-gate-honesty-pack-rg-blockers.json` — Stage 978 B1
- `docs/TRANSFER_SHIELD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shield-gate-honesty-pack-rg-pointers.json` — Stage 978 P1
- `docs/TRANSFER_WALL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-wall-gate-honesty-pack-remaining-gate.json` — Stage 977 I1
- `docs/TRANSFER_WALL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-wall-gate-honesty-pack-rg-blockers.json` — Stage 977 B1
- `docs/TRANSFER_WALL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-wall-gate-honesty-pack-rg-pointers.json` — Stage 977 P1
- `docs/TRANSFER_BARRIER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-barrier-gate-honesty-pack-remaining-gate.json` — Stage 976 I1
- `docs/TRANSFER_BARRIER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-barrier-gate-honesty-pack-rg-blockers.json` — Stage 976 B1
- `docs/TRANSFER_BARRIER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-barrier-gate-honesty-pack-rg-pointers.json` — Stage 976 P1
- `docs/TRANSFER_FENCE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-fence-gate-honesty-pack-remaining-gate.json` — Stage 975 I1
- `docs/TRANSFER_FENCE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-fence-gate-honesty-pack-rg-blockers.json` — Stage 975 B1
- `docs/TRANSFER_FENCE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-fence-gate-honesty-pack-rg-pointers.json` — Stage 975 P1
- `docs/TRANSFER_GUARD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-guard-gate-honesty-pack-remaining-gate.json` — Stage 974 I1
- `docs/TRANSFER_GUARD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-guard-gate-honesty-pack-rg-blockers.json` — Stage 974 B1
- `docs/TRANSFER_GUARD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-guard-gate-honesty-pack-rg-pointers.json` — Stage 974 P1
- `docs/TRANSFER_WATCHDOG_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-watchdog-gate-honesty-pack-remaining-gate.json` — Stage 973 I1
- `docs/TRANSFER_WATCHDOG_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-watchdog-gate-honesty-pack-rg-blockers.json` — Stage 973 B1
- `docs/TRANSFER_WATCHDOG_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-watchdog-gate-honesty-pack-rg-pointers.json` — Stage 973 P1
- `docs/TRANSFER_MONITOR_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-monitor-gate-honesty-pack-remaining-gate.json` — Stage 972 I1
- `docs/TRANSFER_MONITOR_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-monitor-gate-honesty-pack-rg-blockers.json` — Stage 972 B1
- `docs/TRANSFER_MONITOR_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-monitor-gate-honesty-pack-rg-pointers.json` — Stage 972 P1
- `docs/TRANSFER_SENTINEL_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-sentinel-gate-honesty-pack-remaining-gate.json` — Stage 971 I1
- `docs/TRANSFER_SENTINEL_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-sentinel-gate-honesty-pack-rg-blockers.json` — Stage 971 B1
- `docs/TRANSFER_SENTINEL_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-sentinel-gate-honesty-pack-rg-pointers.json` — Stage 971 P1
- `docs/TRANSFER_GATEKEEPER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-gatekeeper-gate-honesty-pack-remaining-gate.json` — Stage 970 I1
- `docs/TRANSFER_GATEKEEPER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-gatekeeper-gate-honesty-pack-rg-blockers.json` — Stage 970 B1
- `docs/TRANSFER_GATEKEEPER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-gatekeeper-gate-honesty-pack-rg-pointers.json` — Stage 970 P1
- `docs/TRANSFER_CHECKPOINT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-checkpoint-gate-honesty-pack-remaining-gate.json` — Stage 969 I1
- `docs/TRANSFER_CHECKPOINT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-checkpoint-gate-honesty-pack-rg-blockers.json` — Stage 969 B1
- `docs/TRANSFER_CHECKPOINT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-checkpoint-gate-honesty-pack-rg-pointers.json` — Stage 969 P1
- `docs/TRANSFER_MILESTONE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-milestone-gate-honesty-pack-remaining-gate.json` — Stage 968 I1
- `docs/TRANSFER_MILESTONE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-milestone-gate-honesty-pack-rg-blockers.json` — Stage 968 B1
- `docs/TRANSFER_MILESTONE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-milestone-gate-honesty-pack-rg-pointers.json` — Stage 968 P1
- `docs/TRANSFER_PHASE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-phase-gate-honesty-pack-remaining-gate.json` — Stage 967 I1
- `docs/TRANSFER_PHASE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-phase-gate-honesty-pack-rg-blockers.json` — Stage 967 B1
- `docs/TRANSFER_PHASE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-phase-gate-honesty-pack-rg-pointers.json` — Stage 967 P1
- `docs/TRANSFER_LIFECYCLE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-lifecycle-gate-honesty-pack-remaining-gate.json` — Stage 966 I1
- `docs/TRANSFER_LIFECYCLE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-lifecycle-gate-honesty-pack-rg-blockers.json` — Stage 966 B1
- `docs/TRANSFER_LIFECYCLE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-lifecycle-gate-honesty-pack-rg-pointers.json` — Stage 966 P1
- `docs/TRANSFER_STAGE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-stage-gate-honesty-pack-remaining-gate.json` — Stage 965 I1
- `docs/TRANSFER_STAGE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-stage-gate-honesty-pack-rg-blockers.json` — Stage 965 B1
- `docs/TRANSFER_STAGE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-stage-gate-honesty-pack-rg-pointers.json` — Stage 965 P1
- `docs/TRANSFER_ENVIRONMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-environment-gate-honesty-pack-remaining-gate.json` — Stage 964 I1
- `docs/TRANSFER_ENVIRONMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-environment-gate-honesty-pack-rg-blockers.json` — Stage 964 B1
- `docs/TRANSFER_ENVIRONMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-environment-gate-honesty-pack-rg-pointers.json` — Stage 964 P1
- `docs/TRANSFER_PROJECT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-project-gate-honesty-pack-remaining-gate.json` — Stage 963 I1
- `docs/TRANSFER_PROJECT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-project-gate-honesty-pack-rg-blockers.json` — Stage 963 B1
- `docs/TRANSFER_PROJECT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-project-gate-honesty-pack-rg-pointers.json` — Stage 963 P1
- `docs/TRANSFER_ACCOUNT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-account-gate-honesty-pack-remaining-gate.json` — Stage 962 I1
- `docs/TRANSFER_ACCOUNT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-account-gate-honesty-pack-rg-blockers.json` — Stage 962 B1
- `docs/TRANSFER_ACCOUNT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-account-gate-honesty-pack-rg-pointers.json` — Stage 962 P1
- `docs/TRANSFER_ORG_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-org-gate-honesty-pack-remaining-gate.json` — Stage 961 I1
- `docs/TRANSFER_ORG_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-org-gate-honesty-pack-rg-blockers.json` — Stage 961 B1
- `docs/TRANSFER_ORG_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-org-gate-honesty-pack-rg-pointers.json` — Stage 961 P1
- `docs/TRANSFER_WORKSPACE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-workspace-gate-honesty-pack-remaining-gate.json` — Stage 960 I1
- `docs/TRANSFER_WORKSPACE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-workspace-gate-honesty-pack-rg-blockers.json` — Stage 960 B1
- `docs/TRANSFER_WORKSPACE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-workspace-gate-honesty-pack-rg-pointers.json` — Stage 960 P1
- `docs/TRANSFER_TENANT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-tenant-gate-honesty-pack-remaining-gate.json` — Stage 959 I1
- `docs/TRANSFER_TENANT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-tenant-gate-honesty-pack-rg-blockers.json` — Stage 959 B1
- `docs/TRANSFER_TENANT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-tenant-gate-honesty-pack-rg-pointers.json` — Stage 959 P1
- `docs/TRANSFER_INSTANCE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-instance-gate-honesty-pack-remaining-gate.json` — Stage 958 I1
- `docs/TRANSFER_INSTANCE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-instance-gate-honesty-pack-rg-blockers.json` — Stage 958 B1
- `docs/TRANSFER_INSTANCE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-instance-gate-honesty-pack-rg-pointers.json` — Stage 958 P1
- `docs/TRANSFER_HOST_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-host-gate-honesty-pack-remaining-gate.json` — Stage 957 I1
- `docs/TRANSFER_HOST_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-host-gate-honesty-pack-rg-blockers.json` — Stage 957 B1
- `docs/TRANSFER_HOST_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-host-gate-honesty-pack-rg-pointers.json` — Stage 957 P1
- `docs/TRANSFER_NODE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-node-gate-honesty-pack-remaining-gate.json` — Stage 956 I1
- `docs/TRANSFER_NODE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-node-gate-honesty-pack-rg-blockers.json` — Stage 956 B1
- `docs/TRANSFER_NODE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-node-gate-honesty-pack-rg-pointers.json` — Stage 956 P1
- `docs/TRANSFER_CLUSTER_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-cluster-gate-honesty-pack-remaining-gate.json` — Stage 955 I1
- `docs/TRANSFER_CLUSTER_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-cluster-gate-honesty-pack-rg-blockers.json` — Stage 955 B1
- `docs/TRANSFER_CLUSTER_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-cluster-gate-honesty-pack-rg-pointers.json` — Stage 955 P1
- `docs/TRANSFER_SHARD_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-shard-gate-honesty-pack-remaining-gate.json` — Stage 954 I1
- `docs/TRANSFER_SHARD_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-shard-gate-honesty-pack-rg-blockers.json` — Stage 954 B1
- `docs/TRANSFER_SHARD_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-shard-gate-honesty-pack-rg-pointers.json` — Stage 954 P1
- `docs/TRANSFER_SLICE_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-slice-gate-honesty-pack-remaining-gate.json` — Stage 953 I1
- `docs/TRANSFER_SLICE_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-slice-gate-honesty-pack-rg-blockers.json` — Stage 953 B1
- `docs/TRANSFER_SLICE_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-slice-gate-honesty-pack-rg-pointers.json` — Stage 953 P1
- `docs/TRANSFER_SEGMENT_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-segment-gate-honesty-pack-remaining-gate.json` — Stage 952 I1
- `docs/TRANSFER_SEGMENT_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-segment-gate-honesty-pack-rg-blockers.json` — Stage 952 B1
- `docs/TRANSFER_SEGMENT_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-segment-gate-honesty-pack-rg-pointers.json` — Stage 952 P1
- `docs/TRANSFER_PARTITION_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-partition-gate-honesty-pack-remaining-gate.json` — Stage 951 I1
- `docs/TRANSFER_PARTITION_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-partition-gate-honesty-pack-rg-blockers.json` — Stage 951 B1
- `docs/TRANSFER_PARTITION_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-partition-gate-honesty-pack-rg-pointers.json` — Stage 951 P1
- `docs/TRANSFER_REALM_GATE_HONESTY_PACK_REMAINING_GATE_MVP.md` / `ops/mvp/transfer-realm-gate-honesty-pack-remaining-gate.json` — Stage 950 I1
- `docs/TRANSFER_REALM_GATE_HONESTY_PACK_RG_BLOCKERS_MVP.md` / `ops/mvp/transfer-realm-gate-honesty-pack-rg-blockers.json` — Stage 950 B1
- `docs/TRANSFER_REALM_GATE_HONESTY_PACK_RG_POINTERS_MVP.md` / `ops/mvp/transfer-realm-gate-honesty-pack-rg-pointers.json` — Stage 950 P1
