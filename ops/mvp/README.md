...
## Stage 36 D1 — Assurance completion fidelity

Doc-only fidelity sync. See `docs/STAGE_36_FIDELITY.md` (`backend/tests/test_stage36_fidelity_d1.py`) — maps S1–B1 → readiness / launch / deploy / security.
