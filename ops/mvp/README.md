...
Do **not** treat this packaging as production go-live or as implementation of deferred ADR scopes. Top-level flags stay `go_live_claimed: false` / `deferred_implemented_claimed: false`.
